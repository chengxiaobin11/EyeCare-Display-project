...
//--------------------------------------------------
// DDR2 PLL SSC Support
//--------------------------------------------------
#ifndef _DDR2PLL_SSC_SUPPORT
#define _DDR2PLL_SSC_SUPPORT                                    _OFF
#endif

//--------------------------------------------------
// DDR2 PLL SSC Amplitude
//--------------------------------------------------
#ifndef _DDR2PLL_SSC_AMPLITUDE
#define _DDR2PLL_SSC_AMPLITUDE                                  _0_5_PERCENT
#endif
...
//--------------------------------------------------
// DP Tx Edid Modify Support for HDR & Freesync
//--------------------------------------------------
#ifndef _DP_TX_EDID_MODIFY_REMOVE_HDR_FS2_SUPPORT
#define _DP_TX_EDID_MODIFY_REMOVE_HDR_FS2_SUPPORT               _OFF
#endif

//-------------------------------------------------
// DP Bandwidth Limited by Supported Timing
//-------------------------------------------------
#ifndef _DP_MST_MAC_BW_LIMITED_BY_PROJECT_TIMING_SUPPORT
#define _DP_MST_MAC_BW_LIMITED_BY_PROJECT_TIMING_SUPPORT        ((_DP_MST_SUPPORT == _ON) && (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON))
#endif

//-------------------------------------------------
// DP Project Supported Timing Maximum (in MHz)
//-------------------------------------------------
#ifndef _DP_PROJECT_TIMING_MAX_PIXEL_CLOCK_MHZ
#define _DP_PROJECT_TIMING_MAX_PIXEL_CLOCK_MHZ                  (_INPUTCLOCK_RANG_DP / 10)
#endif

#ifndef _DP_PROJECT_TIMING_MAX_COLOR_DEPTH
