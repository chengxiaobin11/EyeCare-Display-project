...
#define GET_TYPE_C_5400_CBL_ACTIVE_COMPONENT(x)             (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].stCableInfo.enumTypeCCableActiveComponent)
#define SET_TYPE_C_5400_CBL_ACTIVE_COMPONENT(x, y)          (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].stCableInfo.enumTypeCCableActiveComponent = (y))

#define GET_TYPE_C_5400_CBL_UHBR13P5_SUPPORT(x)             (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].stCableInfo.b1CableUhbr13p5Support)
#define SET_TYPE_C_5400_CBL_UHBR13P5_SUPPORT(x)             (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].stCableInfo.b1CableUhbr13p5Support = _TRUE)
#define CLR_TYPE_C_5400_CBL_UHBR13P5_SUPPORT(x)             (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].stCableInfo.b1CableUhbr13p5Support = _FALSE)

#define GET_TYPE_C_5400_CBL_MAX_DP_RATE(x)                  (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].stCableInfo.enumTypeCCableMaxDpRate)
#define SET_TYPE_C_5400_CBL_MAX_DP_RATE(x, y)               (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].stCableInfo.enumTypeCCableMaxDpRate = (y))

#if(_TYPE_C_RTS5400_SERIES_PDO_INFO_SUPPORT == _ON)
// 5400 Port Operation Mode Macro
#define GET_TYPE_C_5400_PORT_OPERATION_MODE(x)              (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3PortOpMode)
#define SET_TYPE_C_5400_PORT_OPERATION_MODE(x, y)           (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3PortOpMode = (y))
#define CLR_TYPE_C_5400_PORT_OPERATION_MODE(x)              (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3PortOpMode = 0)
...
// RTS 5400 Explicit Contract Macro
#define GET_TYPE_C_5400_EXPLICIT_CONTRACT(x)                (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b1PowerContract)
#define SET_TYPE_C_5400_EXPLICIT_CONTRACT(x)                (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b1PowerContract = _TRUE)
#define CLR_TYPE_C_5400_EXPLICIT_CONTRACT(x)                (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b1PowerContract = _FALSE)
...
// 5400 Sink Capability Macros
#define GET_TYPE_C_5400_SNK_CAP_CNT(x)                      (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b4NumOfSnkCap)
#define SET_TYPE_C_5400_SNK_CAP_CNT(x, y)                   (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b4NumOfSnkCap = (y))

#define GET_TYPE_C_5400_SNK_CAP_TYPE(x, y)                  (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].pstSnkPdo[y].enumPdoType)
#define SET_TYPE_C_5400_SNK_CAP_TYPE(x, y, z)               (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].pstSnkPdo[y].enumPdoType = (z))

#define GET_TYPE_C_5400_SNK_CAP_VOL_MAX(x, y)               (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].pstSnkPdo[y].usMaxVoltage)
#define SET_TYPE_C_5400_SNK_CAP_VOL_MAX(x, y, z)            (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].pstSnkPdo[y].usMaxVoltage = (z))

#define GET_TYPE_C_5400_SNK_CAP_VOL_MIN(x, y)               (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].pstSnkPdo[y].usMinVoltage)
#define SET_TYPE_C_5400_SNK_CAP_VOL_MIN(x, y, z)            (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].pstSnkPdo[y].usMinVoltage = (z))

#define GET_TYPE_C_5400_SNK_CAP_CUR(x, y)                   (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].pstSnkPdo[y].usMaxCurrent)
#define SET_TYPE_C_5400_SNK_CAP_CUR(x, y, z)                (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].pstSnkPdo[y].usMaxCurrent = (z))
...
code StructSMBusWRNotifyEn tSMBusWrCmdSetNotifyEn[1] = {{0x08, 0x06, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00}};
...
bit UserCommonPortControllerGet5400ExplicitContract(BYTE ucInputPort);
...
BYTE UserCommonPortControllerGet5400PortOperationMode(BYTE ucInputPort);
...
StructTypeCCableInfoForDpcd UserCommonPortControllerGet5400CableInfoForDpcd(BYTE ucInputPort);
...
void UserCommonPortControllerGet5400UserNotifyEn(BYTE ucInputPort, Struct5400NotifyEn *pst5400NotifyEn);
bit UserCommonPortControllerSet5400NotifyEn(BYTE ucInputPort, Struct5400NotifyEn st5400NotifyEn);
#endif
...
bit UserCommonPortControllerEnable5400VenderCommand(BYTE ucInputPort)
{
...
#if(_TYPE_C_RTS5400_SERIES_SMBUS_MODE == _RTS5400_SERIES_INT_MODE)
    Struct5400NotifyEn st5400NotifyEn = {_5400_NOTIFY_EN_B0_NONE, _5400_NOTIFY_EN_B1_NONE, _5400_NOTIFY_EN_B2_NONE, _5400_NOTIFY_EN_B3_NONE};
#endif
    ...
    UserCommonPortControllerGet5400UserNotifyEn(ucInputPort, &st5400NotifyEn);

    // Update Notification Enable to Rts Port Controller
    if(UserCommonPortControllerSet5400NotifyEn(ucInputPort, st5400NotifyEn) == _FAIL)
    {
        return _FAIL;
    }
#endif
...
void UserCommonPortController5400Reset(BYTE ucInputPort)
{
...
#if(_TYPE_C_RTS5400_SERIES_PDO_INFO_SUPPORT == _ON)
    CLR_TYPE_C_5400_PORT_OPERATION_MODE(ucInputPort);
    ...
    CLR_TYPE_C_5400_EXPLICIT_CONTRACT(ucInputPort);
...
bit UserCommonPortControllerUpdate5400RoleInfo(BYTE ucInputPort)
{
    ...
    if((g_unSMBusRdDataPool.stRdGetStatus.ucByte4 & (_BIT7)) == _BIT7)
    {
        ...
        SET_TYPE_C_5400_PORT_OPERATION_MODE(ucInputPort, ((g_unSMBusRdDataPool.stRdGetStatus.ucByte4 & (_BIT3 | _BIT2 | _BIT1)) >> 1));
        ...
        if(GET_TYPE_C_5400_PORT_OPERATION_MODE(ucInputPort) == (_BIT1 | _BIT0))
        {
            ...
            SET_TYPE_C_5400_EXPLICIT_CONTRACT(ucInputPort);
        }
        else
        {
...
//--------------------------------------------------
// Description  : Return 5400 Port Controller Explicit Contract
// Input Value  : ucInputPort --> Input Port
// Output Value : Explicit Contract Result (_TRUE / _FALSE)
//--------------------------------------------------
bit UserCommonPortControllerGet5400ExplicitContract(BYTE ucInputPort)
{
    return GET_TYPE_C_5400_EXPLICIT_CONTRACT(ucInputPort);
}
...
//--------------------------------------------------
// Description  : Return 5400 Port Controller Port Operation Mode
// Input Value  : ucInputPort
// Output Value : Port Operation Mode Result
//--------------------------------------------------
BYTE UserCommonPortControllerGet5400PortOperationMode(BYTE ucInputPort)
{
    return GET_TYPE_C_5400_PORT_OPERATION_MODE(ucInputPort);
}
...
void UserCommonPortControllerSet5400PdoCnt(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE ucPdoCnt)
{
    if(enumPowerRole == _TYPE_C_POWER_SRC)
    {
        ...
        SET_TYPE_C_5400_SRC_CAP_CNT(ucInputPort, ucPdoCnt);
    }
    else if(enumPowerRole == _TYPE_C_POWER_SNK)
    {
        // Set Number Of Capabilities (Number Of Data Objects)
        SET_TYPE_C_5400_SNK_CAP_CNT(ucInputPort, ucPdoCnt);
    }
}
...
void UserCommonPortControllerSet5400Pdo(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE ucPdoIndex, StructTypeCUserPDO stTypeCUserPdo)
{
    ...
    {
        // Set PDO Type
        SET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, (ucPdoIndex - 1), stTypeCUserPdo.enumPdoType);

        if(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, (ucPdoIndex - 1)) == _PD_3_PROGRAMMABLE_PDO)
        {
            // Set PDO Voltage (Unit 100mV) and Current (Unit 50mA)
            SET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, (ucPdoIndex - 1), stTypeCUserPdo.usMaxVoltage);
            SET_TYPE_C_5400_SRC_CAP_VOL_MIN(ucInputPort, (ucPdoIndex - 1), stTypeCUserPdo.usMinVoltage);
            SET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, (ucPdoIndex - 1), (stTypeCUserPdo.usMaxCurrent / 5));
        }
        else
        {
            SET_TYPE_C_5400_SRC_CAP_PEAK_CUR(ucInputPort, (ucPdoIndex - 1), stTypeCUserPdo.enumPeakCurrent);

            // Set PDO Voltage (Unit 100mV) and Current (Unit 10mA)
            SET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, (ucPdoIndex - 1), stTypeCUserPdo.usMaxVoltage);
            SET_TYPE_C_5400_SRC_CAP_VOL_MIN(ucInputPort, (ucPdoIndex - 1), GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, (ucPdoIndex - 1)));
            SET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, (ucPdoIndex - 1), stTypeCUserPdo.usMaxCurrent);
        }

        if(GET_TYPE_C_5400_SRC_CAP_CNT(ucInputPort) == ucPdoIndex)
        {
    ...
    {
        // Set PDO Type
        SET_TYPE_C_5400_SNK_CAP_TYPE(ucInputPort, (ucPdoIndex - 1), stTypeCUserPdo.enumPdoType);

        if(GET_TYPE_C_5400_SNK_CAP_TYPE(ucInputPort, (ucPdoIndex - 1)) == _PD_3_PROGRAMMABLE_PDO)
        {
            // Set PDO Voltage (Unit 100mV) and Current (Unit 50mA)
            SET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, (ucPdoIndex - 1), stTypeCUserPdo.usMaxVoltage);
            SET_TYPE_C_5400_SNK_CAP_VOL_MIN(ucInputPort, (ucPdoIndex - 1), stTypeCUserPdo.usMinVoltage);
            SET_TYPE_C_5400_SNK_CAP_CUR(ucInputPort, (ucPdoIndex - 1), (stTypeCUserPdo.usMaxCurrent / 5));
        }
        else
        {
            // Set PDO Voltage (Unit 100mV) and Current (Unit 10mA)
            SET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, (ucPdoIndex - 1), stTypeCUserPdo.usMaxVoltage);
            SET_TYPE_C_5400_SNK_CAP_VOL_MIN(ucInputPort, (ucPdoIndex - 1), GET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, (ucPdoIndex - 1)));
            SET_TYPE_C_5400_SNK_CAP_CUR(ucInputPort, (ucPdoIndex - 1), stTypeCUserPdo.usMaxCurrent);
        }

        if(GET_TYPE_C_5400_SNK_CAP_CNT(ucInputPort) == ucPdoIndex)
        {
...
StructTypeCCableInfoForDpcd UserCommonPortControllerGet5400CableInfoForDpcd(BYTE ucInputPort)
{
    ...
    stTypeCCableInfoForDpcd.enumTypeCCableActiveComponent = GET_TYPE_C_5400_CBL_ACTIVE_COMPONENT(ucInputPort);
    stTypeCCableInfoForDpcd.enumTypeCCableMaxDpRate = GET_TYPE_C_5400_CBL_MAX_DP_RATE(ucInputPort);
    stTypeCCableInfoForDpcd.b1CableUhbr13p5Support = GET_TYPE_C_5400_CBL_UHBR13P5_SUPPORT(ucInputPort);

    DebugMessageTypeC("8. [Cable Info] Get 5400 Port Ctrl Active Component = ", stTypeCCableInfoForDpcd.enumTypeCCableActiveComponent);
    DebugMessageTypeC("8. [Cable Info] Get 5400 Port Ctrl Max DP Rate = ", stTypeCCableInfoForDpcd.enumTypeCCableMaxDpRate);
    DebugMessageTypeC("8. [Cable Info] Get 5400 Port Ctrl UHBR13.5 = ", stTypeCCableInfoForDpcd.b1CableUhbr13p5Support);
...
// Input Value  : ucInputPort, pst5400NotifyEn
...
void UserCommonPortControllerGet5400UserNotifyEn(BYTE ucInputPort, Struct5400NotifyEn *pst5400NotifyEn)
{
    ...
    UserInterfaceTypeCPortControllerGetNotifyEn(ucInputPort, &st5400NotifyEn);

    *pst5400NotifyEn = st5400NotifyEn;
}

//--------------------------------------------------
// Description  : Set Notification Enable to RTS Port Controller
// Input Value  : ucInputPort, st5400NotifyEn
// Output Value : _SUCCESS / _FAIL
//--------------------------------------------------
bit UserCommonPortControllerSet5400NotifyEn(BYTE ucInputPort, Struct5400NotifyEn st5400NotifyEn)
{
    ...
    memcpy(&stSMBusNotifyEn, &tSMBusWrCmdSetNotifyEn[0], tSMBusWrCmdSetNotifyEn[0].ucDataLength + 2);

    stSMBusNotifyEn.ucNotifyEnByte0 = st5400NotifyEn.enumNotifyEnByte0;
    stSMBusNotifyEn.ucNotifyEnByte1 = st5400NotifyEn.enumNotifyEnByte1;
    stSMBusNotifyEn.ucNotifyEnByte2 = st5400NotifyEn.enumNotifyEnByte2;
    stSMBusNotifyEn.ucNotifyEnByte3 = st5400NotifyEn.enumNotifyEnByte3;

    // Execute Write Command
    if(UserCommonTypecCommunicationWrite(ucSlaveAddr, stSMBusNotifyEn.ucCommandCode, 1, stSMBusNotifyEn.ucDataLength + 1, &stSMBusNotifyEn.ucDataLength, ucInputPort) == _FAIL)
    {
        DebugMessageTypeC("5400 Port Ctrl Notification Enable Write fail", 1);
    ...
    if(UserCommonTypecCommunicationPollingPDReady(ucSlaveAddr, 100, ucInputPort) == _FAIL)
    {
        DebugMessageTypeC("5400 Port Ctrl Notification Enable Polling Fail ", 1);
    ...
    switch(enum5400InfoType)
    {
        ...
        case _GET_5400_PIN_ASSIGNMENT:
            ...
            *pucReadInfo = (BYTE)(UserCommonPortControllerDecode5400PinAssignment(g_unSMBusRdDataPool.stRdDPlanesCfg.ucDPCfgPinConfig));
            ...
            if((g_unSMBusRdDataPool.stRdDPlanesCfg.ucDPCfgVDOByte3 & (_BIT7 | _BIT6)) == (_BIT6))
            {
                // Data Byte3 [5:4] Cable Active Component
                if((g_unSMBusRdDataPool.stRdDPlanesCfg.ucDPCfgVDOByte3 & (_BIT5 | _BIT4)) == 0x00)
                {
                    SET_TYPE_C_5400_CBL_ACTIVE_COMPONENT(ucInputPort, _PD_CBL_COMPONENT_PASSIVE);
                }
                else if((g_unSMBusRdDataPool.stRdDPlanesCfg.ucDPCfgVDOByte3 & (_BIT5 | _BIT4)) == (_BIT4))
                {
                    SET_TYPE_C_5400_CBL_ACTIVE_COMPONENT(ucInputPort, _PD_CBL_COMPONENT_ACTIVE_RETIMER);
                }
                else if((g_unSMBusRdDataPool.stRdDPlanesCfg.ucDPCfgVDOByte3 & (_BIT5 | _BIT4)) == (_BIT5))
                {
                    SET_TYPE_C_5400_CBL_ACTIVE_COMPONENT(ucInputPort, _PD_CBL_COMPONENT_ACTIVE_REDRIVER);
                }
                else if((g_unSMBusRdDataPool.stRdDPlanesCfg.ucDPCfgVDOByte3 & (_BIT5 | _BIT4)) == (_BIT5 | _BIT4))
                {
                    SET_TYPE_C_5400_CBL_ACTIVE_COMPONENT(ucInputPort, _PD_CBL_COMPONENT_OPTICAL);
                }

                // Data Byte0 [5:2] Cable UHBR10_20 Capability
                if((g_unSMBusRdDataPool.stRdDPlanesCfg.ucDPCfgVDOByte0 & _BIT4) == _BIT4)
                {
                    SET_TYPE_C_5400_CBL_MAX_DP_RATE(ucInputPort, _PD_CBL_MAX_UHBR20);
                }
                else if((g_unSMBusRdDataPool.stRdDPlanesCfg.ucDPCfgVDOByte0 & _BIT3) == _BIT3)
                {
                    SET_TYPE_C_5400_CBL_MAX_DP_RATE(ucInputPort, _PD_CBL_MAX_UHBR10);
                }
                else if((g_unSMBusRdDataPool.stRdDPlanesCfg.ucDPCfgVDOByte0 & _BIT2) == _BIT2)
                {
                    SET_TYPE_C_5400_CBL_MAX_DP_RATE(ucInputPort, _PD_CBL_MAX_HBR3);
                }
                else
                {
                    SET_TYPE_C_5400_CBL_MAX_DP_RATE(ucInputPort, _PD_CBL_MAX_DP_RATE_UNCONFIRMED);
                }

                // Data Byte3 [2] Cable UHBR13.5 Support
                if((g_unSMBusRdDataPool.stRdDPlanesCfg.ucDPCfgVDOByte3 & _BIT2) == _BIT2)
                {
                    SET_TYPE_C_5400_CBL_UHBR13P5_SUPPORT(ucInputPort);
                }
                else
                {
                    CLR_TYPE_C_5400_CBL_UHBR13P5_SUPPORT(ucInputPort);
                }
            }
            else
            {
...
bit UserCommonPortControllerWrite5400Command(BYTE ucInputPort, BYTE ucSlaveAddr, Enum5400InfoType enum5400InfoType)
{
    ...
    switch(enum5400InfoType)
    {
        ...
        case _SET_5400_SRC_PDO:
            ...
            pucData[1] = 3 + (4 * GET_TYPE_C_5400_SRC_CAP_CNT(ucInputPort));
            pucData[2] = tSMBusWrCmdSetSrcPDO[0].ucByte0;
            pucData[3] = tSMBusWrCmdSetSrcPDO[0].ucByte1;
            pucData[4] = (_BIT3) | GET_TYPE_C_5400_SRC_CAP_CNT(ucInputPort);
            ...
            {
                // [31:30] PDO Type
                pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((BYTE)(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucIndex) << 6) & (_BIT7 | _BIT6));

                if(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucIndex) == _PD_3_PROGRAMMABLE_PDO)
                {
                    // Get PDO Voltage (Unit 100mV) and Current (Unit 50mA)
                    // [24:17] Max Voltage in 100mV
                    pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucIndex) >> 7) & (_BIT0));
                    pucData[(ucIndex * 4) + 7] = pucData[(ucIndex * 4) + 7] | ((BYTE)(GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucIndex) << 1) & (~_BIT0));

                    // [15:8] Min Voltage in 100mV
                    pucData[(ucIndex * 4) + 6] = GET_TYPE_C_5400_SRC_CAP_VOL_MIN(ucInputPort, ucIndex);

                    // [6:0] Max Current in 50mA
                    pucData[(ucIndex * 4) + 5] = GET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, ucIndex);
                }
                else
                {
                    ...
                    pucData[(ucIndex * 4) + 7] = pucData[(ucIndex * 4) + 7] | ((BYTE)(GET_TYPE_C_5400_SRC_CAP_PEAK_CUR(ucInputPort, ucIndex) << 4) & (_BIT5 | _BIT4));
                    pucData[(ucIndex * 4) + 7] = pucData[(ucIndex * 4) + 7] | ((((GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucIndex)) * 2) >> 6) & (_BIT3 | _BIT2 | _BIT1 | _BIT0));

                    // | 15 | 14 | 13 | 12 | 11 | 10 | 09 | 08 | 07 | 06 | 05 | 04 | 03 | 02 | 01 | 00 |
                    // |     Voltage(50mV) [5:0]     |                  Max.Cur [7:0]                  |
                    pucData[(ucIndex * 4) + 6] = pucData[(ucIndex * 4) + 6] | ((((GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucIndex)) * 2) << 2) & (_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2));
                    pucData[(ucIndex * 4) + 6] = pucData[(ucIndex * 4) + 6] | ((GET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, ucIndex) >> 8) & (_BIT1 | _BIT0));
                    pucData[(ucIndex * 4) + 5] = pucData[(ucIndex * 4) + 5] | GET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, ucIndex);
                }
            }
        ...
        case _SET_5400_SNK_PDO:
            ...
            pucData[1] = 3 + (4 * GET_TYPE_C_5400_SNK_CAP_CNT(ucInputPort));
            pucData[2] = tSMBusWrCmdSetSnkPDO[0].ucByte0;
            pucData[3] = tSMBusWrCmdSetSnkPDO[0].ucByte1;
            pucData[4] = GET_TYPE_C_5400_SNK_CAP_CNT(ucInputPort);
            ...
            for(ucIndex = 0; ucIndex < GET_TYPE_C_5400_SNK_CAP_CNT(ucInputPort); ucIndex++)
            {
                // [31:30] PDO Type
                pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((BYTE)(GET_TYPE_C_5400_SNK_CAP_TYPE(ucInputPort, ucIndex) << 6) & (_BIT7 | _BIT6));

                if(GET_TYPE_C_5400_SNK_CAP_TYPE(ucInputPort, ucIndex) == _PD_3_PROGRAMMABLE_PDO)
                {
                    // Get PDO Voltage (Unit 100mV) and Current (Unit 50mA)
                    // [24:17] Max Voltage in 100mV
                    pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((GET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, ucIndex) >> 7) & (_BIT0));
                    pucData[(ucIndex * 4) + 7] = pucData[(ucIndex * 4) + 7] | ((BYTE)(GET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, ucIndex) << 1) & (~_BIT0));

                    // [15:8] Min Voltage in 100mV
                    pucData[(ucIndex * 4) + 6] = GET_TYPE_C_5400_SNK_CAP_VOL_MIN(ucInputPort, ucIndex);

                    // [6:0] Max Current in 50mA
                    pucData[(ucIndex * 4) + 5] = GET_TYPE_C_5400_SNK_CAP_CUR(ucInputPort, ucIndex);
                }
                else
                {
                    // Get PDO Voltage (Unit 100mV to 50mv) and Current (Unit 10mA)
                    ...
                    pucData[(ucIndex * 4) + 7] = pucData[(ucIndex * 4) + 7] | ((((GET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, ucIndex)) * 2) >> 6) & (_BIT3 | _BIT2 | _BIT1 | _BIT0));
                    pucData[(ucIndex * 4) + 6] = pucData[(ucIndex * 4) + 6] | ((((GET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, ucIndex)) * 2) << 2) & (_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2));
                    pucData[(ucIndex * 4) + 6] = pucData[(ucIndex * 4) + 6] | ((GET_TYPE_C_5400_SNK_CAP_CUR(ucInputPort, ucIndex) >> 8) & (_BIT1 | _BIT0));
                    pucData[(ucIndex * 4) + 5] = pucData[(ucIndex * 4) + 5] | GET_TYPE_C_5400_SNK_CAP_CUR(ucInputPort, ucIndex);
                }
            }
