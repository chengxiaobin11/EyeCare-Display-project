...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Series_DPRx0Include.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_D0_DP_EXIST == _ON)
//****************************************************************************
...
//----------------------------------------------------------------------------
#define GET_DP_RX0_PHY_CTS_FLG()                        ((bit)ScalerGetBit(PB_B7_REG_RESERVED_FW_1, _BIT3))
#define SET_DP_RX0_PHY_CTS_FLG()                        (ScalerSetBit(PB_B7_REG_RESERVED_FW_1, ~_BIT3, _BIT3))
#define CLR_DP_RX0_PHY_CTS_FLG()                        (ScalerSetBit(PB_B7_REG_RESERVED_FW_1, ~_BIT3, 0x00))
...
#define SET_DP_RX0_VFRONT_PORCH_REG(x)                  (ScalerSetByte(PB5_40_VS_FRONT_PORCH, ((x) & 0xFF)))
...
#define SET_DP_RX0_INTERLACE_VTT_FW_MODE(x)             {\
                                                            (((x) == _EVEN) ? (ScalerSetBit(PB5_91_DP_RSV1, ~_BIT4, _BIT4)) : (ScalerSetBit(PB5_91_DP_RSV1, ~_BIT4, 0x00)));\
                                                        }
#endif

#define GET_DP_RX0_HDCP_CPIRQ()                         (g_bDpHdcpRx0HdcpCpirqFlag)
#define SET_DP_RX0_HDCP_CPIRQ()                         (g_bDpHdcpRx0HdcpCpirqFlag = _TRUE)
#define CLR_DP_RX0_HDCP_CPIRQ()                         (g_bDpHdcpRx0HdcpCpirqFlag = _FALSE)
...
extern BYTE g_pucDpRx0LEFineTune[4];

#if(_DP_WD_REBUILD_PHY_4PART_FOR_UCD400 == _ON)
extern WORD g_pusLevel0LEErrorCount[4];
extern WORD g_pusLevel1LEErrorCount[4];
extern WORD g_pusLevel2LEErrorCount[4];
extern WORD g_pusLevel3LEErrorCount[4];
#endif
...
extern StructDpAuxModeSetting g_stDpRxAuxModeSetting;
extern bit g_bDpHdcpRx0HdcpCpirqFlag;
...
extern bit ScalerDpRx0MeasureInfoCheck(StructDpInfo *pstDpInfo);
extern void ScalerDpRx0InterlaceReset(void);
...
extern bit ScalerDpRx0GetMeasureLinkInfo(StructDpInfo *pstDpInfo);
extern bit ScalerDpRx0DisplayFormatSetting(StructDpInfo *pstDpInfo);

extern bit ScalerDpRx0StreamClkRegenerate(StructDpLinkInfo *pstDpLinkInfo);
extern bit ScalerDpRx0TrackingSetting(StructDpInfo *pstDpInfo);
...
extern void ScalerDpRx0SetBsMissDetectIRQ(bit bEn);
extern void ScalerDpRx0SetBsMissDetectTrackingWD(bit bEn);
#endif

#if(_DP_8B10B_DEC_ERROR_WD_SUPPORT == _ON)
extern void ScalerDpRx0Set8b10bDecErrorWD(bit bEn);
#endif
#endif
