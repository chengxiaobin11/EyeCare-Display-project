...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Series_ScalerOSDLibInterface.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define GET_OSD_WINDOW_WAIT_DEN_STOP()                          (g_stOsdWindow.b1WindowWaitEvenStop)
#define SET_OSD_WINDOW_WAIT_DEN_STOP(x)                         (g_stOsdWindow.b1WindowWaitEvenStop = (x))
...
typedef enum
{
    ...
    _OSD_WINDOW_4,
    _OSD_WINDOW_5,
    _OSD_WINDOW_6,	//用于快捷键移动
    _OSD_WINDOW_7,	
    _OSD_WINDOW_8,	//用于上分界线 
    _OSD_WINDOW_9,	//用于下分界线 

    _OSD_WINDOW_4_1,
    _OSD_WINDOW_4_2, // PRESS_WIN 按键高亮
    _OSD_WINDOW_4_3, // 快捷键移动选中条
    _OSD_WINDOW_4_4, // 六轴跟用户色温背景色
    _OSD_WINDOW_4_5,
    _OSD_WINDOW_4_6, // 
    _OSD_WINDOW_4_7,
    _OSD_WINDOW_4_8,
...
extern bit ScalerOsdGet2FontFunction(void);
...
extern void ScalerOsdChangeWindowColor(void);
