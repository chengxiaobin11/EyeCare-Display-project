...
//----------------------------------------------------------------------------------------------------
// ID Code      : RTD2014UserDPEdid.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
BYTE code tEDID_TABLE_DP_1080P_AS[] =
{
#include "./EDID/EdidDp/EDID_DP_1920x1080_ADAPTIVESYNC(50,75).h"
};

BYTE code tEDID_TABLE_DP_2K1K_AS[] =
{
#include "./EDID/EdidDp/EDID_DP_2560x1440_ADAPTIVESYNC(48,60).h"
};

BYTE code tEDID_TABLE_DP_4K2K_AS[] =
{
#include "./EDID/EdidDp/EDID_DP_3840x2160_ADAPTIVESYNC(48,60).h"
};
#endif

#if((_DP_ADAPTIVESYNC_SUPPORT == _ON) && (_DP_FREESYNC_SUPPORT == _ON))
BYTE code tEDID_TABLE_DP_1080P_AS_FS[] =
{
#include "./EDID/EdidDp/EDID_DP_1920x1080_AS_FS(50,75).h"
};

BYTE code tEDID_TABLE_DP_2K1K_AS_FS[] =
{
#include "./EDID/EdidDp/EDID_DP_2560x1440_AS_FS(48,60).h"
};

BYTE code tEDID_TABLE_DP_4K2K_AS_FS[] =
{
#include "./EDID/EdidDp/EDID_DP_3840x2160_AS_FS(48,60).h"
};
#endif
...
#if(_DP_ADAPTIVESYNC_SUPPORT == _ON)
    tEDID_TABLE_DP_1080P_AS,            // _EDID_INDEX_12
    tEDID_TABLE_DP_2K1K_AS,             // _EDID_INDEX_13
    tEDID_TABLE_DP_4K2K_AS,             // _EDID_INDEX_14
#endif

#if((_DP_ADAPTIVESYNC_SUPPORT == _ON) && (_DP_FREESYNC_SUPPORT == _ON))
    tEDID_TABLE_DP_1080P_AS_FS,         // _EDID_INDEX_15
    tEDID_TABLE_DP_2K1K_AS_FS,          // _EDID_INDEX_16
    tEDID_TABLE_DP_4K2K_AS_FS,          // _EDID_INDEX_17
#endif
