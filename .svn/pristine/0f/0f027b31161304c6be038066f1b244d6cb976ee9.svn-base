...
extern void UserCommonInterfaceFreeSyncSetInputPortSupport(EnumSourceSearchPort enumSourcePort, EnumFreeSyncSupport enumSupport);
#endif
...
extern void UserCommonInterfaceDpAdaptiveSyncSetInputPortSupport(EnumSourceSearchPort enumSourcePort, EnumDpAdaptiveSyncSupport enumSupport);
#endif
...
extern bit UserCommonTmdsHpd5vPinDetect(EnumSourceSearchPort enumInputPort);
#endif
#endif
...
extern EnumUserDpLTStatus UserCommonInterfaceDpGetLinkTrainingStatus(EnumSourceSearchPort enumInputPort);
#endif
#endif // End of #if(_DIGITAL_PORT_SUPPORT == _ON)

#if(_PANEL_STYLE == _PANEL_DPTX)
extern EnumDpAuxStatus UserCommonInterfaceDisplayDPTxAuxI2COverWrite(EnumDisplayDpTxOutputPort enumDisplayDpTxOutputPort, BYTE ucSlaveAddress, BYTE ucLength, BYTE *pucDataArray);
extern EnumDpAuxStatus UserCommonInterfaceDisplayDPTxAuxI2COverRead(EnumDisplayDpTxOutputPort enumDisplayDpTxOutputPort, BYTE ucSlaveAddress, BYTE ucLength, BYTE *pucDataArray);
#endif
...
extern WORD UserInterfaceSourceGetPollingReactiveTime(BYTE ucInputPort, BYTE ucPortType);
#endif
...
extern bit UserCommonPortControllerGet5400ExplicitContract(BYTE ucInputPort);
...
extern BYTE UserCommonPortControllerGet5400PortOperationMode(BYTE ucInputPort);
...
extern StructTypeCCableInfoForDpcd UserCommonPortControllerGet5400CableInfoForDpcd(BYTE ucInputPort);
...
extern bit UserCommonPortControllerGetUserFwVersion(BYTE ucInputPort, StructTypeCPortCtrlFwVersion *pstTypeCFwVersion);
extern StructTypeCCableInfoForDpcd UserCommonPortControllerGetUserCableInfoForDpcd(BYTE ucInputPort);
