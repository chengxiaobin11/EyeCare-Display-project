...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432_QA_B_216PIN_1A2MHL2DP_DPTX_LVDS_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432_QA_B_216PIN_1A2MHL2DP_DPTX_LVDS_eDP)
...
// Series Pin Share //
//////////////////////
#include "RL6432_QA_B_216PIN_1A2MHL2DP_DPTX_LVDS_eDP_PINSHARE.h"
...
#endif // End of #if(_PCB_TYPE == _RL6432_QA_B_216PIN_1A2MHL2DP_DPTX_LVDS_eDP)
