...
void SysSourceSearchTimeInitial(BYTE ucSearchIndex)
{
    ...
    if(GET_SOURCE_SEARCH_DELAY_MODE() == _SOURCE_SEARCH_POLLING_MODE)
    {
        ...
        usReactiveTime = UserInterfaceSourceGetPollingReactiveTime(GET_INPUT_PORT(GET_INPUTPORT_TYPE(ucSearchIndex)),
                                                                   GET_PORT_TYPE(GET_INPUTPORT_TYPE(ucSearchIndex)));
#else
...
void SysSourceCableDetection(void)
{
    ...
    for(ucI = 0; ucI < _INPUT_PORT_VALID; ucI++)
    {
        ...
        switch(GET_INPUT_PORT(GET_INPUTPORT_TYPE(ucI)))
        {
            ...
            case _D0_INPUT_PORT:
#if((_HDMI_SUPPORT == _ON) && (_D0_HDMI_2_0_SUPPORT == _ON) && (_HDMI_5V_DETECT_BY_USER == _ON))
                g_stTmdsMacRx5vStatusByUser.b1D05vStatusByUser = UserInterfaceTmds5vPinDetect(_D0_INPUT_PORT);
#endif
            ...
            case _D1_INPUT_PORT:
#if((_HDMI_SUPPORT == _ON) && (_D1_HDMI_2_0_SUPPORT == _ON) && (_HDMI_5V_DETECT_BY_USER == _ON))
            ...
            case _D2_INPUT_PORT:
#if((_HDMI_SUPPORT == _ON) && (_D2_HDMI_2_0_SUPPORT == _ON) && (_HDMI_5V_DETECT_BY_USER == _ON))
            ...
            case _D3_INPUT_PORT:
#if((_HDMI_SUPPORT == _ON) && (_D3_HDMI_2_0_SUPPORT == _ON) && (_HDMI_5V_DETECT_BY_USER == _ON))
...
#if(_D4_INPUT_PORT_TYPE != _D4_NO_PORT)
            case _D4_INPUT_PORT:
#if((_HDMI_SUPPORT == _ON) && (_D4_HDMI_2_0_SUPPORT == _ON) && (_HDMI_5V_DETECT_BY_USER == _ON))
            ...
            case _D5_INPUT_PORT:
#if((_HDMI_SUPPORT == _ON) && (_D5_HDMI_2_0_SUPPORT == _ON) && (_HDMI_5V_DETECT_BY_USER == _ON))
...
#if(_DP_TYPE_C_PORT_CTRL_SUPPORT == _ON)
    if(SysTypeCCheckTypeCPortControllerExist(ucInputPort) == _TRUE)
    {
        return SysTypeCGetAltModeStatusChange(ucInputPort);
    }
    else
#endif
#endif
