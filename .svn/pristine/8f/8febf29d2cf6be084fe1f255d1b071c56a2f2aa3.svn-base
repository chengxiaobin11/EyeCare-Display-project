...
StructFlashInformation code tFlashInformation[] =
{
    ...
    {0x9F, 0x85, 0x20, 0x13, 0x90, 0x85, 0x12, 0x00, 0x06, 0x04, 0x20, 0x02, 0xBC, 0x40},
...
void ScalerFlashDetectFlashType(void)
{
    ...
    else if(ucIDCheck1PassFlashCount > 1)
    {
        ...
        else
        {
            ...
            if(g_ucFlashType == _FLASH_FM25Q08B)
            {
                g_ucFlashType = _FLASH_FM25Q08A;
            }
#else
            ...
            if(g_ucFlashType == _FLASH_W25Q80BV)
            {
                g_ucFlashType = _FLASH_W25Q80RVSNIQ;
            }
#else
            if(g_ucFlashType == _FLASH_W25Q80RVSNIQ)
            {
    ...
    switch(g_ucFlashType)
    {
        ...
        case _FLASH_MX25V8035F:
            ...
            if((ucRDCR & _BIT3) != _BIT3)
            {
                ...
                else if((ucBank >= 8) && (ucBank <= 11))
                {
                    // Protect Bank 12~15
                    ucWRSR = 0x0E;
                }
                else if((ucBank >= 12) && (ucBank <= 13))
                {
                    // Protect Bank 14~15
                    ucWRSR = 0x0A;
                }
...
void ScalerFlashWRDis(void)
{
    ...
    switch(g_ucFlashType)
    {
        ...
        case _FLASH_PY25Q40HB:
            ...
            ScalerFlashSet2ByteWRSR(tFlashInformation[g_ucFlashType].ucProtectWRSR, 0x00, _TRUE);
            ScalerFlashSetWREN(tFlashInformation[g_ucFlashType].ucWRDisOpCode);
            break;
