...
//-----------------------------------------------
#if(_PCB_TYPE == _RL6449_216PIN_HK_M_RTD2775E15_2DP2H_eDPVB1)
...
#if 1//(Project_ID == ID_HK2795E01_BOE_MV270FHM_NF1_FHD280HZ_20231020)
...
// UH1 A0 - HDMI的24C02带切换的，默认要拉低，不切,要做PBP,PIP的时候再去操作
...
#define bLED1                                   (MCU_FE24_PORT84_PIN_REG) // _PIN_184, P8D4
