...
#if(_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON)
#if(_VGA_SUPPORT == _ON)
//#warning "VGA Port Can Not Be Supported!!!"
#endif
#endif
#endif
#endif
...
#if((_D0_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_RTS5400_SERIES) && (_TYPE_C_POWER_SOURCE == _TYPE_C_VBUS_POWER_ONLY) && (_TYPE_C_RTS5400_SERIES_PDO_INFO_SUPPORT == _OFF))
#warning "'_TYPE_C_RTS5400_SERIES_PDO_INFO_SUPPORT' should be selected '_ON' if '_D0_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_RTS5400_SERIES' and '_TYPE_C_POWER_SOURCE == _TYPE_C_VBUS_POWER_ONLY'"
#endif
...
#if((_D1_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_RTS5400_SERIES) && (_TYPE_C_POWER_SOURCE == _TYPE_C_VBUS_POWER_ONLY) && (_TYPE_C_RTS5400_SERIES_PDO_INFO_SUPPORT == _OFF))
#warning "'_TYPE_C_RTS5400_SERIES_PDO_INFO_SUPPORT' should be selected '_ON' if '_D1_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_RTS5400_SERIES' and '_TYPE_C_POWER_SOURCE == _TYPE_C_VBUS_POWER_ONLY'"
#endif
...
#if((_D6_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_RTS5400_SERIES) && (_TYPE_C_POWER_SOURCE == _TYPE_C_VBUS_POWER_ONLY) && (_TYPE_C_RTS5400_SERIES_PDO_INFO_SUPPORT == _OFF))
#warning "'_TYPE_C_RTS5400_SERIES_PDO_INFO_SUPPORT' should be selected '_ON' if '_D6_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_RTS5400_SERIES' and '_TYPE_C_POWER_SOURCE == _TYPE_C_VBUS_POWER_ONLY'"
#endif
...
#if((_LVDS_SETTING_CONTROL_BY_USER == _ON) && (_LVDS_TRIM_DRIV_CURRENT_BY_USER == _ON))
#if((_LVDS_PORTA_DATA0_DRIV_2X_USER_CTRL == _ENABLE) || (_LVDS_PORTA_DATA1_DRIV_2X_USER_CTRL == _ENABLE) ||\
    (_LVDS_PORTA_DATA2_DRIV_2X_USER_CTRL == _ENABLE) || (_LVDS_PORTA_DATA3_DRIV_2X_USER_CTRL == _ENABLE) ||\
    (_LVDS_PORTA_DATA4_DRIV_2X_USER_CTRL == _ENABLE) || (_LVDS_PORTB_DATA0_DRIV_2X_USER_CTRL == _ENABLE) ||\
    (_LVDS_PORTB_DATA1_DRIV_2X_USER_CTRL == _ENABLE) || (_LVDS_PORTB_DATA2_DRIV_2X_USER_CTRL == _ENABLE) ||\
    (_LVDS_PORTB_CLK_DRIV_2X_USER_CTRL == _ENABLE) || (_LVDS_PORTB_DATA3_DRIV_2X_USER_CTRL == _ENABLE) ||\
    (_LVDS_PORTB_DATA4_DRIV_2X_USER_CTRL == _ENABLE))
#if(_LVDS_TRIM_DRIV_CURRENT_USER_ADUST > 3500)
#warning "NOTE: If Use LVDS User Trim Driving Current Mode and 2x Driving Enable, Driving Current didnt exceed 3500uA"
#endif
#else
#if(_LVDS_TRIM_DRIV_CURRENT_USER_ADUST > 7000)
#warning "NOTE: If Use LVDS User Trim Driving Current Mode and 2x Driving Disable, Driving Current didnt exceed 7000uA"
#endif
#endif
#endif
#endif
...
#if((_D0_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_EMBEDDED) && (_TYPE_C_GPIO_MODE_SUPPORT == _ON))
#warning "'_TYPE_C_GPIO_MODE_SUPPORT' Should be '_OFF' if '_D0_DP_TYPE_C_PORT_CTRL_TYPE' = '_PORT_CONTROLLER_EMBEDDED'"
#endif
...
#if((_D1_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_EMBEDDED) && (_TYPE_C_GPIO_MODE_SUPPORT == _ON))
#warning "'_TYPE_C_GPIO_MODE_SUPPORT' Should be '_OFF' if '_D1_DP_TYPE_C_PORT_CTRL_TYPE' = '_PORT_CONTROLLER_EMBEDDED'"
#endif
...
#if((_D6_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_EMBEDDED) && (_TYPE_C_GPIO_MODE_SUPPORT == _ON))
#warning "'_TYPE_C_GPIO_MODE_SUPPORT' Should be '_OFF' if '_D6_DP_TYPE_C_PORT_CTRL_TYPE' = '_PORT_CONTROLLER_EMBEDDED'"
#endif
