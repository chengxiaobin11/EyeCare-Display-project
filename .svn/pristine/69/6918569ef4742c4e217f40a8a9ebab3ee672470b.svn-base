...
void OsdDisplayUpdatePowerBar(BYTE ucPreload)	//���¹��Ľ�����
{
...
void UserAdjustColorNormal(void)
{
	...
	if(GET_COLOR_TEMP_TYPE() == _CT_USER)
		UserCommonAdjustGammaRegionEnable(_FUNCTION_OFF);	//Gamma����
	else
		UserCommonAdjustGammaRegionEnable(_FUNCTION_ON);	//Gamma����
	#endif
