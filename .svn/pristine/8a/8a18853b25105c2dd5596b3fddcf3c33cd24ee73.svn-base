...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6369_Series_Mcu.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6369_SERIES_MCU__
...
#else
BYTE xdata MCU_DDCRAM_D0[_D0_EMBEDDED_DDCRAM_MAX_SIZE]          _at_ _EMBEDDED_DDCRAM_DDC2_ADDRESS;
...
#else
BYTE xdata MCU_DDCRAM_D1[_D1_EMBEDDED_DDCRAM_MAX_SIZE]          _at_ _EMBEDDED_DDCRAM_DDC2_ADDRESS;
...
BYTE xdata MCU_DDCRAM_D2[_D2_EMBEDDED_DDCRAM_MAX_SIZE]          _at_ _EMBEDDED_DDCRAM_DDC0_ADDRESS;
#elif(_D2_DDC_CHANNEL_SEL == _DDC1)
BYTE xdata MCU_DDCRAM_D2[_D2_EMBEDDED_DDCRAM_MAX_SIZE]          _at_ _EMBEDDED_DDCRAM_DDC1_ADDRESS;
#else
...
#elif(_D0_DDC_CHANNEL_SEL == _DDC1)
BYTE xdata MCU_DDCRAM_MHL_D0[_D0_MHL_EMBEDDED_DDCRAM_SIZE]  _at_ _EMBEDDED_DDCRAM_DDC1_MHL_ADDRESS;
#else
BYTE xdata MCU_DDCRAM_MHL_D0[_D0_MHL_EMBEDDED_DDCRAM_SIZE]  _at_ _EMBEDDED_DDCRAM_DDC2_MHL_ADDRESS;
#endif
...
#if(_D1_DDC_CHANNEL_SEL == _DDC0)
BYTE xdata MCU_DDCRAM_MHL_D1[_D1_MHL_EMBEDDED_DDCRAM_SIZE]  _at_ _EMBEDDED_DDCRAM_DDC0_MHL_ADDRESS;
#elif(_D1_DDC_CHANNEL_SEL == _DDC1)
BYTE xdata MCU_DDCRAM_MHL_D1[_D1_MHL_EMBEDDED_DDCRAM_SIZE]  _at_ _EMBEDDED_DDCRAM_DDC1_MHL_ADDRESS;
#else
BYTE xdata MCU_DDCRAM_MHL_D1[_D1_MHL_EMBEDDED_DDCRAM_SIZE]  _at_ _EMBEDDED_DDCRAM_DDC2_MHL_ADDRESS;
#endif
...
#if(_D2_DDC_CHANNEL_SEL == _DDC0)
BYTE xdata MCU_DDCRAM_MHL_D2[_D2_MHL_EMBEDDED_DDCRAM_SIZE]  _at_ _EMBEDDED_DDCRAM_DDC0_MHL_ADDRESS;
#elif(_D2_DDC_CHANNEL_SEL == _DDC1)
BYTE xdata MCU_DDCRAM_MHL_D2[_D2_MHL_EMBEDDED_DDCRAM_SIZE]  _at_ _EMBEDDED_DDCRAM_DDC1_MHL_ADDRESS;
#else
...
volatile BYTE xdata MCU_FE28_DUMMY_1                                _at_ 0xFE28;
volatile BYTE xdata MCU_FE29_DUMMY_2                                _at_ 0xFE29;
volatile BYTE xdata MCU_FE30_DUMMY_3                                _at_ 0xFE30;
...
void ScalerMcuDdcDebounceSel(EnumClkSel enumClock)
{
    ...
    ((_D2_INPUT_PORT_TYPE == _D2_DP_PORT) && (_D2_DDC_CHANNEL_SEL == _DDC0)))
      ...
      ((_D2_TMDS_SUPPORT == _ON) && (_D2_DDC_CHANNEL_SEL == _DDC0)))
    ...
    ((_D2_INPUT_PORT_TYPE == _D2_DP_PORT) && (_D2_DDC_CHANNEL_SEL == _DDC1)))
      ...
      ((_D2_TMDS_SUPPORT == _ON) && (_D2_DDC_CHANNEL_SEL == _DDC1)))
    ...
    ((_D2_INPUT_PORT_TYPE == _D2_DP_PORT) && (_D2_DDC_CHANNEL_SEL == _DDC2)))
        // DDC2 De-bounce Reference Clock(Xtal = 14.318M) div by 1, latch 1 stages
        MCU_FE65_DDC2_DDC_CONTROL_1 &= ~(_BIT7 | _BIT6);
        MCU_FE65_DDC2_DDC_CONTROL_1 |= _BIT4;
#elif(((_D0_TMDS_SUPPORT == _ON) && (_D0_DDC_CHANNEL_SEL == _DDC2)) ||\
      ((_D1_TMDS_SUPPORT == _ON) && (_D1_DDC_CHANNEL_SEL == _DDC2)) ||\
      ((_D2_TMDS_SUPPORT == _ON) && (_D2_DDC_CHANNEL_SEL == _DDC2)))
...
void ScalerMcuGpioInitial(void)
{
    ...
    ScalerSetByte(P10_87_PIN_PULLUP_CTRL0D, 0x55);
...
void ScalerMcuDdcInitial(void)
{
    ...
    MCU_FEB1_DDCRAM_ST_ADDRESS &= ~(_BIT2 | _BIT1 | _BIT0);
    ...
    // DDC2 Force Nack when not embedded EDID
