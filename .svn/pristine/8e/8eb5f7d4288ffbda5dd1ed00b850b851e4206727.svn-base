...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Series_ScalerCommonSyncInclude.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _HDMI_AUDIO_SAMPLE_PACKET                           0x02
...
// Macro of Input Pixel Clk (Unit in 0.1MHz)
//--------------------------------------------------
#define GET_DP_LINK_CLK()                                   (g_ulDpLinkClk)
#define SET_DP_LINK_CLK(x)                                  (g_ulDpLinkClk = (x))
#define CLR_DP_LINK_CLK()                                   (g_ulDpLinkClk = 0)
...
#if((_DP_SUPPORT == _ON) || (_PANEL_STYLE == _PANEL_DPTX))
typedef enum
{
    _DP_AUX_RX1_MODE = 0,
    _DP_AUX_SE_MODE = 1,
...
{
    BYTE b4DpAuxAdjr : 4;
    EnumDpAuxMode enumDpAuxMode;
    EnumDpAuxVth enumDpAuxVth;
} StructDpAuxModeSetting;
#endif
