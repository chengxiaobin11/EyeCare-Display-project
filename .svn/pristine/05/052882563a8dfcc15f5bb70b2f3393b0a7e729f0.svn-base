...
#if(_PANEL_TYPE == _CMO_LVDS_19_WXGA)
//----------------------------------------------------------------------------------------------------
// ID Code      : _CMO_LVDS_19_WXGA.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_WIDTH                         1440
#define _PANEL_DH_END                           1488

#define _PANEL_DH_TOTAL                         1600
#define _PANEL_DH_TOTAL_MAX                     1920
#define _PANEL_DH_TOTAL_MIN                     1500

#define _PANEL_DV_START                         6
#define _PANEL_DV_HEIGHT                        900
#define _PANEL_DV_END                           906

#define _PANEL_DV_TOTAL                         926
#define _PANEL_DV_TOTAL_MAX                     1050
#define _PANEL_DV_TOTAL_MIN                     906

#define _PANEL_DH_SYNC_WIDTH                    8
#define _PANEL_DV_SYNC_HEIGHT                   2

#define _PANEL_PIXEL_CLOCK                      90
#define _PANEL_PIXEL_CLOCK_MAX                  112
#define _PANEL_PIXEL_CLOCK_MIN                  89
...
#endif // End of #if(_PANEL_TYPE == _CMO_LVDS_19_WXGA)
