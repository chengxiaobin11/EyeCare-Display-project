...
#if(_LINE_IN_SUPPORT == _ON)
#if(_INTERNAL_AUDIO_TEST_SUPPORT == _ON)
        if(ScalerAudioGetInternalAudioGenEnable(ucInputPort) == _DISABLE)
#endif
        {
...
void ScalerAudioD0InternalAudioGenSwitch(bit bOn, EnumAudioLeftRightChannelSelect enumAudioLeftRightChannelSelect)
{
    ...
    if(bOn == _ON)
    {
        ...
        // Set S code
        ScalerSetDataPortByte(P2_C9_HDMI_AP, _P2_CA_PT_12_PORT_PAGE2_HDMI_SCAPR, GET_AUDIO_GEN_FREQ_S_CODE());

        // Set D code
        ScalerSetDataPortByte(P2_C9_HDMI_AP, _P2_CA_PT_13_PORT_PAGE2_HDMI_DCAPR0, HIBYTE(GET_AUDIO_GEN_FREQ_D_CODE()));
        ScalerSetDataPortByte(P2_C9_HDMI_AP, _P2_CA_PT_14_PORT_PAGE2_HDMI_DCAPR1, LOBYTE(GET_AUDIO_GEN_FREQ_D_CODE()));
