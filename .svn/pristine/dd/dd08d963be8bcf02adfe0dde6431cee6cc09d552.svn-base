...
#if(_PANEL_TYPE == _BOE_HV320FHB_F4A_LVDS_FHD75HZ)
//----------------------------------------------------------------------------------------------------
// ID Code      : 
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_FREESYNC_MIN_FRAME_RATE          500
...
#define _PANEL_DH_TOTAL_MAX                     3280
...
#define _PANEL_DV_TOTAL_MIN                     1088

#define _PANEL_DH_SYNC_WIDTH                    8
#define _PANEL_DV_SYNC_HEIGHT                   2

#define _PANEL_PIXEL_CLOCK                      144
#define _PANEL_PIXEL_CLOCK_MAX                  185
...
#endif // End of #if(_PANEL_TYPE == _BOE_HV320FHB_F4A_LVDS_FHD75HZ)
