...
typedef struct
{
    ...
    StructTypeCUserPDO pstSnkPdo[7];
...
#if(_DP_TX_SUPPORT == _ON)
extern EnumDPTxInputSource UserCommonInterfaceDpTxGetStreamSource(void);
#endif
...
#if(_DVI_SUPPORT == _ON)
extern bit UserCommonInterfacePowerCheckFakeOff(void);
extern void UserCommonInterfaceTmdsHotPlugDdcConfig(BYTE ucInputPort, bit bEnable);
extern void UserCommonInterfaceTmdsHdcpVersionCapabilitySwitch(EnumSourceSearchPort enumInputPort, EnumTmdsHdcpType enumTmdsHdcpType);
#endif
...
extern void UserAdjustSetOverScanStatus(bit tempOverScan);
#endif
