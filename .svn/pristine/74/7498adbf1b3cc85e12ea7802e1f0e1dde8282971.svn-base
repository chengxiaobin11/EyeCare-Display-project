...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6463_DEMO_76PIN_1A1DP_PC99.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6463_DEMO_76PIN_1A1DP_PC99)
...
// Series Pin Share //
//////////////////////
#include "RL6463_DEMO_76PIN_1A1DP_PC99_PINSHARE.h"
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (_76PIN_PIN_29_MCU_REG)
...
#endif // End of #if(_PCB_TYPE == _RL6463_DEMO_76PIN_1A1DP_PC99)
