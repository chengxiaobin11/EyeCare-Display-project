...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432_Project.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _RL6432_PROJECT)
...
#define _CAPABILITIES_STRING_DP                               "(prot(monitor)type(LCD)model(MKF27F240L)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 08 0B 0C 10 12 14(01 04 05 06 08 0B)  16 18 1A 21(01 02 03 04 05) 25(01 02 03) 27 2B 31 33 52 60(0F 11 12) 61 62 64 6C 6E 70 72 87 8D AC AE B2 B6 C0 C6 C8 C9 CA CC(03 04 0a 0c 05 01 06 07 16 09 02 0b 0d 12) D6(01 04 05) DA(01 02) DB(01 02 03 04) DC(00 03 04 30 32 33 34 35 36 3E) DF E0 E1(00 19 32 4B 64) E2 E3(00 01 02) E7(00 1E 2D 3C 78))mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                             "(prot(monitor)type(LCD)model(MKF27F240L)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 08 0B 0C 10 12 14(01 04 05 06 08 0B)  16 18 1A 21(01 02 03 04 05) 25(01 02 03) 27 2B 31 33 52 60(0F 11 12) 61 62 64 6C 6E 70 72 87 8D AC AE B2 B6 C0 C6 C8 C9 CA CC(03 04 0a 0c 05 01 06 07 16 09 02 0b 0d 12) D6(01 04 05) DA(01 02) DB(01 02 03 04) DC(00 03 04 30 32 33 34 35 36 3E) DF E0 E1(00 19 32 4B 64) E2 E3(00 01 02) E7(00 1E 2D 3C 78))mswhql(1)asset_eep(40)mccs_ver(2.2))"
#else
...
#define _HW_DISPLAY_ROTATION_180_SUPPORT                        _OFF
...
#if _IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT
#define _OOR_H_FREQ_UPPER_BOUND                                 6500 // Unit in 0.1 kHZ
#define _OOR_H_FREQ_LOWER_BOUND                                 100  // Unit in 0.1 kHZ
#define _OOR_V_FREQ_UPPER_BOUND                                 6100 // Unit in 0.1 HZ
#define _OOR_V_FREQ_LOWER_BOUND                                 230  // Unit in 0.1 HZ
#define _OOR_H_WIDTH_UPPER_BOUND                                9096 // Unit in pixel
#define _OOR_V_HEIGHT_LOWER_BOUND                               240  // Unit in line

#define _FAIL_SAVE_H_FREQ_UPPER_BOUND                           6500 // Unit in 0.1 kHZ
#define _FAIL_SAVE_H_FREQ_LOWER_BOUND                           110  // Unit in 0.1 kHZ
#define _FAIL_SAVE_V_FREQ_UPPER_BOUND                           6100 // Unit in 0.1 HZ
...
#define _OOR_H_FREQ_LOWER_BOUND                                 100  // Unit in 0.1 kHZ
#define _OOR_V_FREQ_UPPER_BOUND                                 1700 // Unit in 0.1 HZ
#define _OOR_V_FREQ_LOWER_BOUND                                 230  // Unit in 0.1 HZ
...
#define _FAIL_SAVE_H_FREQ_LOWER_BOUND                           110  // Unit in 0.1 kHZ
#define _FAIL_SAVE_V_FREQ_UPPER_BOUND                           1700 // Unit in 0.1 HZ
#define _FAIL_SAVE_V_FREQ_LOWER_BOUND                           230  // Unit in 0.1 HZ

#define _INPUTCLOCK_RANG_VGA                                    2100 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_DVI                                    3400 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_HDMI                                   3400 // Unit in 0.1 MHz, Max 4450 (441MHz + 1%) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
#define _INPUTCLOCK_RANG_DP                                     3600 // Unit in 0.1 MHz, Max 4300 (423.6MHz + 1%) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
#define _INPUTCLOCK_RANG_USBC                                   3600 // Unit in 0.1 MHz, Max 4300 (423.6MHz + 1%) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
#endif
/////////
// VGA //
/////////
...
#define _HDMI_SINK_RTK_ID_STRING_L                              0x85
...
#define _LINE_IN_VOLUME_MAX                                     0x2000                      // MAX: 0x3FFF
#define _LINE_IN_VOLUME_MIN                                     0x0000
//#define _LINE_IN_VOLUME_CENTER									0x1600
...
#define _DIGITAL_VOLUME_MAX                                     0X1EEE                      // MAX: 0x3FFF
#define _DIGITAL_VOLUME_MIN                                     0x0000
//#define _DIGITAL_VOLUME_CENTER									0x14E0
...
#endif // End of #if(_PROJECT == _RL6432_PROJECT)
