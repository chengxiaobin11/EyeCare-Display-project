...
//----------------------------------------------------------------------------------------------------
// ID Code      : _RL6463_PCB_EXAMPLE_76_PIN.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6463_PCB_EXAMPLE_76_PIN)
...
// Series Pin Share //
//////////////////////
#include "RL6463_PCB_EXAMPLE_76_PIN_PINSHARE.h"
...
#endif // End of #if(_PCB_TYPE == _RL6463_PCB_EXAMPLE_76_PIN)
