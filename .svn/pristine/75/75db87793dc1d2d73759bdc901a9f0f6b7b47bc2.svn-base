...
EnumTypeCCcDetectStatus ScalerTypeCGetCcPinStatus(EnumTypeCChannel enumTypeCChannel);
#endif
...
void ScalerTypeCGpioModeInitialSetting(void)
{
    ...
    ScalerTypeCRx0CcGpioModeInitialSetting();
}

//--------------------------------------------------
// Description  : Return CC Pin Status to SysTypeC
...
EnumTypeCCcDetectStatus ScalerTypeCGetCcPinStatus(EnumTypeCChannel enumTypeCChannel)
{
    return ScalerTypeCRx0CcGetCcPinStatus(enumTypeCChannel);
}
