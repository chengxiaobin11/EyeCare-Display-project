...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6369_Project.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _RL6369_PROJECT)
...
// Pcb Option
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6369_QA_128PIN_1A2MHL1DP
...
#define _FAIL_SAVE_V_FREQ_UPPER_BOUND                           845  // Unit in 0.1 HZ
...
#define _INPUTCLOCK_RANG_HDMI                                   2250 // Unit in 0.1 MHz, Max 3000 (297MHz + 3MHz margin) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
#define _INPUTCLOCK_RANG_DP                                     2250 // Unit in 0.1 MHz, Max 2350 (230MHz + 5MHz margin) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
...
#endif // End of #if(_PROJECT == _RL6369_PROJECT)
