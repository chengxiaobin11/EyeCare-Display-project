...
//--------------------------------------------------
// Definitions for Memory Clock Speed
//--------------------------------------------------
#if(_SCALER_TYPE == _RL6851_SERIES)
...
#if(_PANEL_PIXEL_CLOCK_MAX_KHZ > 260000)
#define _M2PLL_FREQ_SEL_BY_SDRAM_CLK                        _M2PLL_FREQ_220M
#elif(_PANEL_PIXEL_CLOCK_MAX_KHZ > 235000)
#define _M2PLL_FREQ_SEL_BY_SDRAM_CLK                        _M2PLL_FREQ_216M
#elif(_PANEL_PIXEL_CLOCK_MAX_KHZ <= 235000)
#define _M2PLL_FREQ_SEL_BY_SDRAM_CLK                        _M2PLL_FREQ_189M
#endif

#else

#if(_MULTIPANEL_ULTRA_HIGH_SPEED_PIXEL_CLOCK_MAX == _MULTIPANEL_CLOCK_MAX_FHD_120_HZ)
#define _M2PLL_FREQ_SEL_BY_SDRAM_CLK                        _M2PLL_FREQ_220M
#elif(_MULTIPANEL_ULTRA_HIGH_SPEED_PIXEL_CLOCK_MAX == _MULTIPANEL_CLOCK_MAX_WUXGA_100_HZ)
#define _M2PLL_FREQ_SEL_BY_SDRAM_CLK                        _M2PLL_FREQ_216M
#elif(_MULTIPANEL_ULTRA_HIGH_SPEED_PIXEL_CLOCK_MAX == _MULTIPANEL_CLOCK_MAX_FHD_100_HZ)
#define _M2PLL_FREQ_SEL_BY_SDRAM_CLK                        _M2PLL_FREQ_189M
#endif
...
#if(_LVDS_ULTRA_HIGH_SPEED_SUPPORT == _ON)
#if(_PANEL_EXIST_MULTIPANEL == _OFF)

#if(_PANEL_PIXEL_CLOCK_MAX_KHZ > 260000)
#define _MPLL_FREQ_SEL_BY_SDRAM_CLK                         _MEMORY_SPEED_220MHZ
#elif(_PANEL_PIXEL_CLOCK_MAX_KHZ > 235000)
#define _MPLL_FREQ_SEL_BY_SDRAM_CLK                         _MEMORY_SPEED_216MHZ
#elif(_PANEL_PIXEL_CLOCK_MAX_KHZ <= 235000)
#define _MPLL_FREQ_SEL_BY_SDRAM_CLK                         _MEMORY_SPEED_198MHZ
#endif
...
#endif // End of #if(_LVDS_ULTRA_HIGH_SPEED_SUPPORT == _ON)
...
#define _DB_GAIN_DOWN_VALUE                                 _DB_GAIN_1_8_DB   // Audio DVC Use Normal-Mode Control (_DB_GAIN)

#undef _DB_GAIN_UP_VALUE
#define _DB_GAIN_UP_VALUE                                   _DB_GAIN_1_8_DB   // Audio DVC Use Normal-Mode Control (_DB_GAIN)

#undef _AUDIO_DVC_FAST_CONTROL_SUPPORT
#define _AUDIO_DVC_FAST_CONTROL_SUPPORT                     _OFF

#undef _DB_GAIN_FAST_DOWN_VALUE
#define _DB_GAIN_FAST_DOWN_VALUE                            _DB_GAIN_1_8_DB   // Audio DVC Use Fast-Mode Control (_DB_GAIN)

#undef _DB_GAIN_FAST_UP_VALUE
#define _DB_GAIN_FAST_UP_VALUE                              _DB_GAIN_1_8_DB   // Audio DVC Use Fast-Mode Control (_DB_GAIN)
...
#define _DVC_VOLUME_MUTE_TIMER                              400 // Audio DVC Use Normal-Mode Control (ms)

#undef _DVC_FAST_VOLUME_MUTE_TIMER
#define _DVC_FAST_VOLUME_MUTE_TIMER                         10 // Audio DVC Use Fast-Mode Control (ms)

#undef _DVC_FAST_VOLUME_UNMUTE_TIMER
#define _DVC_FAST_VOLUME_UNMUTE_TIMER                       75 // Audio DVC Use Fast-Mode Control (ms)
...
#undef _INTERNAL_AUDIO_CHANNEL_CONFIG_BY_USER_SUPPORT
...
#undef _DIGITAL_AUDIO_OUTPUT_MUTE_CONTROL_SUPPORT
#define _DIGITAL_AUDIO_OUTPUT_MUTE_CONTROL_SUPPORT          _OFF
#endif
...
#undef _DP_WD_REBUILD_PHY_4PART_FOR_UCD400
#define _DP_WD_REBUILD_PHY_4PART_FOR_UCD400                 _OFF
...
#undef _USER_DP_LONG_HPD_TIME_VALUE
#define _USER_DP_LONG_HPD_TIME_VALUE                        800

#undef _USER_DP_HDCP_LONG_HPD_TIME_VALUE
#define _USER_DP_HDCP_LONG_HPD_TIME_VALUE                   800

#undef _DP_COLORIMTRY_SEAMLESS_COLOR_INFO_CHECK_BYPASS
#define _DP_COLORIMTRY_SEAMLESS_COLOR_INFO_CHECK_BYPASS     _OFF

#undef _DP_PROJECT_TIMING_MAX_PIXEL_CLOCK_MHZ
#define _DP_PROJECT_TIMING_MAX_PIXEL_CLOCK_MHZ              (_INPUTCLOCK_RANG_DP / 10)

#undef _DP_PROJECT_TIMING_MAX_COLOR_DEPTH
#define _DP_PROJECT_TIMING_MAX_COLOR_DEPTH                  _COLOR_DEPTH_12_BITS
...
#undef _DP_MST_MAC_BW_LIMITED_BY_PROJECT_TIMING_SUPPORT
#define _DP_MST_MAC_BW_LIMITED_BY_PROJECT_TIMING_SUPPORT    _OFF
#endif
...
#undef _TYPE_C_EMB_SRC_DEF_CUR
#define _TYPE_C_EMB_SRC_DEF_CUR                             _TYPE_C_SRC_DEF_3P0A

#undef _TYPE_C_POWER_SOURCE
...
//--------------------------------------------------
#if((_TYPE_C_POWER_SOURCE != _TYPE_C_VBUS_POWER_ONLY) && (_D0_DP_TYPE_C_EMB_DEAD_BATTERY_SUPPORT == _ON) && (_TYPE_C_EMB_CTS_FLOW == _OFF))
...
#elif(_M2PLL_FREQ_SEL == _M2PLL_FREQ_216M)
...
#elif(_M2PLL_FREQ_SEL == _M2PLL_FREQ_220M)

#if(_FLASH_CLK_SPEED == _FLASH_FAST_SPEED)
    _FLASH_CLK_DIV = _DIV_2, // _DIV_2
#elif(_FLASH_CLK_SPEED == _FLASH_LOW_SPEED)
    _FLASH_CLK_DIV = _DIV_4,
    _FLASH_CLK_FAST_DIV = _DIV_2,
#endif
...
typedef enum
{
    ...
    _M2PLL_DELAY4US_CNT = 22,
#elif(_M2PLL_FREQ_SEL == _M2PLL_FREQ_216M)
    _M2PLL_DELAY6US_CNT = 34,
    _M2PLL_DELAY4US_CNT = 26,
#elif(_M2PLL_FREQ_SEL == _M2PLL_FREQ_220M)
    _M2PLL_DELAY6US_CNT = 34,
    _M2PLL_DELAY4US_CNT = 26,
#endif
