...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Series_ScalerCommonMcu.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
void ScalerMcuHwIICInitial(void)
{
    ...
    MCU_FF59_I2CM_STR0 = 0x00;

    // Set fall time period count
    MCU_FFD7_I2CM_STR4 = _HW_IIC_FTPC;

    // Set STA setup time period count
    MCU_FF5A_I2CM_STR1 = _HW_IIC_STA_SUGPIO_C;

    // Set I2C Master Repeated_Start Hold Time
    MCU_FFD8_I2CM_STR5 = _HW_IIC_STA_SUGPIO_C + 2;
