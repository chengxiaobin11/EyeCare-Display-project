...
void ScalerAudioD2InternalAudioGenSwitch(bit bOn, EnumAudioLeftRightChannelSelect enumAudioLeftRightChannelSelect);
#endif
#endif
...
void ScalerAudioD3InternalAudioGenSwitch(bit bOn, EnumAudioLeftRightChannelSelect enumAudioLeftRightChannelSelect);
#endif
...
void ScalerAudioD4InternalAudioGenSwitch(bit bOn, EnumAudioLeftRightChannelSelect enumAudioLeftRightChannelSelect);
#endif
...
void ScalerAudioD5InternalAudioGenSwitch(bit bOn, EnumAudioLeftRightChannelSelect enumAudioLeftRightChannelSelect);
#endif
...
void ScalerAudioD0DPAudioInitial(void)
{
    ...
    ScalerSetByte(PB6_B3_DP_CHANNEL_EN, 0x00);
#endif
...
#if(_DIGITAL_AUDIO_OUTPUT_MUTE_CONTROL_SUPPORT == _ON)
    // Disable Audio Output
    ScalerSetByte(PB9_B3_DP_CHANNEL_EN, 0x00);
#endif
...
void ScalerAudioD3InternalAudioGenSwitch(bit bOn, EnumAudioLeftRightChannelSelect enumAudioLeftRightChannelSelect)
{
    ...
    if(bOn == _ON)
    {
        ...
        // Set S code
        ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_12_PORT_PAGE72_HDMI_SCAPR, GET_AUDIO_GEN_FREQ_S_CODE());

        // Set D code
        ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_13_PORT_PAGE72_HDMI_DCAPR0, HIBYTE(GET_AUDIO_GEN_FREQ_D_CODE()));
        ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_14_PORT_PAGE72_HDMI_DCAPR1, LOBYTE(GET_AUDIO_GEN_FREQ_D_CODE()));
...
#if(_DIGITAL_AUDIO_OUTPUT_MUTE_CONTROL_SUPPORT == _ON)
    // Set auto gain delay mode and final gain
    ScalerSetDataPortBit(P73_C9_HDMI_AP, _P73_CA_PT_07_PORT_PAGE73_HDMI_MAG_M_FINAL, ~(_BIT3 | _BIT1 | _BIT0), 0x00);
...
void ScalerAudioD4InternalAudioGenSwitch(bit bOn, EnumAudioLeftRightChannelSelect enumAudioLeftRightChannelSelect)
{
    ...
    if(bOn == _ON)
    {
        ...
        // Set S code
        ScalerSetDataPortByte(P73_C9_HDMI_AP, _P73_CA_PT_12_PORT_PAGE73_HDMI_SCAPR, GET_AUDIO_GEN_FREQ_S_CODE());

        // Set D code
        ScalerSetDataPortByte(P73_C9_HDMI_AP, _P73_CA_PT_13_PORT_PAGE73_HDMI_DCAPR0, HIBYTE(GET_AUDIO_GEN_FREQ_D_CODE()));
        ScalerSetDataPortByte(P73_C9_HDMI_AP, _P73_CA_PT_14_PORT_PAGE73_HDMI_DCAPR1, LOBYTE(GET_AUDIO_GEN_FREQ_D_CODE()));
        ...
        {
            // HDMI MAC DVC Mute Off Left channel
            ScalerSetDataPortBit(P73_C9_HDMI_AP, _P73_CA_PT_07_PORT_PAGE73_HDMI_MAG_M_FINAL, ~(_BIT1 | _BIT0), (_BIT1));
        }
        else if(enumAudioLeftRightChannelSelect == _AUDIO_RIGHT_CHANNEL)
        {
            // HDMI MAC DVC Mute Off Right channel
            ScalerSetDataPortBit(P73_C9_HDMI_AP, _P73_CA_PT_07_PORT_PAGE73_HDMI_MAG_M_FINAL, ~(_BIT1 | _BIT0), (_BIT0));
        }
        else
        {
            // HDMI MAC DVC Mute Off
...
#if(_DIGITAL_AUDIO_OUTPUT_MUTE_CONTROL_SUPPORT == _ON)
    // Set auto gain delay mode and final gain
    ScalerSetDataPortBit(P74_C9_HDMI_AP, _P74_CA_PT_07_PORT_PAGE74_HDMI_MAG_M_FINAL, ~(_BIT3 | _BIT1 | _BIT0), 0x00);
...
void ScalerAudioD5InternalAudioGenSwitch(bit bOn, EnumAudioLeftRightChannelSelect enumAudioLeftRightChannelSelect)
{
    ...
    if(bOn == _ON)
    {
        ...
        // Set S code
        ScalerSetDataPortByte(P74_C9_HDMI_AP, _P74_CA_PT_12_PORT_PAGE74_HDMI_SCAPR, GET_AUDIO_GEN_FREQ_S_CODE());

        // Set D code
        ScalerSetDataPortByte(P74_C9_HDMI_AP, _P74_CA_PT_13_PORT_PAGE74_HDMI_DCAPR0, HIBYTE(GET_AUDIO_GEN_FREQ_D_CODE()));
        ScalerSetDataPortByte(P74_C9_HDMI_AP, _P74_CA_PT_14_PORT_PAGE74_HDMI_DCAPR1, LOBYTE(GET_AUDIO_GEN_FREQ_D_CODE()));
        ...
        {
            // HDMI MAC DVC Mute Off Left channel
            ScalerSetDataPortBit(P74_C9_HDMI_AP, _P74_CA_PT_07_PORT_PAGE74_HDMI_MAG_M_FINAL, ~(_BIT1 | _BIT0), (_BIT1));
        }
        else if(enumAudioLeftRightChannelSelect == _AUDIO_RIGHT_CHANNEL)
        {
            // HDMI MAC DVC Mute Off Right channel
            ScalerSetDataPortBit(P74_C9_HDMI_AP, _P74_CA_PT_07_PORT_PAGE74_HDMI_MAG_M_FINAL, ~(_BIT1 | _BIT0), (_BIT0));
        }
        else
        {
            // HDMI MAC DVC Mute Off
