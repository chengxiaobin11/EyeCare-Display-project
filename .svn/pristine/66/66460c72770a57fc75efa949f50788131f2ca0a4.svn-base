...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432_QA_A_216PIN_1A2MHL1DP1mDP_DPTX_LVDS_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432_QA_A_216PIN_1A2MHL1DP1mDP_DPTX_LVDS_eDP)
...
// Series Pin Share //
//////////////////////
#include "RL6432_QA_A_216PIN_1A2MHL1DP1mDP_DPTX_LVDS_eDP_PINSHARE.h"
...
//-----------------------------------------------
#define bD0_HPD                                 (MCU_FE23_PORT83_PIN_REG) // Pin_200, P8.3
#define bD1_HPD                                 (MCU_FE22_PORT82_PIN_REG) // Pin_201, P8.2
...
// Macro of LED On/Off
//--------------------------------------------------
#define bLED1                                   (MCU_FE17_PORT67_PIN_REG) // Pin_180, P6.7
#define bLED2                                   (MCU_FE16_PORT66_PIN_REG) // Pin_179, P6.6
#define bLED3                                   (MCU_FE0E_PORT56_PIN_REG) // Pin_166, P5.6
#define bLED4                                   (MCU_FE0D_PORT55_PIN_REG) // Pin_165, P5.5
#define bLED5                                   (MCU_FE0C_PORT54_PIN_REG) // Pin_164, P5.4
...
#endif // End of #if(_PCB_TYPE == _RL6432_QA_A_216PIN_1A2MHL1DP1mDP_DPTX_LVDS_eDP)
