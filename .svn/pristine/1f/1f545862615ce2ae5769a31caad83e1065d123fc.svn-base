...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6369_DEMO_76PIN_1A1DP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6369_DEMO_76PIN_1A1DP)
...
// Series Pin Share //
//////////////////////
#include "RL6369_DEMO_76PIN_1A1DP_PINSHARE.h"
...
//-----------------------------------------------
#define bFLASH_WRITE_PROTECT                    (MCU_FE18_PORT70_PIN_REG)  // 76PIN_PIN_58
...
//-----------------------------------------------
#define bEEPROM_WRITE_PROTECT                   (MCU_FE0B_PORT53_PIN_REG) // 76Pin_Pin37
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_FE19_PORT71_PIN_REG) // 76Pin_Pin59
...
//-----------------------------------------------
#define bD1_DP_PIN15_CONNECT                    (P3_3)   // Pin_30, P3.3
#define bD1_DP_PIN16_CONNECT                    (P1_3)   // Pin_22, P1.3
#define bD1_DP_PIN17_CONNECT                    (P3_2)   // Pin_29, P3.2

#define bA0_CONNECT                             (P1_2) // Pin_21, P1.2
...
//-----------------------------------------------
#define bD1_HPD                                 (P1_4) // Pin_23, P1.4
...
//-----------------------------------------------
#define AD_KEY0                                 (MCU_FF09_ADC_A0_CONVERT_RESULT) // 76pin_27pin , P3.0
#define AD_KEY1                                 (MCU_FF0A_ADC_A1_CONVERT_RESULT) // 76pin_28pin , P3.1
...
#endif // End of #if(_PCB_TYPE == _RL6369_DEMO_76PIN_1A1DP)
