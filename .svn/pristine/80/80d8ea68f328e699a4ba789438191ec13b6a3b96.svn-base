...
void ScalerDpRx0AuxPowerOnInitial(void)
{
    BYTE ucConnectorType = ScalerSyncDpRxGetConnectorType(GET_DP_EMBEDDED_SWITCH_SELECT());
...
void ScalerDpRx0PassiveDFEFineTune(void)
{
    ...
    else if(GET_DP_RX0_LINK_TRAINING_STATUS() == _DP_NORMAL_LINK_TRAINING_PASS)
    {
        ScalerSetBit(P1D_A2_L0_LIMIT_INIT, ~(_BIT4 | _BIT3 | _BIT2), ScalerGetBit(P1D_A4_L0_INIT_2, (_BIT7 | _BIT6 | _BIT5)) >> 3);
        ScalerSetBit(P1D_A2_L0_LIMIT_INIT, ~(_BIT1 | _BIT0), ScalerGetBit(P1D_A5_L0_INIT_3, (_BIT7 | _BIT6)) >> 6);
        ScalerSetBit(P1D_B2_L1_LIMIT_INIT, ~(_BIT4 | _BIT3 | _BIT2), ScalerGetBit(P1D_B4_L1_INIT_2, (_BIT7 | _BIT6 | _BIT5)) >> 3);
        ScalerSetBit(P1D_B2_L1_LIMIT_INIT, ~(_BIT1 | _BIT0), ScalerGetBit(P1D_B5_L1_INIT_3, (_BIT7 | _BIT6)) >> 6);
        ScalerSetBit(P1D_C2_L2_LIMIT_INIT, ~(_BIT4 | _BIT3 | _BIT2), ScalerGetBit(P1D_C4_L2_INIT_2, (_BIT7 | _BIT6 | _BIT5)) >> 3);
        ScalerSetBit(P1D_C2_L2_LIMIT_INIT, ~(_BIT1 | _BIT0), ScalerGetBit(P1D_C5_L2_INIT_3, (_BIT7 | _BIT6)) >> 6);
        ScalerSetBit(P1D_D2_L3_LIMIT_INIT, ~(_BIT4 | _BIT3 | _BIT2), ScalerGetBit(P1D_D4_L3_INIT_2, (_BIT7 | _BIT6 | _BIT5)) >> 3);
        ScalerSetBit(P1D_D2_L3_LIMIT_INIT, ~(_BIT1 | _BIT0), ScalerGetBit(P1D_D5_L3_INIT_3, (_BIT7 | _BIT6)) >> 6);
    }
    else
    {
        ScalerSetByte(P1D_A2_L0_LIMIT_INIT, ucLELevel2);
        ScalerSetByte(P1D_B2_L1_LIMIT_INIT, ucLELevel2);
        ScalerSetByte(P1D_C2_L2_LIMIT_INIT, ucLELevel2);
        ScalerSetByte(P1D_D2_L3_LIMIT_INIT, ucLELevel2);
    }

    // HBR Reload Tap0 = 21
    if(ScalerDpRx0GetDpcdInfo(0x00, 0x01, 0x00) == _DP_LINK_HBR)
    {
        ScalerSetBit(P1D_A4_L0_INIT_2, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT2 | _BIT0));
        ScalerSetBit(P1D_B4_L1_INIT_2, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT2 | _BIT0));
        ScalerSetBit(P1D_C4_L2_INIT_2, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT2 | _BIT0));
        ScalerSetBit(P1D_D4_L3_INIT_2, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT2 | _BIT0));
    }
...
void ScalerDpRx0SetDFEInitial(EnumDpLinkRate enumDpLinkRate)
{
    ...
    ScalerSetBit(P1D_A4_L0_INIT_2, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2 | _BIT1 | _BIT0));
    ScalerSetBit(P1D_B4_L1_INIT_2, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2 | _BIT1 | _BIT0));
    ScalerSetBit(P1D_C4_L2_INIT_2, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2 | _BIT1 | _BIT0));
    ScalerSetBit(P1D_D4_L3_INIT_2, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2 | _BIT1 | _BIT0));

    // Tap1 Initial Value = 0
    ScalerSetBit(P1D_A5_L0_INIT_3, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
    ScalerSetBit(P1D_B5_L1_INIT_3, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
    ScalerSetBit(P1D_C5_L2_INIT_3, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
    ScalerSetBit(P1D_D5_L3_INIT_3, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
