...
//----------------------------------------------------------------------------------------------------
// ID Code      : ScalerCommonDPRxMSTInclude.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
// Definitions of MAC Bandwidth
//--------------------------------------------------
#define _DP_MST_D0_PBN_PER_TIMESLOT_MAX                                                         (_D0_DP_LINK_CLK_RATE * _D0_DP_MAIN_LINK_LANES / 2)
#define _DP_MST_D1_PBN_PER_TIMESLOT_MAX                                                         (_D1_DP_LINK_CLK_RATE * _D1_DP_MAIN_LINK_LANES / 2)
#define _DP_MST_PBN_PER_TIMESLOT_MAX                                                            ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? _DP_MST_D0_PBN_PER_TIMESLOT_MAX : _DP_MST_D1_PBN_PER_TIMESLOT_MAX)

#if(_DP_MST_MAC_BW_LIMITED_BY_PROJECT_TIMING_SUPPORT == _ON)
#define _DP_PROJECT_TIMING_MAX_PBN                                                              ((DWORD)_DP_PROJECT_TIMING_MAX_PIXEL_CLOCK_MHZ * _DP_PROJECT_TIMING_MAX_COLOR_DEPTH * 3 / 8 * 64 / 54)
#define _DP_PROJECT_TIMING_MAX_TIMESLOT                                                         CEILING_OF_INT_DIVISION(_DP_PROJECT_TIMING_MAX_PBN, _DP_MST_PBN_PER_TIMESLOT_MAX)
#define _DP_MST_MAC_MAX_BW                                                                      (_DP_MST_PBN_PER_TIMESLOT_MAX *\
                                                                                                 ((_DP_PROJECT_TIMING_MAX_TIMESLOT < _DP_TOTAL_TIME_SLOT_NUM) ?\
                                                                                                   _DP_PROJECT_TIMING_MAX_TIMESLOT : _DP_TOTAL_TIME_SLOT_NUM))
#else
#define _DP_MST_MAC_MAX_BW                                                                      _HW_DP_MST_MAC_MAX_BW
#endif
#endif
...
#define _DOWN_REPLY_MANUAL_MODE_MAX_LEN                                                         32
...
//--------------------------------------------------
// Definitions of MST DDCRAM SIZE
//--------------------------------------------------
#define GET_DP_MST_DDCRAM_SIZE()                                                                (g_usDpMstDdcRamSize)
#define SET_DP_MST_DDCRAM_SIZE(x)                                                               (g_usDpMstDdcRamSize = (x))
#define CLR_DP_MST_DDCRAM_SIZE()                                                                (g_usDpMstDdcRamSize = _EDID_SIZE_NONE)
...
#define SET_DP_MST_HPD_IRQ()                                                                    ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? ScalerDpRx0HpdIrqAssert() : ScalerDpRx1HpdIrqAssert())
#define GET_DP_CHECK_AUX_CH_POWER_STATUS()                                                      ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? GET_DP_RX0_CHECK_AUX_CH_POWER_STATUS() : GET_DP_RX1_CHECK_AUX_CH_POWER_STATUS())
...
#define GET_DP_RX_MST_SOURCE_WRITE_POWER_UP()                                                   ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? GET_DP_RX0_SOURCE_WRITE_POWER_UP() : GET_DP_RX1_SOURCE_WRITE_POWER_UP())
...
#define GET_DP_DPCD_02200H_STATUS()                                                             ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? g_ucDpRx0DPCD02200hValue : g_ucDpRx1DPCD02200hValue)
#define GET_DP_DPCD_02201H_STATUS()                                                             ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? g_ucDpRx0DPCD02201hValue : g_ucDpRx1DPCD02201hValue)
#define GET_DP_DPCD_02210H_STATUS()                                                             ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? g_ucDpRx0DPCD02210hValue : g_ucDpRx1DPCD02210hValue)

#if(_DP_TX_SUPPORT == _ON)
//--------------------------------------------------
// Definitions of Rx HDCP Macro
//--------------------------------------------------
#define GET_DP_RX_HDCP_AUTH_ENCRYPTION()                                                        ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? ScalerDpRx0HdcpCheckValid() : ScalerDpRx1HdcpCheckValid())
...
#define GET_REG_DP_RX_HDCP_M0_0()                                                               ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? GET_DP_RX0_HDCP_M0_0() : GET_DP_RX1_HDCP_M0_0())
#define GET_REG_DP_RX_HDCP_M0_1()                                                               ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? GET_DP_RX0_HDCP_M0_1() : GET_DP_RX1_HDCP_M0_1())
#define GET_REG_DP_RX_HDCP_M0_2()                                                               ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? GET_DP_RX0_HDCP_M0_2() : GET_DP_RX1_HDCP_M0_2())
#define GET_REG_DP_RX_HDCP_M0_3()                                                               ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? GET_DP_RX0_HDCP_M0_3() : GET_DP_RX1_HDCP_M0_3())
#define GET_REG_DP_RX_HDCP_M0_4()                                                               ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? GET_DP_RX0_HDCP_M0_4() : GET_DP_RX1_HDCP_M0_4())
#define GET_REG_DP_RX_HDCP_M0_5()                                                               ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? GET_DP_RX0_HDCP_M0_5() : GET_DP_RX1_HDCP_M0_5())
#define GET_REG_DP_RX_HDCP_M0_6()                                                               ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? GET_DP_RX0_HDCP_M0_6() : GET_DP_RX1_HDCP_M0_6())
#define GET_REG_DP_RX_HDCP_M0_7()                                                               ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? GET_DP_RX0_HDCP_M0_7() : GET_DP_RX1_HDCP_M0_7())

#define SET_DP_RX_DFP_DEVICE_DETAIL_CONFIG()                                                    ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? ScalerDpRx0DfpDeviceDetailConfig() : ScalerDpRx1DfpDeviceDetailConfig())
#define RST_DP_RX_DFP_DEVICE_DETAIL_CONFIG()                                                    ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? ScalerDpRx0DfpDeviceDetailConfigReset() : ScalerDpRx1DfpDeviceDetailConfigReset())
#endif

#if(_DP_HDCP_2_2_SUPPORT == _ON)
#define GET_DP_RX_HDCP2_MODE()                                                                  ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? (GET_DP_RX0_HDCP2_MODE()) : (GET_DP_RX1_HDCP2_MODE()))
#define GET_DP_RX_HDCP2_AUTH_PROC_DONE()                                                        ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? (GET_DP_RX0_HDCP2_AUTH_STATE() == _DP_RX_HDCP2_REPEATER_STATE_AUTH_DONE) : (GET_DP_RX1_HDCP2_AUTH_STATE() == _DP_RX_HDCP2_REPEATER_STATE_AUTH_DONE))
#define GET_DP_RX_HDCP2_REPEATER_SUPPORTED()                                                    ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? (ScalerDpRx0GetDpcdInfo(0x06, 0x92, 0x1F) == (_BIT1 | _BIT0)) : (ScalerDpRx1GetDpcdInfo(0x06, 0x92, 0x1F) == (_BIT1 | _BIT0)))
#define SET_DP_RX_HDCP2_LPRIME_CAL(x)                                                           ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? ScalerHdcp2RepeaterLPrimeCalculate(g_pucDpRx0Hdcp2dKey0, g_pucDpRx0Hdcp2dKey1, (x)) : ScalerHdcp2RepeaterLPrimeCalculate(g_pucDpRx1Hdcp2dKey0, g_pucDpRx1Hdcp2dKey1, (x)))
#define GET_DP_RX_HDCP2_V(x)                                                                    ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? (g_pucDpRx0Hdcp2VPrime[x]) : (g_pucDpRx1Hdcp2VPrime[x]))
#endif
...
#define SET_DP_MST_HPD_IRQ()                                                                    (ScalerDpRx0HpdIrqAssert())
#define GET_DP_CHECK_AUX_CH_POWER_STATUS()                                                      (GET_DP_RX0_CHECK_AUX_CH_POWER_STATUS())
#define GET_DP_SOURCE_FIRST_POWER_ON()                                                          (GET_DP_RX0_SOURCE_FIRST_POWER_ON())

#define GET_DP_RX_MST_SOURCE_WRITE_POWER_UP()                                                   (GET_DP_RX0_SOURCE_WRITE_POWER_UP())

#define GET_DP_DPCD_02200H_STATUS()                                                             (g_ucDpRx0DPCD02200hValue)
#define GET_DP_DPCD_02201H_STATUS()                                                             (g_ucDpRx0DPCD02201hValue)
#define GET_DP_DPCD_02210H_STATUS()                                                             (g_ucDpRx0DPCD02210hValue)
...
#if(_DP_TX_SUPPORT == _ON)
#define GET_DP_RX_HDCP_AUTH_ENCRYPTION()                                                        (ScalerDpRx0HdcpCheckValid())
...
#define GET_REG_DP_RX_HDCP_M0_0()                                                               (GET_DP_RX0_HDCP_M0_0())
#define GET_REG_DP_RX_HDCP_M0_1()                                                               (GET_DP_RX0_HDCP_M0_1())
#define GET_REG_DP_RX_HDCP_M0_2()                                                               (GET_DP_RX0_HDCP_M0_2())
#define GET_REG_DP_RX_HDCP_M0_3()                                                               (GET_DP_RX0_HDCP_M0_3())
#define GET_REG_DP_RX_HDCP_M0_4()                                                               (GET_DP_RX0_HDCP_M0_4())
#define GET_REG_DP_RX_HDCP_M0_5()                                                               (GET_DP_RX0_HDCP_M0_5())
#define GET_REG_DP_RX_HDCP_M0_6()                                                               (GET_DP_RX0_HDCP_M0_6())
#define GET_REG_DP_RX_HDCP_M0_7()                                                               (GET_DP_RX0_HDCP_M0_7())

#define SET_DP_RX_DFP_DEVICE_DETAIL_CONFIG()                                                    (ScalerDpRx0DfpDeviceDetailConfig())
#define RST_DP_RX_DFP_DEVICE_DETAIL_CONFIG()                                                    (ScalerDpRx0DfpDeviceDetailConfigReset())
#endif

#if(_DP_HDCP_2_2_SUPPORT == _ON)
#define GET_DP_RX_HDCP2_MODE()                                                                  (GET_DP_RX0_HDCP2_MODE())
#define GET_DP_RX_HDCP2_AUTH_PROC_DONE()                                                        (GET_DP_RX0_HDCP2_AUTH_STATE() == _DP_RX_HDCP2_REPEATER_STATE_AUTH_DONE)
#define GET_DP_RX_HDCP2_REPEATER_SUPPORTED()                                                    (ScalerDpRx0GetDpcdInfo(0x06, 0x92, 0x1F) == (_BIT1 | _BIT0))
#define SET_DP_RX_HDCP2_LPRIME_CAL(x)                                                           (ScalerHdcp2RepeaterLPrimeCalculate(g_pucDpRx0Hdcp2dKey0, g_pucDpRx0Hdcp2dKey1, (x)))
#define GET_DP_RX_HDCP2_V(x)                                                                    (g_pucDpRx0Hdcp2VPrime[x])
#endif
...
#define SET_DP_MST_HPD_IRQ()                                                                    (ScalerDpRx1HpdIrqAssert())
#define GET_DP_CHECK_AUX_CH_POWER_STATUS()                                                      (GET_DP_RX1_CHECK_AUX_CH_POWER_STATUS())
#define GET_DP_SOURCE_FIRST_POWER_ON()                                                          (GET_DP_RX1_SOURCE_FIRST_POWER_ON())

#define GET_DP_RX_MST_SOURCE_WRITE_POWER_UP()                                                   (GET_DP_RX1_SOURCE_WRITE_POWER_UP())
...
#define GET_DP_DPCD_02200H_STATUS()                                                             (g_ucDpRx1DPCD02200hValue)
#define GET_DP_DPCD_02201H_STATUS()                                                             (g_ucDpRx1DPCD02201hValue)
#define GET_DP_DPCD_02210H_STATUS()                                                             (g_ucDpRx1DPCD02210hValue)

#if(_DP_TX_SUPPORT == _ON)
#define GET_DP_RX_HDCP_AUTH_ENCRYPTION()                                                        (ScalerDpRx1HdcpCheckValid())
...
#define GET_REG_DP_RX_HDCP_M0_0()                                                               (GET_DP_RX1_HDCP_M0_0())
#define GET_REG_DP_RX_HDCP_M0_1()                                                               (GET_DP_RX1_HDCP_M0_1())
#define GET_REG_DP_RX_HDCP_M0_2()                                                               (GET_DP_RX1_HDCP_M0_2())
#define GET_REG_DP_RX_HDCP_M0_3()                                                               (GET_DP_RX1_HDCP_M0_3())
#define GET_REG_DP_RX_HDCP_M0_4()                                                               (GET_DP_RX1_HDCP_M0_4())
#define GET_REG_DP_RX_HDCP_M0_5()                                                               (GET_DP_RX1_HDCP_M0_5())
#define GET_REG_DP_RX_HDCP_M0_6()                                                               (GET_DP_RX1_HDCP_M0_6())
#define GET_REG_DP_RX_HDCP_M0_7()                                                               (GET_DP_RX1_HDCP_M0_7())

#define SET_DP_RX_DFP_DEVICE_DETAIL_CONFIG()                                                    (ScalerDpRx1DfpDeviceDetailConfig())
#define RST_DP_RX_DFP_DEVICE_DETAIL_CONFIG()                                                    (ScalerDpRx1DfpDeviceDetailConfigReset())
#endif

#if(_DP_HDCP_2_2_SUPPORT == _ON)
#define GET_DP_RX_HDCP2_MODE()                                                                  (GET_DP_RX1_HDCP2_MODE())
#define GET_DP_RX_HDCP2_AUTH_PROC_DONE()                                                        (GET_DP_RX1_HDCP2_AUTH_STATE() == _DP_RX_HDCP2_REPEATER_STATE_AUTH_DONE)
#define GET_DP_RX_HDCP2_REPEATER_SUPPORTED()                                                    (ScalerDpRx1GetDpcdInfo(0x06, 0x92, 0x1F) == (_BIT1 | _BIT0))
#define SET_DP_RX_HDCP2_LPRIME_CAL(x)                                                           (ScalerHdcp2RepeaterLPrimeCalculate(g_pucDpRx1Hdcp2dKey0, g_pucDpRx1Hdcp2dKey1, (x)))
#define GET_DP_RX_HDCP2_V(x)                                                                    (g_pucDpRx1Hdcp2VPrime[x])
#endif
...
#define GET_DP_RX_MST_ST_END_POSITION(x)                                                        (ScalerGetBit((((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB5_04_STHD_CTRL_3 : PB8_04_STHD_CTRL_3) + ((x) << 1)), 0x3F))
...
#define SET_REG_DP_RX_MST_ST1_SOURCE_STATUS(x)                                                  (ScalerSetBit(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB5_0D_SOURCE_SEL_0 : PB8_0D_SOURCE_SEL_0), ~(_BIT6 | _BIT5 | _BIT4), ((x) << 4)))
...
#define SET_REG_DP_RX_MST_ST3_SOURCE_STATUS(x)                                                  (ScalerSetBit(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB5_0E_SOURCE_SEL_1 : PB8_0E_SOURCE_SEL_1), ~(_BIT6 | _BIT5 | _BIT4), ((x) << 4)))
...
#define GET_REG_DP_RX_MST_ST1_SOURCE_STATUS_EXINT()                                             (ScalerGetBit_EXINT(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB5_0D_SOURCE_SEL_0 : PB8_0D_SOURCE_SEL_0), (_BIT6 | _BIT5 | _BIT4)) >> 4)
#define SET_REG_DP_RX_MST_ST1_SOURCE_STATUS_EXINT(x)                                            (ScalerSetBit_EXINT(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB5_0D_SOURCE_SEL_0 : PB8_0D_SOURCE_SEL_0), ~(_BIT6 | _BIT5 | _BIT4), ((x) << 4)))
#define GET_REG_DP_RX_MST_ST2_SOURCE_STATUS_EXINT()                                             (ScalerGetBit_EXINT(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB5_0D_SOURCE_SEL_0 : PB8_0D_SOURCE_SEL_0), (_BIT2 | _BIT1 | _BIT0)))
#define SET_REG_DP_RX_MST_ST2_SOURCE_STATUS_EXINT(x)                                            (ScalerSetBit_EXINT(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB5_0D_SOURCE_SEL_0 : PB8_0D_SOURCE_SEL_0), ~(_BIT2 | _BIT1 | _BIT0), (x)))
#define GET_REG_DP_RX_MST_ST3_SOURCE_STATUS_EXINT()                                             (ScalerGetBit_EXINT(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB5_0E_SOURCE_SEL_1 : PB8_0E_SOURCE_SEL_1), (_BIT6 | _BIT5 | _BIT4)) >> 4)
#define SET_REG_DP_RX_MST_ST3_SOURCE_STATUS_EXINT(x)                                            (ScalerSetBit_EXINT(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB5_0E_SOURCE_SEL_1 : PB8_0E_SOURCE_SEL_1), ~(_BIT6 | _BIT5 | _BIT4), ((x) << 4)))
#define GET_REG_DP_RX_MST_ST4_SOURCE_STATUS_EXINT()                                             (ScalerGetBit_EXINT(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB5_0E_SOURCE_SEL_1 : PB8_0E_SOURCE_SEL_1), (_BIT2 | _BIT1 | _BIT0)))
#define SET_REG_DP_RX_MST_ST4_SOURCE_STATUS_EXINT(x)                                            (ScalerSetBit_EXINT(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB5_0E_SOURCE_SEL_1 : PB8_0E_SOURCE_SEL_1), ~(_BIT2 | _BIT1 | _BIT0), (x)))
#define GET_REG_DP_RX_MST_ST5_SOURCE_STATUS_EXINT()                                             (ScalerGetBit_EXINT(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB5_0F_SOURCE_SEL_2 : PB8_0F_SOURCE_SEL_2), (_BIT2 | _BIT1 | _BIT0)))
#define SET_REG_DP_RX_MST_ST5_SOURCE_STATUS_EXINT(x)                                            (ScalerSetBit_EXINT(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB5_0F_SOURCE_SEL_2 : PB8_0F_SOURCE_SEL_2), ~(_BIT2 | _BIT1 | _BIT0), (x)))

#define SET_DP_RX_MST_ST_SOURCE_BACKUP(x, y)                                                    (g_pucDpRxMstStreamMuxBackup[x] = (y))
#define GET_DP_RX_MST_ST_SOURCE_BACKUP(x)                                                       (g_pucDpRxMstStreamMuxBackup[x])

#define CLR_DP_RX_MST_ST_SOURCE_CHANGE()                                                        (g_bDpRxMstStreamMuxChange = _FALSE)
#define SET_DP_RX_MST_ST_SOURCE_CHANGE()                                                        (g_bDpRxMstStreamMuxChange = _TRUE)
#define GET_DP_RX_MST_ST_SOURCE_CHANGE()                                                        (g_bDpRxMstStreamMuxChange)

#define GET_REG_DP_RX_HDCP_SHA_RESULT(x)                                                        (ScalerGetByte(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB_36_SHA_0 : PB0_36_SHA_0) + (x)))
#define GET_REG_DP_RX_HDCP_SHA256_RESULT(x)                                                     (ScalerGetByte(P63_35_HDCP_SHA_0 + (x)))
...
#define CLR_REG_DP_RX_1C2_IRQ()                                                                 (ScalerSetBit(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB7_B2_AUX_SPECIAL_IRQ_EN : PBA_B2_AUX_SPECIAL_IRQ_EN), ~_BIT4, 0x00))
...
#define CLR_REG_DP_RX_2C0_IRQ_EXINT()                                                           (ScalerSetBit_EXINT(((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? PB7_B2_AUX_SPECIAL_IRQ_EN : PBA_B2_AUX_SPECIAL_IRQ_EN), ~_BIT3, 0x00))
...
//--------------------------------------------------
#define GET_REG_DP_RX_DOWN_REQUEST_HEADER_CRC_BACKUP()                                          (g_stDpMstRxReqGetMsgCRC.b4HeaderCRC)
#define SET_REG_DP_RX_DOWN_REQUEST_HEADER_CRC_BACKUP(x)                                         (g_stDpMstRxReqGetMsgCRC.b4HeaderCRC = (x))
#define GET_REG_DP_RX_DOWN_REQUEST_BODY_CRC_BACKUP()                                            (g_stDpMstRxReqGetMsgCRC.ucBodyCRC)
#define SET_REG_DP_RX_DOWN_REQUEST_BODY_CRC_BACKUP(x)                                           (g_stDpMstRxReqGetMsgCRC.ucBodyCRC = (x))
...
//--------------------------------------------------
#define SET_DP_REPLY_REMOTE_I2C_READ_NAK_REP_TYPE(x)                                            (g_unDpReplyPool.stRemoteI2CReadNak.b1RepType = (x))
#define SET_DP_REPLY_REMOTE_I2C_READ_NAK_REQUESET_ID(x)                                         (g_unDpReplyPool.stRemoteI2CReadNak.b7ReqID = (x))
#define SET_DP_REPLY_REMOTE_I2C_READ_NAK_GUID(x, y)                                             (g_unDpReplyPool.stRemoteI2CReadNak.pucGuid[x] = (y))
#define SET_DP_REPLY_REMOTE_I2C_READ_NAK_PORT(x)                                                (g_unDpReplyPool.stRemoteI2CReadNak.b4Port = (x))
#define SET_DP_REPLY_REMOTE_I2C_READ_NAK_REASON(x)                                              (g_unDpReplyPool.stRemoteI2CReadNak.ucNakReason = (x))
#define SET_DP_REPLY_REMOTE_I2C_READ_NAK_TRANSACTION(x)                                         (g_unDpReplyPool.stRemoteI2CReadNak.b2I2CNakTransaction = (x))
#define SET_DP_REPLY_REMOTE_I2C_READ_NAK_ZEROS()                                                {\
                                                                                                    g_unDpReplyPool.stRemoteI2CReadNak.b4zero = 0;\
                                                                                                    g_unDpReplyPool.stRemoteI2CReadNak.b6zero1 = 0;\
                                                                                                }
...
#define GET_DP_RX_UP_REQUEST_CRC_FAIL_RETRY_NUM()                                               (g_stMsgOtherInfo.ucCrcFailRetryNum)
#define INCREASE_DP_RX_UP_REQUEST_CRC_FAIL_RETRY_NUM()                                          (g_stMsgOtherInfo.ucCrcFailRetryNum = g_stMsgOtherInfo.ucCrcFailRetryNum + 1)
#define CLR_DP_RX_UP_REQUEST_CRC_FAIL_RETRY_NUM()                                               (g_stMsgOtherInfo.ucCrcFailRetryNum = 0)
...
#define GET_DP_RX_REPORT_DOWNSTREAM_UNPLUG_EVENT()                                              (g_stMsgOtherInfo.b1ReportTxUnplugEventExist)
#define SET_DP_RX_REPORT_DOWNSTREAM_UNPLUG_EVENT()                                              (g_stMsgOtherInfo.b1ReportTxUnplugEventExist = _TRUE)
#define CLR_DP_RX_REPORT_DOWNSTREAM_UNPLUG_EVENT()                                              (g_stMsgOtherInfo.b1ReportTxUnplugEventExist = _FALSE)
...
#define GET_DP_RX_REMOTE_I2C_READ_FAIL()                                                        (g_stMsgOtherInfo.b1RemoteI2CReadFail)
#define SET_DP_RX_REMOTE_I2C_READ_FAIL()                                                        (g_stMsgOtherInfo.b1RemoteI2CReadFail = _TRUE)
#define CLR_DP_RX_REMOTE_I2C_READ_FAIL()                                                        (g_stMsgOtherInfo.b1RemoteI2CReadFail = _FALSE)

#define GET_DP_MSG_REQUEST_ID()                                                                 (g_unDpRequestPool.pucData[0] & 0x7F)
#define GET_DP_MSG_REPLY_ID()                                                                   (g_unDpReplyPool.pucData[0] & 0x7F)
#define GET_DP_MSG_REPLY_TYPE()                                                                 (g_unDpReplyPool.pucData[0] >> 7)
...
#define GET_DP_PBN_PER_TIME_SLOT(x, y)                                                          (((x) == _DP_HIGH_SPEED3_810MHZ) ? (15 * (y)) : (((x) == _DP_HIGH_SPEED2_540MHZ) ? (10 * (y)) : (((x) == _DP_HIGH_SPEED_270MHZ) ? (5 * (y)) : (3 * (y)))))
...
//--------------------------------------------------
#define GET_DP_RX_MANUAL_FORCE_SET_ACT()                                                        (g_stMsgOtherInfo.b1DpManualForceSetAct)
#define SET_DP_RX_MANUAL_FORCE_SET_ACT()                                                        (g_stMsgOtherInfo.b1DpManualForceSetAct = (_TRUE))
#define CLR_DP_RX_MANUAL_FORCE_SET_ACT()                                                        (g_stMsgOtherInfo.b1DpManualForceSetAct = (_FALSE))
...
#define GET_DP_TX_STX_START_ADDRESS(x)                                                          (RET_REG_ADDR_DP_RX0_DAIZY_ST3_START() + (2 * ((x) - 2)))
#define GET_DP_TX_STX_END_ADDRESS(x)                                                            (RET_REG_ADDR_DP_RX0_DAIZY_ST3_END() + (2 * ((x) - 2)))
...
//--------------------------------------------------
#define GET_REG_DP_RX_DOWN_REQUEST_MSG_D0_SUPPORT_ENABLE()                                      (ScalerGetBit(PB7_00_AUX_RX_MSG_RX_CTRL, _BIT6) == 0x00)
#define GET_REG_DP_RX_DOWN_REQUEST_MSG_D0_SUPPORT_ENABLE_EXINT()                                (ScalerGetBit_EXINT(PB7_00_AUX_RX_MSG_RX_CTRL, _BIT6) == 0x00)
#define SET_REG_DP_RX_DOWN_REQUEST_MSG_D0_SUPPORT_ENABLE()                                      (ScalerSetBit(PB7_00_AUX_RX_MSG_RX_CTRL, ~_BIT6, 0x00))
#define SET_REG_DP_RX_DOWN_REQUEST_MSG_D0_SUPPORT_ENABLE_EXINT()                                (ScalerSetBit_EXINT(PB7_00_AUX_RX_MSG_RX_CTRL, ~_BIT6, 0x00))
#define GET_REG_DP_RX_DOWN_REQUEST_MSG_D1_SUPPORT_ENABLE()                                      (ScalerGetBit(PB7_00_AUX_RX_MSG_RX_CTRL, _BIT6) == _BIT6)
#define GET_REG_DP_RX_DOWN_REQUEST_MSG_D1_SUPPORT_ENABLE_EXINT()                                (ScalerGetBit_EXINT(PB7_00_AUX_RX_MSG_RX_CTRL, _BIT6) == _BIT6)
#define SET_REG_DP_RX_DOWN_REQUEST_MSG_D1_SUPPORT_ENABLE()                                      (ScalerSetBit(PB7_00_AUX_RX_MSG_RX_CTRL, ~_BIT6, _BIT6))
#define SET_REG_DP_RX_DOWN_REQUEST_MSG_D1_SUPPORT_ENABLE_EXINT()                                (ScalerSetBit_EXINT(PB7_00_AUX_RX_MSG_RX_CTRL, ~_BIT6, _BIT6))
#define SET_REG_DP_RX_DOWN_REQUEST_MSG_RECEIVE_CRC_IGNORE_ENABLE()                              (ScalerSetBit(PB7_00_AUX_RX_MSG_RX_CTRL, ~(_BIT3 | _BIT2), (_BIT3 | _BIT2)))
#define CLR_REG_DP_RX_DOWN_REQUEST_MSG_RECEIVE_CRC_IGNORE_ENABLE()                              (ScalerSetBit(PB7_00_AUX_RX_MSG_RX_CTRL, ~(_BIT3 | _BIT2), 0x00))
#define CLR_REG_DP_RX_DOWN_REQUEST_MSG_FINISH()                                                 (ScalerSetByte(PB7_02_MSG_RX_FINISH, 0xFF))
#define CLR_REG_DP_RX_DOWN_REQUEST_MSG_FINISH_EXINT()                                           (ScalerSetByte_EXINT(PB7_02_MSG_RX_FINISH, 0xFF))
#define CLR_REG_DP_RX_DOWN_REQUEST_MSG_ERROR()                                                  (ScalerSetByte(PB7_03_MSG_RX_FLAG, 0xFF))
#define CLR_REG_DP_RX_DOWN_REQUEST_MSG_ERROR_EXINT()                                            (ScalerSetByte_EXINT(PB7_03_MSG_RX_FLAG, 0xFF))
...
#define CLR_REG_DP_RX_DOWN_REQUEST_BUF0_BUF1_EXINT()                                            (ScalerSetBit_EXINT(PB7_04_MSG_RX_BUF_CLR, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2 | _BIT1 | _BIT0)))
#define RST_REG_DP_RX_DOWN_REQUEST_FSM_WRITTEN()                                                (ScalerSetBit(PB7_1B_MSG_EXCEPT_CTRL0, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6)))
#define RST_REG_DP_RX_DOWN_REQUEST_FSM_WRITTEN_EXINT()                                          (ScalerSetBit_EXINT(PB7_1B_MSG_EXCEPT_CTRL0, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6)))
#define SET_REG_DP_RX_DOWN_REQUEST_FORCE_ACK_ADDRESS_UNEXPECT()                                 (ScalerSetBit(PB7_1C_MSG_EXCEPT_CTRL1, ~_BIT3, _BIT3))

#define SET_REG_DP_RX_DOWN_REQUEST_BUF0_MSG_RECEIVE_ENABLE()                                    (ScalerSetBit(PB7_00_AUX_RX_MSG_RX_CTRL, ~_BIT0, _BIT0))
#define SET_REG_DP_RX_DOWN_REQUEST_BUF0_MSG_RECEIVE_ENABLE_EXINT()                              (ScalerSetBit_EXINT(PB7_00_AUX_RX_MSG_RX_CTRL, ~_BIT0, _BIT0))
#define CLR_REG_DP_RX_DOWN_REQUEST_BUF0_MSG_RECEIVE_ENABLE()                                    (ScalerSetBit(PB7_00_AUX_RX_MSG_RX_CTRL, ~_BIT0, 0x00))
#define CLR_REG_DP_RX_DOWN_REQUEST_BUF0_MSG_RECEIVE_ENABLE_EXINT()                              (ScalerSetBit_EXINT(PB7_00_AUX_RX_MSG_RX_CTRL, ~_BIT0, 0x00))
#define GET_REG_DP_RX_DOWN_REQUEST_BUF0_MSG_FINISH()                                            (ScalerGetBit(PB7_02_MSG_RX_FINISH, _BIT0))
#define GET_REG_DP_RX_DOWN_REQUEST_BUF0_MSG_FINISH_EXINT()                                      (ScalerGetBit_EXINT(PB7_02_MSG_RX_FINISH, _BIT0))
#define CLR_REG_DP_RX_DOWN_REQUEST_BUF0_MSG_FINISH()                                            (ScalerSetBit(PB7_02_MSG_RX_FINISH, ~(_BIT4 | _BIT0), _BIT0))
#define CLR_REG_DP_RX_DOWN_REQUEST_BUF0_MSG_FINISH_EXINT()                                      (ScalerSetBit_EXINT(PB7_02_MSG_RX_FINISH, ~(_BIT4 | _BIT0), _BIT0))
...
#define CLR_REG_DP_RX_DOWN_REQUEST_BUF0_EXINT()                                                 (ScalerSetBit_EXINT(PB7_04_MSG_RX_BUF_CLR, ~(_BIT3 | _BIT1), (_BIT3 | _BIT1)))

#define GET_REG_DP_RX_DOWN_REQUEST_ADDR_WRITTEN()                                               ((bit)ScalerGetBit(PB7_1B_MSG_EXCEPT_CTRL0, _BIT0))
#define GET_REG_DP_RX_DOWN_REQUEST_ADDR_WRITTEN_EXINT()                                         ((bit)ScalerGetBit_EXINT(PB7_1B_MSG_EXCEPT_CTRL0, _BIT0))
#define CLR_REG_DP_RX_DOWN_REQUEST_ADDR_WRITTEN()                                               (ScalerSetBit(PB7_1B_MSG_EXCEPT_CTRL0, ~_BIT0, _BIT0))
#define CLR_REG_DP_RX_DOWN_REQUEST_ADDR_WRITTEN_EXINT()                                         (ScalerSetBit_EXINT(PB7_1B_MSG_EXCEPT_CTRL0, ~_BIT0, _BIT0))

#define GET_REG_DP_RX_DOWN_REQUEST_ADDR_WRITTEN_IRQ_ENABLE()                                    ((bit)ScalerGetBit(PB7_1B_MSG_EXCEPT_CTRL0, _BIT1))
#define GET_REG_DP_RX_DOWN_REQUEST_ADDR_WRITTEN_IRQ_ENABLE_EXINT()                              ((bit)ScalerGetBit_EXINT(PB7_1B_MSG_EXCEPT_CTRL0, _BIT1))
#define SET_REG_DP_RX_DOWN_REQUEST_ADDR_WRITTEN_IRQ_ENABLE()                                    (ScalerSetBit(PB7_1B_MSG_EXCEPT_CTRL0, ~_BIT1, _BIT1))
#define SET_REG_DP_RX_DOWN_REQUEST_ADDR_WRITTEN_IRQ_ENABLE_EXINT()                              (ScalerSetBit_EXINT(PB7_1B_MSG_EXCEPT_CTRL0, ~_BIT1, _BIT1))
#define CLR_REG_DP_RX_DOWN_REQUEST_ADDR_WRITTEN_IRQ_ENABLE()                                    (ScalerSetBit(PB7_1B_MSG_EXCEPT_CTRL0, ~_BIT1, 0x00))
#define CLR_REG_DP_RX_DOWN_REQUEST_ADDR_WRITTEN_IRQ_ENABLE_EXINT()                              (ScalerSetBit_EXINT(PB7_1B_MSG_EXCEPT_CTRL0, ~_BIT1, 0x00))

#define SET_REG_DP_RX_DOWN_REQUEST_BUF1_MSG_RECEIVE_ENABLE()                                    (ScalerSetBit(PB7_00_AUX_RX_MSG_RX_CTRL, ~_BIT1, _BIT1))
#define SET_REG_DP_RX_DOWN_REQUEST_BUF1_MSG_RECEIVE_ENABLE_EXINT()                              (ScalerSetBit_EXINT(PB7_00_AUX_RX_MSG_RX_CTRL, ~_BIT1, _BIT1))
#define CLR_REG_DP_RX_DOWN_REQUEST_BUF1_MSG_RECEIVE_ENABLE()                                    (ScalerSetBit(PB7_00_AUX_RX_MSG_RX_CTRL, ~_BIT1, 0x00))
#define CLR_REG_DP_RX_DOWN_REQUEST_BUF1_MSG_RECEIVE_ENABLE_EXINT()                              (ScalerSetBit_EXINT(PB7_00_AUX_RX_MSG_RX_CTRL, ~_BIT1, 0x00))
#define GET_REG_DP_RX_DOWN_REQUEST_BUF1_MSG_FINISH()                                            ((ScalerGetBit(PB7_02_MSG_RX_FINISH, _BIT4)) >> 4)
#define GET_REG_DP_RX_DOWN_REQUEST_BUF1_MSG_FINISH_EXINT()                                      ((ScalerGetBit_EXINT(PB7_02_MSG_RX_FINISH, _BIT4)) >> 4)
#define CLR_REG_DP_RX_DOWN_REQUEST_BUF1_MSG_FINISH()                                            (ScalerSetBit(PB7_02_MSG_RX_FINISH, ~(_BIT4 | _BIT0), _BIT4))
#define CLR_REG_DP_RX_DOWN_REQUEST_BUF1_MSG_FINISH_EXINT()                                      (ScalerSetBit_EXINT(PB7_02_MSG_RX_FINISH, ~(_BIT4 | _BIT0), _BIT4))
...
#define CLR_REG_DP_RX_DOWN_REQUEST_BUF1_EXINT()                                                 (ScalerSetBit_EXINT(PB7_04_MSG_RX_BUF_CLR, ~(_BIT2 | _BIT0), (_BIT2 | _BIT0)))
...
#define GET_REG_DP_RX_DOWN_REQUEST_RAD(x)                                                       (ScalerGetBit((PB7_06_MSG_RX_DATA1 + ((x) / 2)), (0x0F << (((x) % 2) ? 0 : 4))) >> (((x) % 2) ? 0 : 4))
...
#define GET_REG_DP_RX_DOWN_REQUEST_HEADER_CRC()                                                 (ScalerGetBit(PB7_0E_MSG_RX_DATA9, (_BIT3 | _BIT2 | _BIT1 | _BIT0)))
#define GET_REG_DP_RX_DOWN_REQUEST_BODY_CRC()                                                   (ScalerGetByte(PB7_0F_MSG_RX_DATAA))
...
#define CLR_REG_DP_RX_DOWN_REPLY_READY_BIT_IRQ_EXINT()                                          (ScalerSetBit_EXINT(PB7_40_AUX_RX_MSG_TX_CTRL, ~_BIT5, 0x00))
...
#define GET_REG_DP_RX_DOWN_REPLY_MSG_IS_READ()                                                  ((bit)ScalerGetBit(PB7_53_MSG_TX_READ_FLAG, _BIT0))
#define CLR_REG_DP_RX_DOWN_REPLY_MSG_IS_READ()                                                  (ScalerSetBit(PB7_53_MSG_TX_READ_FLAG, ~(_BIT1 | _BIT0), _BIT0))

#define GET_REG_DP_RX_DOWN_REPLY_MSG_IS_READ_EXINT()                                            ((bit)ScalerGetBit_EXINT(PB7_53_MSG_TX_READ_FLAG, _BIT0))
#define CLR_REG_DP_RX_DOWN_REPLY_MSG_IS_READ_EXINT()                                            (ScalerSetBit_EXINT(PB7_53_MSG_TX_READ_FLAG, ~(_BIT1 | _BIT0), _BIT0))
...
#define CLR_REG_DP_RX_UP_REQUEST_READY_BIT_IRQ_EXINT()                                          (ScalerSetBit_EXINT(PB7_40_AUX_RX_MSG_TX_CTRL, ~_BIT6, 0x00))
...
#define CLR_REG_DP_RX_DOWN_REPLY_UP_REQUEST_READY_BIT_IRQ_EXINT()                               (ScalerSetBit_EXINT(PB7_40_AUX_RX_MSG_TX_CTRL, ~(_BIT6 | _BIT5), 0x00))
...
#define CLR_REG_DP_RX_UPSTREAM_REPLY_EXINT()                                                    (ScalerSetBit_EXINT(PB7_40_AUX_RX_MSG_TX_CTRL, ~_BIT0, 0x00))
...
#define SET_REG_DP_RX_UPSTREAM_REPLY_LCT(x)                                                     (ScalerSetBit(PB7_43_MSG_TX_SET0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), ((x) << 4)))
...
#define SET_REG_DP_RX_UPSTREAM_REPLY_RAD(x, y)                                                  {ScalerSetBit((PB7_44_MSG_TX_SET1 + ((x) / 2)), ~(0x0F << (((x) % 2) ? 0 : 4)), ((y) << (((x) % 2) ? 0 : 4)));}
...
#define GET_REG_DP_RX_UPSTREAM_REPLY_MSN()                                                      ((ScalerGetBit(PB7_4C_MSG_TX_SET9, _BIT4)) >> 4)
...
#define CLR_REG_DP_RX_USTERAM_REPLY_BUF_EXINT()                                                 (ScalerSetBit_EXINT(PB7_4F_BUF_CLR, ~_BIT0, _BIT0))
...
//--------------------------------------------------
#define SET_REG_DP_RX_UP_REPLY_MSG_RECEIVE_CRC_IGNORE_ENABLE()                                  (ScalerSetBit(PB7_20_AUX_RX_MSG_RX_CTRL, ~(_BIT3 | _BIT2), (_BIT3 | _BIT2)))
#define CLR_REG_DP_RX_UP_REPLY_MSG_RECEIVE_CRC_IGNORE_ENABLE()                                  (ScalerSetBit(PB7_20_AUX_RX_MSG_RX_CTRL, ~(_BIT3 | _BIT2), 0x00))

#define SET_REG_DP_RX_UP_REPLY_BUF0_MSG_RECEIVE_ENABLE()                                        (ScalerSetBit(PB7_20_AUX_RX_MSG_RX_CTRL, ~_BIT0, _BIT0))
#define SET_REG_DP_RX_UP_REPLY_BUF0_MSG_RECEIVE_ENABLE_EXINT()                                  (ScalerSetBit_EXINT(PB7_20_AUX_RX_MSG_RX_CTRL, ~_BIT0, _BIT0))
#define CLR_REG_DP_RX_UP_REPLY_BUF0_MSG_RECEIVE_ENABLE()                                        (ScalerSetBit(PB7_20_AUX_RX_MSG_RX_CTRL, ~_BIT0, 0x00))
#define CLR_REG_DP_RX_UP_REPLY_BUF0_MSG_RECEIVE_ENABLE_EXINT()                                  (ScalerSetBit_EXINT(PB7_20_AUX_RX_MSG_RX_CTRL, ~_BIT0, 0x00))
...
#define CLR_REG_DP_RX_UP_REPLY_BUF0_MSG_FINISH_EXINT()                                          (ScalerSetBit_EXINT(PB7_22_MSG_RX_FINISH, ~(_BIT4 | _BIT0), _BIT0))
...
#define CLR_REG_DP_RX_UP_REPLY_BUF0_EXINT()                                                     (ScalerSetBit_EXINT(PB7_24_MSG_RX_BUF_CLR, ~(_BIT3 | _BIT1), (_BIT3 | _BIT1)))
#define RST_REG_DP_RX_UP_REPLY_FSM_WRITTEN()                                                    (ScalerSetBit(PB7_3B_MSG_EXCEPT_CTRL0, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6)))
#define RST_REG_DP_RX_UP_REPLY_FSM_WRITTEN_EXINT()                                              (ScalerSetBit_EXINT(PB7_3B_MSG_EXCEPT_CTRL0, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6)))
#define SET_REG_DP_RX_UP_REPLY_FORCE_ACK_ADDRESS_UNEXPECT()                                     (ScalerSetBit(PB7_3C_MSG_EXCEPT_CTRL1, ~_BIT3, _BIT3))
...
#define CLR_REG_DP_RX_UP_REPLY_ADDR_WRITTEN_EXINT()                                             (ScalerSetBit_EXINT(PB7_3B_MSG_EXCEPT_CTRL0, ~_BIT0, _BIT0))

#define SET_REG_DP_RX_UP_REPLY_BUF1_MSG_RECEIVE_ENABLE()                                        (ScalerSetBit(PB7_20_AUX_RX_MSG_RX_CTRL, ~_BIT1, _BIT1))
#define SET_REG_DP_RX_UP_REPLY_BUF1_MSG_RECEIVE_ENABLE_EXINT()                                  (ScalerSetBit_EXINT(PB7_20_AUX_RX_MSG_RX_CTRL, ~_BIT1, _BIT1))
#define CLR_REG_DP_RX_UP_REPLY_BUF1_MSG_RECEIVE_ENABLE()                                        (ScalerSetBit(PB7_20_AUX_RX_MSG_RX_CTRL, ~_BIT1, 0x00))
#define CLR_REG_DP_RX_UP_REPLY_BUF1_MSG_RECEIVE_ENABLE_EXINT()                                  (ScalerSetBit_EXINT(PB7_20_AUX_RX_MSG_RX_CTRL, ~_BIT1, 0x00))
...
#define CLR_REG_DP_RX_UP_REPLY_BUF1_MSG_FINISH_EXINT()                                          (ScalerSetBit_EXINT(PB7_22_MSG_RX_FINISH, ~(_BIT4 | _BIT0), _BIT4))
...
#define CLR_REG_DP_RX_UP_REPLY_BUF1_EXINT()                                                     (ScalerSetBit_EXINT(PB7_24_MSG_RX_BUF_CLR, ~(_BIT2 | _BIT0), (_BIT2 | _BIT0)))
...
//--------------------------------------------------
#define GET_DP_MST_RX_URGENT_EVENT_CHECK_SKIP()                                                 (g_stMsgOtherInfo.b1UrgentEventCheckSkip)
#define SET_DP_MST_RX_URGENT_EVENT_CHECK_SKIP()                                                 (g_stMsgOtherInfo.b1UrgentEventCheckSkip = _TRUE)
#define CLR_DP_MST_RX_URGENT_EVENT_CHECK_SKIP()                                                 (g_stMsgOtherInfo.b1UrgentEventCheckSkip = _FALSE)
#endif
...
extern BYTE g_ucDpDownReplyManualMsgBodyLengthMax;
#endif
...
extern bit g_bUpRequestBypassDone;
...
extern BYTE g_pucDpRxMstStreamMuxBackup[];
extern bit g_bDpRxMstStreamMuxChange;
...
extern void ScalerDpRxMstDownRequestBufferRelease(void);
extern bit ScalerDpRxMstDownRequestBurstRepeatHandle(void);
...
extern EnumDpStreamNum ScalerDpRxMstGetSourceMuxBackup(EnumDpStreamSourceNum enumDpStreamSourceNum);
extern bit ScalerDpRxMstCheckMsgBufferFree(void);
extern EnumDpStreamNum ScalerDpRxMstSearchMatchStream(BYTE ucTargetID);

extern void ScalerDpRxMstStreamMuxReset(void);
extern void ScalerDpRxMstClrStreamMuxBackup(void);
extern void ScalerDpRxMstClrStreamMuxBackup_EXINT0(void);
extern void ScalerDpRxMstSetSourceMuxBackup(EnumDpStreamSourceNum enumDpStreamSourceNum, EnumDpStreamNum enumDpStreamNum);
extern void ScalerDpRxMstSetSourceMuxReg(EnumDpStreamSourceNum enumDpStreamSourceNum, EnumDpStreamNum enumDpStreamNum);
extern void ScalerDpRxMstSetSourceMuxReg_EXINT0(EnumDpStreamSourceNum enumDpStreamSourceNum, EnumDpStreamNum enumDpStreamNum);

extern bit ScalerDpRxMstGetSrcMsgEnable(EnumSourceSearchPort enumInputPort);
extern bit ScalerDpRxMstGetUpstreamIsSrc(EnumSourceSearchPort enumInputPort);
extern bit ScalerDpRxMstGetMstCapability(EnumSourceSearchPort enumInputPort);
extern void ScalerDpRxMstPowerProc(EnumPowerAction enumPowerAction);

#if(_DP_MST_AUTO_SEARCH_SUPPORT == _ON)
#if((_D0_DP_EXIST == _ON) && (_D1_DP_EXIST == _ON))
extern void ScalerDpRxMstCapabilitySwitch_EXINT0(EnumSourceSearchPort enumInputPort, bit bEn);
#endif
extern void ScalerDpRxMstInitial_EXINT0(EnumDPMSTPort enumRxMstPort);
#endif

#if(_DP_TX_SUPPORT == _ON)
extern void ScalerDpRxMstQueryEncryptionWriteShaInput(void);
#if(_DP_HDCP_2_2_SUPPORT == _ON)
extern void ScalerDpRxMstQueryEncryptionWriteSha256Input(bit bRepeater);
#endif
#endif
