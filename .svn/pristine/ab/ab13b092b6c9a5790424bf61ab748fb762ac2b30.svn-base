...
#endif
        {
            pusData[0] = UserCommonAdjust6bitPanelCompensate(usContrast);
            pusData[1] = UserCommonAdjust6bitPanelCompensate(usContrast);
            pusData[2] = UserCommonAdjust6bitPanelCompensate(usContrast);
        }
    }
#endif
    else
