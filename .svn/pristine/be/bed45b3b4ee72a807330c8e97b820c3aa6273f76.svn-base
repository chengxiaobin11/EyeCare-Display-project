...
void UserCommonGlobalDimmingInitialSetting(bit bEn)
{
...
#endif
    {
        ...
        {
            DWORD ulAddress = UserCommonAdjustOCCPCMGammaGetsRGBCTTableAddress(UserInterfaceGetSDRPCMOCCGammaMode(), _OGC_NORMAL_TYPE);
