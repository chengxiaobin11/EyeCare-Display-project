...
bit g_bDpHdcpRx0HdcpCpirqFlag = _FALSE;
StructDpLanesMapping g_stDpRx0LanesMapping;

volatile BYTE g_ucDpAuxRx0DpcdAddress;
volatile BYTE g_ucDpAuxRx0DpcdLength;
...
void ScalerDpRx0SetBranchDeviceSpecificField(EnumDpVersionType enumDpVersion);
void ScalerDpRx0ClearBranchDeviceSpecificField(void);
...
void ScalerDpRx0HpdIrqAssert_WDINT(void);
void ScalerDpRx0CpIRQ_WDINT(EnumDpRxBStatusType enumBStatusType);
#endif
#endif
...
void ScalerDpRx6Initial(EnumDpVersionType enumDpVersion, EnumDpLaneCount enumDpLaneCount, EnumDPMSTPort enumDpRxMstPort, EnumFreeSyncSupport enumFreeSyncSupport, EnumAudioDpDpcdSupport enumAudioSupport);
...
bit ScalerDpRx0HDCPDeviceCountChange(void);
#endif
...
void ScalerDpRx0DfpDeviceDetailConfigReset(void);
void ScalerDpRx0DfpDeviceDetailConfig(void);
...
bit ScalerDpRx0MstToSstDeOnlyTimngCheck(DWORD ulVBs2BsCount);
bit ScalerDpRx0MstToSstDeOnlyJudge(WORD *pusDpVtotal, WORD usHBs2BsCount, DWORD ulVBs2BsCount);
...
void ScalerDpRx0SetBranchDeviceSpecificField(EnumDpVersionType enumDpVersion)
{
    if(enumDpVersion >= _DP_VERSION_1_4)
    {
        ...
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x00, _DP_1_4_BRANCH_RTK_IEEE_OUI_L);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x01, _DP_1_4_BRANCH_RTK_IEEE_OUI_M);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x02, _DP_1_4_BRANCH_RTK_IEEE_OUI_H);

        // Branch IEEE OUI LSB For DP1.4
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x03, _DP_1_4_BRANCH_RTK_ID_STRING_0);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x04, _DP_1_4_BRANCH_RTK_ID_STRING_1);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x05, _DP_1_4_BRANCH_RTK_ID_STRING_2);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x06, _DP_1_4_BRANCH_RTK_ID_STRING_3);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x07, _DP_1_4_BRANCH_RTK_ID_STRING_4);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x08, _DP_1_4_BRANCH_RTK_ID_STRING_5);

        // Branch HW/FW Version For DP1.4
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x09, _DP_1_4_BRANCH_RTK_HW_VERSION);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x0A, _DP_1_4_BRANCH_RTK_FW_VERSION_H);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x0B, _DP_1_4_BRANCH_RTK_FW_VERSION_L);
    }
    else if(enumDpVersion >= _DP_VERSION_1_2)
    {
        // Branch IEEE OUI For DP1.2
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x00, _DP_1_2_BRANCH_RTK_IEEE_OUI_L);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x01, _DP_1_2_BRANCH_RTK_IEEE_OUI_M);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x02, _DP_1_2_BRANCH_RTK_IEEE_OUI_H);

        // Branch IEEE OUI LSB For DP1.2
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x03, _DP_1_2_BRANCH_RTK_ID_STRING_0);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x04, _DP_1_2_BRANCH_RTK_ID_STRING_1);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x05, _DP_1_2_BRANCH_RTK_ID_STRING_2);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x06, _DP_1_2_BRANCH_RTK_ID_STRING_3);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x07, _DP_1_2_BRANCH_RTK_ID_STRING_4);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x08, _DP_1_2_BRANCH_RTK_ID_STRING_5);

        // Branch HW/FW Version For DP1.2
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x09, _DP_1_2_BRANCH_RTK_HW_VERSION);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x0A, _DP_1_2_BRANCH_RTK_FW_VERSION_H);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x0B, _DP_1_2_BRANCH_RTK_FW_VERSION_L);
    }
    else
    {
#if(_DP_SINK_VER11_OUI_SUPPORT == _ON)
        // Branch IEEE OUI For DP1.1
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x00, _DP_1_1_BRANCH_RTK_IEEE_OUI_L);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x01, _DP_1_1_BRANCH_RTK_IEEE_OUI_M);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x02, _DP_1_1_BRANCH_RTK_IEEE_OUI_H);
#else
        ...
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x03, _DP_1_1_BRANCH_RTK_ID_STRING_0);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x04, _DP_1_1_BRANCH_RTK_ID_STRING_1);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x05, _DP_1_1_BRANCH_RTK_ID_STRING_2);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x06, _DP_1_1_BRANCH_RTK_ID_STRING_3);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x07, _DP_1_1_BRANCH_RTK_ID_STRING_4);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x08, _DP_1_1_BRANCH_RTK_ID_STRING_5);

        // Branch HW/FW Version For DP1.1
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x09, _DP_1_1_BRANCH_RTK_HW_VERSION);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x0A, _DP_1_1_BRANCH_RTK_FW_VERSION_H);
        ScalerDpRx0SetDpcdValue(0x00, 0x05, 0x0B, _DP_1_1_BRANCH_RTK_FW_VERSION_L);
    }
}
...
// Output Value : None
//--------------------------------------------------
void ScalerDpRx0Hdcp14RepeaterCapabilityCheck(EnumDPMSTPort enumDPMSTPort, bit bClone)
{
    if(enumDPMSTPort == _DP_MST_RX0_PORT)
    {
        SET_DP_RX0_HDCP14_REPEATER_SUPPORT(_ENABLE);
    }
    else
    {
        if(bClone == _TRUE)
        ...
        {
            SET_DP_RX0_HDCP14_REPEATER_SUPPORT(_DISABLE);
        }
    }
}
#endif
...
void ScalerDpRx0LinkStatusIRQ(void)
{
    ...
    if((GET_DP_RX0_LINK_TRAINING_STATUS() == _DP_LINK_TRAINING_FAIL) || (GET_DP_RX0_LINK_TRAINING_STATUS() == _DP_LINK_STATUS_FAIL))
    {
           ...
           (ScalerDpRx0GetDpcdBitInfo(0x00, 0x06, 0x00, (_BIT2 | _BIT1 | _BIT0)) != (_BIT2 | _BIT0)))
        {
            ...
            ScalerTimerWDCancelTimerEvent(_SCALER_WD_TIMER_EVENT_DP_RX0_HDCP2_H_PRIME);
#endif
...
void ScalerDpRx0AuxSet(void)
{
    if(GET_DP_AUX_DIFF_MODE() == _FALSE)
    {
        ...
        ScalerSetByte(PB7_61_AUX_1, ((_DP_RX_AUX_REPLY_SWING_LEVEL << 5) | _BIT4));
    ...
    else
    {
        ...
        ScalerSetBit(PB7_61_AUX_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), ((_DP_RX_AUX_REPLY_SWING_LEVEL << 5) | _BIT4));
...
// Output Value : None
//--------------------------------------------------
void ScalerDpRx0HpdIrqAssert_WDINT(void) using 3
{
    if(PCB_D0_HOTPLUG_DETECT() == _D0_HOT_PLUG_HIGH)
    {
#if(_DP_IRQ_HPD_MODE == _DP_IRQ_HPD_T2_MODE)
...
// Output Value : None
//--------------------------------------------------
void ScalerDpRx0CpIRQ_WDINT(EnumDpRxBStatusType enumBStatusType) using 3
{
    BYTE ucBackUp = 0;
    ...
    switch(enumBStatusType)
    {
        ...
        case _DP_HDCP2_PARING_AVAILABLE:
            ...
            ScalerDpRx0SetDpcdValue_WDINT(0x06, 0x94, 0x93, (ScalerDpRx0GetDpcdInfo_WDINT(0x06, 0x94, 0x93) | (enumBStatusType >> 3)));
    ...
    // Link Status CPIRQ Flag
    pData_EXINT[0] = (ScalerDpRx0GetDpcdInfo_WDINT(0x00, 0x02, 0x01) | _BIT2);

    // SET AUX AUTO MODE
    SET_DP_RX0_AUX_AUTO_MODE_EXINT();

    ScalerDpRx0SetDpcdValue_WDINT(0x00, 0x02, 0x01, pData_EXINT[0]);
...
#else
                            g_ucDpRx0DPCD02201hValue = _DP_LINK_HBR2;
#endif
                        }
                        else
                        {
            ...
            else if(GET_D6_SWITCH_SELECT() == _D6_INPUT_PORT)
            {
...
#endif
                {
                    if(_D6_DP_LINK_CLK_RATE >= _DP_HIGH_SPEED2_540MHZ)
                    {
                        ...
                        if(GET_DP_RX_D6_PORT_TARGET_VERSION() <= _DP_VERSION_1_2)
                        {
                            // When Define Extended Rx Cap Should Set DPCD 0x02201
#if(_HW_DP_DPCD_EXT_CAP_PHYSICAL_ADDRESS_SUPPORT == _ON)
                            ScalerDpRx0SetDpcdValue(0x00, 0x22, 0x01, _DP_LINK_HBR2);
...
bit ScalerDpRx0VbiosAssrCheck(bit bMSACheckResult)
{
    ...
    if((GET_DP_RX0_LINK_TRAINING_STATUS() == _DP_LINK_TRAINING_NONE) &&
       ...
       (ScalerDpRx0GetDpcdBitInfo(0x00, 0x01, 0x11, _BIT1) != _BIT1))
#else
    if((GET_DP_RX0_LINK_TRAINING_STATUS() == _DP_LINK_TRAINING_NONE) &&
       (ScalerDpRx0GetDpcdInfo(0x00, 0x01, 0x00) == 0x00))
#endif
...
#if(_AUDIO_SUPPORT == _ON)
    SET_AUDIO_DP_D6_SUPPORT(enumAudioSupport);
#else
    enumAudioSupport = enumAudioSupport;
#endif // End of #if(_AUDIO_SUPPORT == _ON)
...
void ScalerDpRx6AuxChPowerStatusCheck(bit bCableStatus)
{
    ...
    {
        if(ScalerSyncDpGetHotPlugStatus(_D6_INPUT_PORT) == _HIGH)
        {
    ...
    switch(enumDpMstBackup)
    {
        case _DP_MST_BACKUP_INFO:
               ...
               (GET_DP_RX0_LINK_TRAINING_STATUS() == _DP_FAKE_LINK_TRAINING_PASS))
            {
                ...
                memcpy(g_pucDpRx0MstTimeSlotBackup, (volatile BYTE xdata *)PB5_03_STHD_CTRL_2, sizeof(g_pucDpRx0MstTimeSlotBackup));

                for(enumSourceNum = _DP_ST_SOURCE1; enumSourceNum <= _DP_ST_SOURCE5; enumSourceNum++)
                {
                    g_pucDpMacRx0MstStMuxBackup[enumSourceNum] = GET_DP_RX_MST_ST_SOURCE_BACKUP(enumSourceNum);
                }
            }
        ...
        case _DP_MST_BACKUP_INFO_RESTORE:
            ...
            if(((ScalerDpRx0GetDpcdInfo(0x00, 0x00, 0x21) & _BIT0) == _BIT0) && (g_stDpRx0MiscInfo.b1DpMstEnableBackup == _TRUE))
            {
                ...
                memcpy((volatile BYTE xdata *)PB5_03_STHD_CTRL_2, g_pucDpRx0MstTimeSlotBackup, sizeof(g_pucDpRx0MstTimeSlotBackup));

                for(enumSourceNum = _DP_ST_SOURCE1; enumSourceNum <= _DP_ST_SOURCE5; enumSourceNum++)
                {
                    ScalerDpRxMstSetSourceMuxBackup(enumSourceNum, g_pucDpMacRx0MstStMuxBackup[enumSourceNum]);
                }
            }
...
void ScalerDpRx0HDCPHandler(void)
{
...
#endif
    {
        ...
        if(GET_DP_RX0_HDCP_AUTH_AKSV_WRITTEN() == _TRUE)
        {
            ...
            SET_DP_RX0_HDCP_REPEATER_AUTH_1_START();
    ...
    switch(GET_DP_RX0_HDCP_AUTH_STATE())
    {
        case _DP_RX_HDCP_STATE_IDLE:
...
#endif
            {
                ...
                if((ScalerGetBit(PB_20_HDCP_DEBUG, (_BIT7 | _BIT5)) == (_BIT7 | _BIT5)) &&
                   ...
                   (GET_DP_RX0_HDCP_REPEATER_AUTH_1_START() == _TRUE))
                {
                    CLR_DP_RX0_HDCP_REPEATER_AUTH_1_START();
        ...
        case _DP_RX_HDCP_STATE_AUTH_2:
            ...
            if(GET_DP_RX0_HDCP_AUTH_AKSV_WRITTEN() == _FALSE)
            {
        ...
        case _DP_RX_HDCP_STATE_AUTH_DONE:
            ...
            if(GET_DP_TX_HDCP_DOWNSTREAM_EVENT() == _DP_TX_HDCP_DOWNSTREAM_AUTH_EVENT_PASS)
            {
                ...
                {
                    if((ScalerDpRx0HDCPDeviceCountChange() == _TRUE) &&
                       (ScalerDpRx0HdcpCheckValid() == _TRUE) &&
                       (ScalerDpRx0HDCPCheckLvp() == _TRUE))
                    {
                        ScalerDpRx0SetHotPlugEvent(_DP_HDCP_LONG_HPD_EVENT);
...
bit ScalerDpRx0HDCPDeviceCountChange(void)
{
    ...
    if((ucBInfoDevice != ScalerDpRx0GetDpcdInfo(0x06, 0x80, 0x2A)) ||
       (ucBInfoDepth != ScalerDpRx0GetDpcdInfo(0x06, 0x80, 0x2B)))
    {
        return _TRUE;
    }
...
void ScalerDpRx0DfpDeviceDetailConfigReset(void)
{
    ...
    ScalerDpRx0SetDpcdBitValue(0x00, 0x00, 0x07, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
...
{
#if(_EIZO_CUSTOMIZED_VALUE_OF_DPCD_SUPPORT == _OFF)
    ScalerDpRx0SetDpcdBitValue(0x00, 0x00, 0x07, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x01);

    ScalerDpRx0SetDpcdValue(0x00, 0x00, 0x80, (_BIT6 | _BIT4 | _BIT3));
#endif
}
#endif // End of #if(_DP_TX_SUPPORT == _ON)
...
void ScalerDpRx0CpIRQ(EnumDpRxBStatusType enumBStatusType)
{
    switch(enumBStatusType)
    {
        case _DP_HDCP_BSTATUS_LINK_INTEGRITY_FAIL:
            ...
            {
#if(_DP_MST_SUPPORT == _ON)
                if(GET_DP_RX0_HDCP_REPEATER_SUPPORT() == _FALSE)
                {
                    // Reset HDCP Block
        ...
        else
        {
...
#endif
            {
                ...
                if((bit)ucOddFlg == _TRUE)
                {
                    ...
                    SET_DP_RX0_INTERLACE_VTOTAL_NUMBER(_ODD);
                }
                else
                {
                    SET_DP_RX0_INTERLACE_VTOTAL_NUMBER(_EVEN);
                }
...
#if(_DP_ADAPTIVESYNC_SUPPORT == _ON)
    if((ScalerDpRx0GetDpcdInfo(0x00, 0x01, 0x07) & (_BIT7 | _BIT6)) == (_BIT7 | _BIT6))
    {
...
bit ScalerDpRx0MstToSstDeOnlyJudge(WORD *pusDpVtotal, WORD usHBs2BsCount, DWORD ulVBs2BsCount)
{
    ...
    if(ScalerDpRx0MstToSstDeOnlyTimngCheck(ulVBs2BsCount) == _TRUE)
    {
        usMeasureDpVtotal = ScalerDpRx0GetVtotalbyMeasure(usHBs2BsCount, ulVBs2BsCount);
...
bit ScalerDpRx0MstToSstDisplayFormatSetting(void)
{
...
#endif
    {
        ...
        if(ScalerDpRx0MstToSstDeOnlyJudge(&usDpVtotal, usHBs2BsCount, ulVBs2BsCount) == _TRUE)
        {
            bDeOnlyModeJudge = _TRUE;
        }
...
#endif
    {
        if(bDeOnlyModeJudge == _TRUE)
        {
            ...
            DebugMessageRx0("MST DE_Only Mode Enabled!!", ScalerGetByte(PA_35_DPF_CTRL_0));
        }
        else
        {
            DWORD ulBs2VsDelay = 0;
            ...
            DebugMessageRx0("MST Full Last Line Mode Enable!!", ScalerGetByte(PA_35_DPF_CTRL_0));
        }
    }
