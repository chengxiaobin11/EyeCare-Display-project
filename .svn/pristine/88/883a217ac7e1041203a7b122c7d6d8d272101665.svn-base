...
//----------------------------------------------------------------------------------------------------
// ID Code      : _RL6851_PCB_EXAMPLE_76_PIN.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6851_PCB_EXAMPLE_76_PIN)
...
#define _D1_DP_TYPE_C_RTK_PC_SMBUS_IIC          _HW_IIC_76PIN_31_32
...
// Series Pin Share //
//////////////////////
#include "RL6851_PCB_EXAMPLE_76_PIN_PINSHARE.h"
...
#endif // End of #if(_PCB_TYPE == _RL6851_PCB_EXAMPLE_76_PIN)
