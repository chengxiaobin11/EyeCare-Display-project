...
// DFM
//========================================
void RTDFactoryDFMEnter(void);
void RTDFactoryDFMLeft(void);
void RTDFactoryDFMRight(void);
void RTDFactoryDFMExit(void);
//========================================
// TD Reset
//========================================
void RTDFactoryTdResetEnter(void);
void RTDFactoryTdResetLeft(void);
void RTDFactoryTdResetRight(void);
void RTDFactoryTdResetExit(void);
//========================================
// Logo
//========================================
void RTDFactoryLogoEnter(void);
void RTDFactoryLogoLeft(void);
void RTDFactoryLogoRight(void);
void RTDFactoryLogoExit(void);
//========================================
// Adjust DFM
//========================================
void RTDFactoryAdjustDFMEnter(void);
void RTDFactoryAdjustDFMLeft(void);
void RTDFactoryAdjustDFMRight(void);
void RTDFactoryAdjustDFMExit(void);
//========================================
// Adjust SSC
//========================================
void RTDFactoryAdjustSSCEnter(void);
void RTDFactoryAdjustSSCLeft(void);
void RTDFactoryAdjustSSCRight(void);
void RTDFactoryAdjustSSCExit(void);
//========================================
// Adjust TD reset
//========================================
void RTDFactoryAdjustTdResetEnter(void);
void RTDFactoryAdjustTdResetLeft(void);
void RTDFactoryAdjustTdResetRight(void);
void RTDFactoryAdjustTdResetExit(void);
//========================================
// Adjust logo
//========================================
void RTDFactoryAdjustLOGOEnter(void);
void RTDFactoryAdjustLOGOLeft(void);
void RTDFactoryAdjustLOGORight(void);
void RTDFactoryAdjustLOGOExit(void);
//============= Osd Page=======================
...
code void (*OperationFactoryTable[][4])(void) =
{
	...
	{RTDFactoryBRIEnter,						    RTDFactoryBRILeft,							    RTDFactoryBRIRight,							    RTDFactoryBRIExit,},
	{RTDFactoryCONEnter, 						    RTDFactoryCONLeft,							    RTDFactoryCONRight,							    RTDFactoryCONExit,},
    {RTDFactoryAUDIOEnter,                          RTDFactoryAUDIOLeft,                            RTDFactoryAUDIORight,                           RTDFactoryAUDIOExit,},
    ...
    {RTDFactoryDFMEnter,                            RTDFactoryDFMLeft,                              RTDFactoryDFMRight,                             RTDFactoryDFMExit}, 
    {RTDFactorySSCEnter,                            RTDFactorySSCLeft,                              RTDFactorySSCRight,                             RTDFactorySSCExit,},
    {RTDFactoryTdResetEnter,                        RTDFactoryTdResetLeft,					        RTDFactoryTdResetRight, 		                RTDFactoryTdResetExit,},
	{RTDFactoryLogoEnter,                           RTDFactoryLogoLeft,						        RTDFactoryLogoRight,                           	RTDFactoryLogoExit,},
	...
	{RTDFactoryBRIAdjustEnter,						RTDFactoryBRIAdjustLeft,						RTDFactoryBRIAdjustRight,						RTDFactoryBRIAdjustExit,},
	{RTDFactoryCONAdjustEnter,						RTDFactoryCONAdjustLeft,						RTDFactoryCONAdjustRight,						RTDFactoryCONAdjustExit,},
    {RTDFactoryAUDIOAdjustEnter,                    RTDFactoryAUDIOdjustLeft,                       RTDFactoryAUDIOAdjustRight,                     RTDFactoryAUDIOAdjustExit,},
    ...
    {RTDFactoryAdjustDFMEnter,                      RTDFactoryAdjustDFMLeft,                        RTDFactoryAdjustDFMRight,  	                    RTDFactoryAdjustDFMExit,},
    {RTDFactorySSCAdjustEnter,                      RTDFactorySSCAdjustLeft,                        RTDFactorySSCAdjustRight,                       RTDFactorySSCAdjustExit,},
    {RTDFactoryAdjustTdResetEnter,                  RTDFactoryAdjustTdResetLeft,			        RTDFactoryAdjustTdResetRight,                   RTDFactoryAdjustTdResetExit,},
	{RTDFactoryAdjustLOGOEnter,                     RTDFactoryAdjustLOGOLeft,				        RTDFactoryAdjustLOGORight,		                RTDFactoryAdjustLOGOExit,},
...
void RTDFactoryMenuOperation(void)
{
    ...
    {  
        DebugMessageOsd("My_KEY",GET_KEYMESSAGE());
	#if(_PROJECT_ID==_ID_ZQ_2313E01_BOE_MV238FHB_N63_8BIT_FHD100_WLCD_24FH25_20250207)
       ...
       (*OperationFactoryTable[GET_OSD_STATE() - _MENU_FACTORY_AUTOCOLOR][GET_KEYMESSAGE()])();
        ...
        (*OperationFactoryTable[GET_OSD_STATE() - _MENU_FACTORY_AUTOCOLOR][2])();
		else if(GET_KEYMESSAGE()==_DOWN_KEY_MESSAGE)
		(*OperationFactoryTable[GET_OSD_STATE() - _MENU_FACTORY_AUTOCOLOR][1])();	
		else if(GET_KEYMESSAGE()==_LEFT_KEY_MESSAGE)
        (*OperationFactoryTable[GET_OSD_STATE() - _MENU_FACTORY_AUTOCOLOR][3])();
		else if((GET_KEYMESSAGE()==_RIGHT_KEY_MESSAGE))
	     (*OperationFactoryTable[GET_OSD_STATE() - _MENU_FACTORY_AUTOCOLOR][0])();
#endif
...
//--------------------------------------------------
#if 0
void USER_XW_TEST_VALE(WORD ucMeasureValueAvg)
{
	ScalerOsdMapRotation(GET_OSD_ROTATE_STATUS(), _ENABLE, HEIGHT(_OSD_MAIN_MENU_HEIGHT), _DISABLE, 0, _ENABLE);


	RTDFactoryOsdFuncApplyMap(WIDTH(33), HEIGHT(30), COLOR(_CP_WHITE, _CP_BG));
	RTDFactoryOsdFuncDrawWindow(tOSD_FACTORY_WIN0, 0, 0, _FACTORY_OSD_WINDOW_SIZE_X, _FACTORY_OSD_WINDOW_SIZE_Y, _CP_DARKBLUE); 	

	OsdPaletteSelectPalette(_PALETTE_MAIN_MENU);
	
	RTDFactoryOsdFuncShowNumber(ROW(11), COL(5),ucMeasureValueAvg, (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_R);

	
    RTDFactoryOsdFuncSetPosition(_FACTORY_OSD, _FACTORY_OSD_H_POS_MIN, _FACTORY_OSD_V_POS_MIN);	//1¡è3¡ì2?¦Ì£¤¦Ì?????
...
void RTDFactoryMainMenu(void)
{
    ...
    SET_OSD_IN_FACTORY_MENU_STATUS(_TRUE);
	 OsdPaletteSelectPalette(_PALETTE_MAIN_MENU);
#if(_FACTORY_NAVIGATION_SUPPORT == _OFF)
	RTDFactoryOsdFuncApplyMap(WIDTH(_FACTORY_OSD_COL), HEIGHT(_FACTORY_OSD_ROW), COLOR(_CP_WHITE, _CP_BLUE_1));
#else
	ScalerOsdReferenceDelay(_OSD_B, _OSD_SECOND_DELAY);
	ScalerOsd2FontFunction(_ENABLE);
	OsdFuncApplyMapOsdAB(WIDTH(_FACTORY_OSD_COL), HEIGHT(_FACTORY_OSD_ROW), COLOR(_CP_WHITE, _CP_BLUE_1),
							 WIDTH(_MAIN_B_OSD_WIDTH), HEIGHT(_MAIN_B_OSD_HEIGHT), COLOR(_CP_WHITE, _CP_BLUE_1));
#endif

	
#if(_FACTORY_NAVIGATION_SUPPORT == _ON)
    ...
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_MODEL_NAME_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[0], _ENGLISH);//model
	RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_FW_VERSION_ROW), COL(_FACTORY_FW_VERSION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[2], _ENGLISH);//version
	RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_SCALER_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[23], _ENGLISH);//scaler
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_PANEL_NAME_ROW), COL(_FACTORY_PANEL_NAME_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[1], _ENGLISH);//panel


    
	//Chksum
	RTDFactoryOsdFuncPutStringProp(ROW(_BURNIN_FW_CSK_ROW),COL(_BURNIN_MSG_COL),_PFONT_FACTORY_PAGE_0,tFONT_FACTORY_EUROPE, tOSD_BURNIN_PAGE_TABLE[_FACTORY_CHKSUM], _ENGLISH);
	RTDFactoryOsdFuncShowChecksum(ROW(_BURNIN_FW_CSK_ROW), COL(_BURNIN_MSG_COL + 6), (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_5), _PFONT_FACTORY_PAGE_0);

	if(SysSourceGetSourceType() == _SOURCE_VGA) 
	RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_AUTOCOLOR_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[20], _ENGLISH);
   // RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_EEP_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[24], _ENGLISH);
    ...
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_BURNIN_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[4], _ENGLISH);
      ...
      //Reset
   RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_RESET_ROW),COL(_FACTORY_FUNCTION_COL),_PFONT_FACTORY_PAGE_0,tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[29], _ENGLISH);
  ...
  if(SysSourceGetSourceType() == _SOURCE_VGA) 
    ...
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_PANEL_TIME_ROW), COL(_FACTORY_PANEL_TIME_HOUR_NUMBER_COL+4), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_HOUR_MIN_TABLE[1], _ENGLISH);
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_PANEL_TIME_ROW), COL(_FACTORY_PANEL_TIME_MIN_NUMBER_COL+2), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_HOUR_MIN_TABLE[2], _ENGLISH);
    
    //RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_DFM_ROW), COL(_FACTORY_DFM_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_1_TABLE[15], _ENGLISH);

    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_BRI_ROW),COL(_FACTORY_FUNCTION_COL),_PFONT_FACTORY_PAGE_0,tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[26], _ENGLISH);
    #if(_PROJECT_ID !=_ID_ZQ_2313E01_BOE_MV238FHB_N63_8BIT_FHD100_WLCD_24FH25_20250207) // no audio
	RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_AUDIO_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[30], _ENGLISH);
    #endif
	RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_SSC_ROW), COL(_FACTORY_SSC_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_1_TABLE[2], _ENGLISH);
   
	//RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_TD_RESET_ROW), COL(_FACTORY_TD_RESET_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_1_TABLE[16], _ENGLISH);
   // RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_LOGO_ROW), COL(_FACTORY_LOGO_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_1_TABLE[17], _ENGLISH);
   ...
   // RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[9], _ENGLISH);
	...
	if(SysSourceGetSourceType() == _SOURCE_VGA) 
	{
     ...
     {
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_ADC_GAIN_ROW + ucRowCount), COL(_FACTORY_R_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[0], _ENGLISH);
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_ADC_GAIN_ROW + ucRowCount), COL(_FACTORY_G_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[1], _ENGLISH);
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_ADC_GAIN_ROW + ucRowCount), COL(_FACTORY_B_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[2], _ENGLISH);
     }
	}
    for(ucRowCount = 0; ucRowCount < 6; ucRowCount++)
    {
...
#else
		RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount), COL(_FACTORY_R_NUMBER_COL), (g_stColorProcData.usColorTempR ), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_R + ucRowCount * 3);
		RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount), COL(_FACTORY_G_NUMBER_COL), (g_stColorProcData.usColorTempG ), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_G + ucRowCount * 3);
		RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount), COL(_FACTORY_B_NUMBER_COL), (g_stColorProcData.usColorTempB ), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_B + ucRowCount * 3);
#endif
    }
   ...
   if(SysSourceGetSourceType() == _SOURCE_VGA) 
    ...
    // Burnin on or off
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_BURNIN_ROW), COL(_FACTORY_ON_OFF_COL), _PFONT_FACTORY_BURNIN, tFONT_FACTORY_EUROPE, tOSD_FACTORY_ON_OFF_TABLE[GET_FACTORY_BURNIN()], _ENGLISH);
    //DFM
   // RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_DFM_ROW), COL(_FACTORY_DFM_NUMBER_COL), _PFONT_FACTORY_DFM, tFONT_FACTORY_EUROPE, tOSD_FACTORY_ON_OFF_TABLE[TPVDFMModeFlag()], _ENGLISH);
    // SSC value
 #if (_DEF_CT_SRGB_SUPPIRT == _ON)
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_BRI_ROW ), COL(_FACTORY_G_NUMBER_COL),(g_stVscSceneModeData.usBackLightSrgb), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_OSD_PAGE );
#else
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_BRI_ROW ), COL(_FACTORY_G_NUMBER_COL),GET_OSD_BACKLIGHT(), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_OSD_PAGE );
#endif
    #if(_PROJECT_ID !=_ID_ZQ_2313E01_BOE_MV238FHB_N63_8BIT_FHD100_WLCD_24FH25_20250207) // no audio
	RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_AUDIO_ROW ), COL(_FACTORY_G_NUMBER_COL),GET_OSD_VOLUME(), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_BACKGROUND_COLOR_B );
    #endif
	...
	//OperationFactoryTable

	//TD RESET
   // RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_TD_RESET_ROW), COL(_FACTORY_TD_RESET_NUMBER_COL), _PFONT_FACTORY_TD_RESECT, tFONT_FACTORY_EUROPE, tOSD_FACTORY_ON_OFF_TABLE[GET_FACTORY_RESET_OFF()], _ENGLISH);
    //LOGO
 //   RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_LOGO_ROW), COL(_FACTORY_LOGO_NUMBER_COL), _PFONT_FACTORY_LOGO, tFONT_FACTORY_EUROPE, tOSD_FACTORY_ON_OFF_TABLE[GET_FACTORY_FORCE_LOGO_OFF()], _ENGLISH);
    ...
    // Auto color type
    g_ucAutoColotTypeFontPointer = g_usFontPointer0;
...
void RTDFactoryMainMenu(void)
{
	...
	RTDFactoryOsdFuncApplyMap(WIDTH(_FACTORY_OSD_COL), HEIGHT(_FACTORY_OSD_ROW), COLOR(_CP_WHITE, _CP_BLUE));
#else
	RTDFactoryOsdFuncApplyMap(WIDTH(_FACTORY_OSD_COL), HEIGHT(_FACTORY_OSD_ROW), COLOR(_CP_WHITE, _CP_BLUE_1));
#endif
	...
	RTDFactoryOsdFuncSetPosition(1, _FACTORY_OSD_H_POS_ROTATE_270, _FACTORY_OSD_V_POS_ROTATE_270);
    else
	RTDFactoryOsdFuncSetPosition(_FACTORY_OSD, _FACTORY_OSD_H_POS_MIN, _FACTORY_OSD_V_POS_MIN);
   ...
   ScalerOsdMapRotation(GET_OSD_ROTATE_STATUS(), _OSD_MAP_A_REMAPPING_ENABLE,HEIGHT(_FACTORY_OSD_ROW), _OSD_MAP_B_REMAPPING_DISABLE,0,_OSD_FONT_LIB_ROTATION_ENABLE);
   // OsdFuncMapRotation(GET_OSD_ROTATE_STATUS(), _OSD_MAP_A_REMAPPING_ENABLE, HEIGHT(_OSD_MAIN_MENU_HEIGHT), _OSD_MAP_B_REMAPPING_DISABLE, 0, _OSD_FONT_LIB_ROTATION_ENABLE);
    ...
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_MODEL_NAME_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[0], _ENGLISH);//model
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_PANEL_NAME_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[1], _ENGLISH);//panel
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_FW_VERSION_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[2], _ENGLISH);//version

#if(_OSD_AMD_FREESYNC_VERSION ==_ON)
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_MODEL_NAME_ROW), COL(_FACTORY_FUNCTION_COL+15), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[28], _ENGLISH);//AMD Freesync
#endif
	RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_SCALER_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[23], _ENGLISH);//scaler
    //RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_AUTOCOLOR_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[20], _ENGLISH);
    // RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_EEP_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[24], _ENGLISH);
    ...
    //RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_PANEL_TIME_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[8], _ENGLISH);
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_BACKLIST_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[25], _ENGLISH);
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_PANEL_TIME_ROW), COL(_FACTORY_PANEL_TIME_HOUR_NUMBER_COL+4), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_HOUR_MIN_TABLE[1], _ENGLISH);
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_PANEL_TIME_ROW), COL(_FACTORY_PANEL_TIME_MIN_NUMBER_COL+2), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_HOUR_MIN_TABLE[2], _ENGLISH);
   ...
   // RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[9], _ENGLISH);
    #if(_DEF_CT_SRGB_SUPPIRT)
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP1_ROW-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[10], _ENGLISH);
    #endif
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP2_ROW-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[11], _ENGLISH);
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP3_ROW-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[12], _ENGLISH);
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP4_ROW-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[13], _ENGLISH);
#if(_DEF_CT_5800_SUPPORT == _ON)
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP5_ROW-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[14], _ENGLISH);
#endif
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP6_ROW-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[15], _ENGLISH);
   // RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_ADC_GAIN_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[16], _ENGLISH);
   // RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_ADC_OFFSET_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[17], _ENGLISH);
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_EXIT_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[19], _ENGLISH);
#if 0
	...
	#if(_DEF_CT_SRGB_SUPPIRT == _OFF && _DEF_CT_5800_SUPPORT == _OFF)
	for(ucRowCount = 0; ucRowCount < 4; ucRowCount++)
	{
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP2_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_R_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[0], _ENGLISH);
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP2_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_G_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[1], _ENGLISH);
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP2_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_B_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[2], _ENGLISH);
    }

    #elif(_DEF_CT_SRGB_SUPPIRT)
    for(ucRowCount = 0; ucRowCount < 6; ucRowCount++)
	{
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_R_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[0], _ENGLISH);
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_G_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[1], _ENGLISH);
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_B_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[2], _ENGLISH);
    }

    #else
    for(ucRowCount = 0; ucRowCount < 5; ucRowCount++)
	{
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP2_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_R_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[0], _ENGLISH);
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP2_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_G_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[1], _ENGLISH);
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP2_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_B_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[2], _ENGLISH);
...
#if 1//(_CTS_TYPE == _CTS_GEN_1_12BIT)
  	 #if(_DEF_CT_SRGB_SUPPIRT)
		RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_R_NUMBER_COL), (g_stColorProcData.usColorTempR ), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_R + ucRowCount * 3);
		RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_G_NUMBER_COL), (g_stColorProcData.usColorTempG ), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_G + ucRowCount * 3);
		RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_B_NUMBER_COL), (g_stColorProcData.usColorTempB ), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_B + ucRowCount * 3);

   	#else
		RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP2_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_R_NUMBER_COL), (g_stColorProcData.usColorTempR ), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP2_R + ucRowCount * 3);
		RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP2_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_G_NUMBER_COL), (g_stColorProcData.usColorTempG ), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP2_G + ucRowCount * 3);
		RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP2_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_B_NUMBER_COL), (g_stColorProcData.usColorTempB ), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP2_B + ucRowCount * 3);
   	#endif
#else
		RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP2_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_R_NUMBER_COL), (g_stColorProcData.usColorTempR ), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_R + ucRowCount * 3);
		RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP2_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_G_NUMBER_COL), (g_stColorProcData.usColorTempG ), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_G + ucRowCount * 3);
		RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP2_ROW + ucRowCount-_FACTORY_COLORTEMP__ROW_OFFSET), COL(_FACTORY_B_NUMBER_COL), (g_stColorProcData.usColorTempB ), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_B + ucRowCount * 3);
#endif
    }
    RTDNVRamLoadColorSetting(GET_COLOR_TEMP_TYPE());
#if 0
 ...
 //   RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_LOGO_ROW), COL(_FACTORY_LOGO_NUMBER_COL), _PFONT_FACTORY_LOGO, tFONT_FACTORY_EUROPE, tOSD_FACTORY_ON_OFF_TABLE[GET_FACTORY_FORCE_LOGO_OFF()], _ENGLISH);
   ...
   RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_BRI_ROW),COL(_FACTORY_FUNCTION_COL),_PFONT_FACTORY_PAGE_0,tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[26], _ENGLISH);
   RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_CON_ROW),COL(_FACTORY_FUNCTION_COL),_PFONT_FACTORY_PAGE_0,tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[27], _ENGLISH); 
#if (_DEF_CT_SRGB_SUPPIRT == _ON)
...
#if(_DEFAULT_OSD_STYLE==_TRG_OSD_STYLE)
	RTDFactoryOsdFuncChangeColor1Bit(ROW(_FACTORY_COLORIMETRY_SEAMLESS_ROW), COL(0), _FACTORY_OSD_COL, 1, COLOR(_CP_GRAY, _CP_BLUE));
#else
...
void RTDFactoryAutoColorTypeRight(void)
{
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_LOGO);
}
...
#else
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_BACKLIGHT);
#endif
}
...
void RTDFactoryColortemp1RRight(void)
{
  if(SysSourceGetSourceType() == _SOURCE_VGA)
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_OFFSET_BLUE);
  	...
  	{
  	 #if 0//(_DEF_CT_SRGB_SUPPIRT)
  	RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CONTRAST);
	#else
  	RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_RESET_BURNIN_TIME);
	#endif
  	}
...
void RTDFactoryColortemp4BLeft(void)
{
    ...
    RTDFactoryOsdChangColorTemp(_CT_5000);
#else    
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT6_RED);
    RTDFactoryOsdChangColorTemp(_FACTORY_COLORTEMP_ITEM6);
...
//============= BRI =======================
void RTDFactoryBRIEnter(void)
{
    g_usBackupValue =GET_OSD_BACKLIGHT();
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_BACKLIGHT_ADJ);
}

void RTDFactoryBRILeft(void)
{
	...
	RTDFactoryOsdFuncSelectItem(_MENU_FACTORT_AUDIO);
    RTDFactoryOsdChangColorTemp(_CT_6500);
...
//============= CON =======================
void RTDFactoryCONEnter(void)
{
    g_usBackupValue =GET_OSD_CONTRAST();
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CONTRAST_ADJ);
}

void RTDFactoryCONLeft(void)
{  
  	 #if(_DEF_CT_SRGB_SUPPIRT)
      RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT1_RED);
	  RTDFactoryOsdChangColorTemp(_CT_SRGB);
...
void RTDFactoryCONRight(void)
{
	RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_BACKLIGHT);

}

void RTDFactoryCONExit(void)
{
    RTDFactoryOsdFuncDisableOsd();
}
...
void RTDFactoryAUDIOEnter(void)
{
  g_usBackupValue=GET_OSD_VOLUME();
  RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_AUDIO_ADJ);
}

void RTDFactoryAUDIOLeft(void)
{  
    
      RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_SSC);
}

void RTDFactoryAUDIORight(void)
{
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_BACKLIGHT);
    RTDFactoryOsdChangColorTemp(_CT_SRGB);

}
void RTDFactoryAUDIOExit(void)
{
    RTDFactoryOsdFuncDisableOsd();
}
...
void RTDFactoryBurninOnOffLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_BURNIN_ON_OFF, GET_FACTORY_BURNIN());
}
...
//============= BRI Adjust=======================
void RTDFactoryBRIAdjustEnter(void)
{

    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_BACKLIGHT);
}

void RTDFactoryBRIAdjustLeft(void)
{
#if (_DEF_CT_SRGB_SUPPIRT == _ON)
	RTDFactoryOsdDispNumber(_MENU_FACTORY_BACKLIGHT_ADJ,(g_stVscSceneModeData.usBackLightSrgb));
#else
	RTDFactoryOsdDispNumber(_MENU_FACTORY_BACKLIGHT_ADJ,GET_OSD_BACKLIGHT());
#endif
}

void RTDFactoryBRIAdjustRight(void)
{
#if (_DEF_CT_SRGB_SUPPIRT == _ON)
	RTDFactoryOsdDispNumber(_MENU_FACTORY_BACKLIGHT_ADJ,(g_stVscSceneModeData.usBackLightSrgb));
#else
...
void RTDFactoryBRIAdjustExit(void)
{
...
//============= CON Adjust=======================
void RTDFactoryCONAdjustEnter(void)
{

    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CONTRAST);
}

void RTDFactoryCONAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CONTRAST_ADJ, GET_OSD_CONTRAST());
}

void RTDFactoryCONAdjustRight(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CONTRAST_ADJ, GET_OSD_CONTRAST());
}

void RTDFactoryCONAdjustExit(void)
{
...
void RTDFactoryAUDIOAdjustEnter(void)
{

    RTDFactoryOsdFuncSelectItem(_MENU_FACTORT_AUDIO);
}

void RTDFactoryAUDIOdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_AUDIO_ADJ, GET_OSD_VOLUME());
}

void RTDFactoryAUDIOAdjustRight(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_AUDIO_ADJ, GET_OSD_VOLUME());
}
...
void RTDFactoryAUDIOAdjustExit(void)
{
...
void RTDFactoryDFMEnter(void)
{
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_DFM_ADJ);
}
...
void RTDFactoryAdjustDFMEnter(void)
{
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_DFM);
}

void RTDFactoryAdjustDFMLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_DFM_ADJ,  TPVDFMModeFlag());
}

void RTDFactoryAdjustDFMRight(void)
{
	RTDFactoryAdjustDFMLeft();
}
...
void RTDFactoryTdResetEnter(void)
{
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_TD_RESET_ADJ);
}
...
void RTDFactoryAdjustTdResetEnter(void)
{
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_TD_RESET);

}

void RTDFactoryAdjustTdResetLeft(void)
{
	RTDFactoryOsdDispNumber(_MENU_FACTORY_TD_RESET_ADJ, GET_FACTORY_RESET_OFF());
}

void RTDFactoryAdjustTdResetRight(void)
{
	RTDFactoryAdjustTdResetLeft();
}
...
void RTDFactoryLOGOEnter(void)
{
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_LOGO_ADJ);
}
...
void RTDFactoryAdjustLOGOLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_LOGO_ADJ, g_usAdjustValue);
}

void RTDFactoryAdjustLOGORight(void)
{
	RTDFactoryAdjustLOGOLeft();
}
...
void RTDFactorySSCAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_SSC_ADJ, UserCommonNVRamGetSystemData(_SSC));
}
...
void RTDFactoryDPAuxModeAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_DP_AUX_MODE_ON_OFF, g_usAdjustValue);
}
...
{
	if(GET_FACTORY_BURNIN()) // ³ÈÀ¶ÉÁË¸
	{

		if((bLED1 == _LED_OFF) && (bLED2 == _LED_ON))
		{
			bLED1=_LED_ON;
			bLED2=_LED_OFF;
		}
	...
	else	// ³ÈµÆÉÁË¸ 
	{
		...
		if((bLED1 == _LED_ON) && (bLED2 == _LED_ON))
		{
			bLED1=_LED_OFF;
	        bLED2=_LED_ON;
		}
	...
	ScalerTimerActiveTimerEvent(SEC(1), _USER_TIMER_EVENT_OSD_INDICATO_LIGHT_FACTORY_FLICKER);
}
