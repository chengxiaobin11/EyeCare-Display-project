...
//--------------------------------------------------
//  GDIPHY Z0 Impedance Option
//--------------------------------------------------
#define _BY_CONNECTOR                                     0
#define _LG_90_OHM                                        1 // for HDMI Port
#define _U3_90_OHM                                        2 // for DP Port
...
//--------------------------------------------------
//  Audio DAC FLATLINE Control
//--------------------------------------------------
#define _FLATLINE_TO_ZERO_LEVEL                           0
#define _FLATLINE_TO_REPEAT_VALUE                         1
...
//  Type C HW Version
//--------------------------------------------------
#define _TYPE_C_PD_HW_VERSION_NULL                        0x00
#define _TYPE_C_PD_HW_VERSION_1_0                         0x01
...
#define _MEMORY_SPEED_232MHZ                              232U
...
//--------------------------------------------------
// SDR PLL SSC Amplitude
//--------------------------------------------------
#define _0_5_PERCENT                                      0
#define _1_PERCENT                                        1
#define _1_5_PERCENT                                      2
#define _2_PERCENT                                        3
...
#define _M2PLL_STRUCT_COMBO_SDRPLL                        2
...
// Scaling Down Generation
//--------------------------------------------------
#define _SD_VSD_GEN_0                                     0
#define _SD_VSD_GEN_1                                     1
...
#define _GARBAGE_PREVENT_BY_BACKLIGHT_FW_POLLING          2
...
//--------------------------------------------------
// Definitions of 5400 Status Polling Time
//--------------------------------------------------
#define _RTS5400_SERIES_STATUS_POLL_TIME_500MS            500 // (ms)
#define _RTS5400_SERIES_STATUS_POLL_TIME_1000MS           1000 // (ms)
#define _RTS5400_SERIES_STATUS_POLL_TIME_1500MS           1500 // (ms)
#define _RTS5400_SERIES_STATUS_POLL_TIME_2000MS           2000 // (ms)

//--------------------------------------------------
//  Type C RTS5400 Port Controller SMBus Mode
//--------------------------------------------------
#define _RTS5400_SERIES_POLLING_MODE                      0x00
#define _RTS5400_SERIES_INT_MODE                          0x01

//--------------------------------------------------
// SMBus Arbitration Type List
//--------------------------------------------------
#define _RTS_SMBUS_ARBITRATION_NONE                       0
#define _RTS_SMBUS_ARBITRATION_DELAY_MODE                 1
#define _RTS_SMBUS_ARBITRATION_HANDSHAKE_MODE             2
...
//--------------------------------------------------
#define _ADC_AFE_POWER_CONTROL_GEN_1                      0
#define _ADC_AFE_POWER_CONTROL_GEN_2                      1
...
//--------------------------------------------------
// HW Digital Audio Frequency Detection Type
//--------------------------------------------------
#define _AUDIO_AFD_HW_MODE                                0
#define _AUDIO_AFD_FW_MODE                                1
...
#define _DUAL_BANK_DIGITAL_SIGNATURE_ONLY                 4
...
//--------------------------------------------------
#define _MULTIPANEL_CLOCK_MAX_NONE                        (0U)
#define _MULTIPANEL_CLOCK_MAX_FHD_100_HZ                  (235000U)
#define _MULTIPANEL_CLOCK_MAX_WUXGA_100_HZ                (260000U)
#define _MULTIPANEL_CLOCK_MAX_FHD_120_HZ                  (300000U)
