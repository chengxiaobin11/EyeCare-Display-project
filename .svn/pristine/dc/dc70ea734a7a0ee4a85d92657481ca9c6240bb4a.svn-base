...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_DEMO_LOCAL_DIMMING_2MHL1DP1mD_PINSHARE.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
// USB_EN
#define _PIN_AK2                                (2 & 0x07) // Page 10-0x0C[2:0]
...
// ADC_KEY1
#define _PIN_AJ9                                (3 & 0x07) // Page 10-0x13[2:0]
...
// EDID1_ADD1
#define _PIN_AK4                                (2 & 0x07) // Page 10-0x18[2:0]
...
// EDID1_ADD2
#define _PIN_AM2                                (2 & 0x07) // Page 10-0x1B[2:0]
...
// Local Diming V_SYNC
#define _PIN_AF28                               (3 & 0x07) // Page 10-0x3F[2:0]
...
// EDID2_ADD2
#define _PIN_AG8                                (2 & 0x07) // Page 10-0x5D[2:0]
// 0 ~ 6 (0: PDD5i<I>, 1: PDD5o<PP>, 2: PDD5o<OD>, 3: PWM1<PP>, 4: PWM1<OD>,
//        5:TCON[7], 6:IICSCL2)

// EDID2_ADD1
#define _PIN_AG9                                (2 & 0x07) // Page 10-0x5E[2:0]
