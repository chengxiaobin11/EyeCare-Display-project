...
extern bit SysPowerCheckFakeOff(void);
...
extern EnumAudioSamplingFreqPacket SysAudioGetAudioBackupFreq(void);
...
extern void SysAudioFastMuteProc(bit bMute);
#endif

extern void SysAudioOutputProc(bit bEnable);

#if(_AUDIO_DVC_FAST_CONTROL_SUPPORT == _ON)
extern void SysAudioFastOutputProc(bit bEnable);
#endif
...
extern BYTE SysTypeCGetPortOperationMode(BYTE ucInputPort);
...
extern EnumTypeCCcDetectStatus SysTypeCGetCcPinStatus(EnumTypeCChannel enumTypeCChannel);
#endif
