...
#elif((_DUAL_BANK_FLASH_PARTITION_SUPPORT == _ON) && (_DUAL_BANK_FLASH_PARTITION_BOOT_USER_SEL == _DUAL_BANK_FLASH_PARTITION_BOOT))
    memset((volatile BYTE data *)0x08, 0, ((SP - 0x01) - 0x08));
#else
    // for Diff /Copy Bank / Flash Partition User
