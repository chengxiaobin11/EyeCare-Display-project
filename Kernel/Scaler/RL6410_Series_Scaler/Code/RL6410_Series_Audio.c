...
void ScalerAudioD2HDMIAudioInitial(void)
{
    ...
    ScalerSetDataPortBit(P71_C9_HDMI_AP, _P71_CA_PT_07_PORT_PAGE71_HDMI_MAG_M_FINAL, ~(_BIT3 | _BIT1 | _BIT0), 0x00);
    ScalerSetDataPortByte(P71_C9_HDMI_AP, _P71_CA_PT_08_PORT_PAGE71_HDMI_MAG_L_FINAL, 0x00);
    ScalerSetDataPortByte(P71_C9_HDMI_AP, _P71_CA_PT_09_PORT_PAGE71_HDMI_MAG_R_FINAL, 0x00);
#endif
...
#if(_D4_HDMI_SUPPORT == _ON)
            ScalerAudioD4InternalAudioGenSwitch(bOn, enumAudioLeftRightChannelSelect);
#endif
            break;
...
#if(_D5_HDMI_SUPPORT == _ON)
            ScalerAudioD5InternalAudioGenSwitch(bOn, enumAudioLeftRightChannelSelect);
#endif
            break;
