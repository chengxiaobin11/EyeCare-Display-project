...
BYTE xdata MCU_DDCRAM_D3[_D3_EMBEDDED_DDCRAM_MAX_SIZE]          _at_ _EMBEDDED_DDCRAM_DDC3_ADDRESS;
#endif // End of _DDC_CHANNEL_FOR_D3

#endif // End of #if(_D3_EMBEDDED_DDCRAM_MAX_SIZE != _EDID_SIZE_NONE)

#if(_D4_EMBEDDED_DDCRAM_MAX_SIZE != _EDID_SIZE_NONE)

#if(_D4_DDC_CHANNEL_SEL == _DDC4)
BYTE xdata MCU_DDCRAM_D4[_D4_EMBEDDED_DDCRAM_MAX_SIZE]          _at_ _EMBEDDED_DDCRAM_DDC4_ADDRESS;
#endif // End of _DDC_CHANNEL_FOR_D4

#endif // End of #if(_D4_EMBEDDED_DDCRAM_MAX_SIZE != _EDID_SIZE_NONE)

#if(_D5_EMBEDDED_DDCRAM_MAX_SIZE != _EDID_SIZE_NONE)

#if(_D5_DDC_CHANNEL_SEL == _DDC5)
BYTE xdata MCU_DDCRAM_D5[_D5_EMBEDDED_DDCRAM_MAX_SIZE]          _at_ _EMBEDDED_DDCRAM_DDC5_ADDRESS;
#endif // End of _DDC_CHANNEL_FOR_D5

#endif // End of #if(_D5_EMBEDDED_DDCRAM_MAX_SIZE != _EDID_SIZE_NONE)

#if(_D6_EMBEDDED_DDCRAM_MAX_SIZE != _EDID_SIZE_NONE)
BYTE xdata MCU_DDCRAM_D6[_D6_EMBEDDED_DDCRAM_MAX_SIZE]          _at_ _EMBEDDED_DDCRAM_DDC6_ADDRESS;
#endif
    ...
    if(enumMode == _DDCCI_MODE)
    {
        ...
        switch(ucInputPort)
        {
            ...
            case _D3_INPUT_PORT:
                ...
                // DDCCI switch to DDC3 if D3 is assigned to DDC3
                MCU_FF22_IIC_CH_SEL &= ~(_BIT2 | _BIT1 | _BIT0);
            ...
            case _D4_INPUT_PORT:
                ...
                // DDCCI switch to DDC4 if D4 is assigned to DDC4
                MCU_FF22_IIC_CH_SEL &= ~(_BIT2 | _BIT1 | _BIT0);
            ...
            case _D5_INPUT_PORT:
                ...
                // DDCCI switch to DDC5 if D5 is assigned to DDC5
                MCU_FF22_IIC_CH_SEL &= ~(_BIT2 | _BIT1 | _BIT0);
    ...
    if(bEnable == _ENABLE)
    {
        switch(MCU_FF22_IIC_CH_SEL)
        {
            case _DDCCI_ADC_DDC:
                ...
                MCU_FE6F_DDC3_DDC_CONTROL_2 |= _BIT4;
                MCU_FE78_DDC4_DDC_CONTROL_2 |= _BIT4;
...
void ScalerMcuDdcciInitial(void)
{
    ...
    MCU_FE95_IIC_2_SET_SLAVE = 0x3D;
    MCU_FEA4_IIC_3_SET_SLAVE = 0x3D;
...
void ScalerMcuDdcISPChannelCtrl(BYTE ucDdcChannel, bit bEnable)
{
    switch(ucDdcChannel)
    {
        ...
        case _DDC3:
            // DDC3 ISP
            MCU_FE6F_DDC3_DDC_CONTROL_2 = (bEnable) ? (MCU_FE6F_DDC3_DDC_CONTROL_2 | _BIT3) : (MCU_FE6F_DDC3_DDC_CONTROL_2 & (~_BIT3));
            break;

        case _DDC4:
            // DDC4 ISP
            MCU_FE78_DDC4_DDC_CONTROL_2 = (bEnable) ? (MCU_FE78_DDC4_DDC_CONTROL_2 | _BIT3) : (MCU_FE78_DDC4_DDC_CONTROL_2 & (~_BIT3));
            break;

        case _DDC5:
            // DDC4 ISP
            MCU_FE81_DDC5_DDC_CONTROL_2 = (bEnable) ? (MCU_FE81_DDC5_DDC_CONTROL_2 | _BIT3) : (MCU_FE81_DDC5_DDC_CONTROL_2 & (~_BIT3));
            break;
