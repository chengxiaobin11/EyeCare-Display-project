...
void ScalerDpRx1RebuildPhy_WDINT(BYTE ucDpLinkRate, BYTE ucDpcdLane) using 3
{
    ...
    g_pucDpRx1LEFineTune[0] = ScalerGetBit_EXINT(P1D_A2_L0_LIMIT_INIT, (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
    g_pucDpRx1LEFineTune[1] = ScalerGetBit_EXINT(P1D_B2_L1_LIMIT_INIT, (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
    g_pucDpRx1LEFineTune[2] = ScalerGetBit_EXINT(P1D_C2_L2_LIMIT_INIT, (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
    g_pucDpRx1LEFineTune[3] = ScalerGetBit_EXINT(P1D_D2_L3_LIMIT_INIT, (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
    ...
    else
    {
        ...
        switch(ucFakeLTLaneCount)
        {
            ...
            case _DP_TWO_LANE:
                ...
                {
                    if(((ScalerDpRx1GetDpcdBitInfo_EXINT0(0x00, 0x00, 0x0E, _BIT7) == _BIT7) &&
                        ((ScalerDpRx1GetDpcdInfo_EXINT0(0x00, 0x22, 0x02) & 0x1F) == _DP_ONE_LANE)) ||
                       ((ScalerDpRx1GetDpcdBitInfo_EXINT0(0x00, 0x00, 0x0E, _BIT7) == 0x00) &&
                        ((ScalerDpRx1GetDpcdInfo_EXINT0(0x00, 0x00, 0x02) & 0x1F) == _DP_ONE_LANE)))
                    {
                        ScalerDpRx1SetDpcdValue_EXINT0(0x00, 0x02, 0x02, 0x01);
                    }
                    else
            ...
            default:
                   ...
                   (((pucDpPhyLinkTrainingLevel[3] & _BIT2) == _BIT2) || ((pucDpPhyLinkTrainingLevel[3] & (_BIT1 | _BIT0)) == (ScalerDpRx1GetDpcdBitInfo_EXINT0(0x00, 0x02, 0x07, (_BIT5 | _BIT4)) >> 4))))
                {
                    ...
                    else if(((ScalerDpRx1GetDpcdBitInfo_EXINT0(0x00, 0x00, 0x0E, _BIT7) == _BIT7) &&
                             ((ScalerDpRx1GetDpcdInfo_EXINT0(0x00, 0x22, 0x02) & 0x1F) == _DP_TWO_LANE)) ||
                            ((ScalerDpRx1GetDpcdBitInfo_EXINT0(0x00, 0x00, 0x0E, _BIT7) == 0x00) &&
                             ((ScalerDpRx1GetDpcdInfo_EXINT0(0x00, 0x00, 0x02) & 0x1F) == _DP_TWO_LANE)))
                    {
                        ScalerDpRx1SetDpcdValue_EXINT0(0x00, 0x02, 0x02, 0x11);
                    }
                    else
