...
void ScalerDpRx1PassiveDFEFineTune(void)
{
    ...
    else if(GET_DP_RX1_LINK_TRAINING_STATUS() == _DP_NORMAL_LINK_TRAINING_PASS)
    {
        ScalerSetByte(P1D_A2_L0_LIMIT_INIT, g_pucDpRx1LEFineTune[0]);
        ScalerSetByte(P1D_B2_L1_LIMIT_INIT, g_pucDpRx1LEFineTune[1]);
        ScalerSetByte(P1D_C2_L2_LIMIT_INIT, g_pucDpRx1LEFineTune[2]);
        ScalerSetByte(P1D_D2_L3_LIMIT_INIT, g_pucDpRx1LEFineTune[3]);
    }
    else
    {
