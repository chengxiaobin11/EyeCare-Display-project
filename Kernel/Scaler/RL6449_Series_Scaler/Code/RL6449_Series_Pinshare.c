...
void ScalerPinshareGpioDdcPinSwitch(BYTE ucPinType)
{
    switch(ucPinType)
    {
        ...
        case _DDC2_SWITCH_GPI:
            ScalerSetBit(P10_49_PIN_SHARE_CTRLB1__ADION, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), (_BIT7 | ((BYTE)_GPIO_INPUT))); // Pin_212
            ScalerSetByte(P10_4A_PIN_SHARE_CTRLB2__ADION, (BYTE)_GPIO_INPUT); // Pin_213
            break;
        ...
        case _DDC3_SWITCH_GPI:
            ScalerSetBit(P10_4B_PIN_SHARE_CTRLB3__ADION, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), (_BIT7 | ((BYTE)_GPIO_INPUT))); // Pin_214
            ScalerSetByte(P10_4C_PIN_SHARE_CTRLB4__ADION, (BYTE)_GPIO_INPUT); // Pin_215
            break;
