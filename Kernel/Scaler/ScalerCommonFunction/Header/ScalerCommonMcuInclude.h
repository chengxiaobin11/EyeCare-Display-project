...
//--------------------------------------------------
// MACRO for Receive DDCCI Command
//--------------------------------------------------
#if(_DDCCI_AUTO_SWITCH_SUPPORT == _ON)
#define GET_RECEIVE_DDCCI_CMD_NOT_FINISH()  (g_bReceiveDdcciCmdNotFinish)
#define SET_RECEIVE_DDCCI_CMD_NOT_FINISH()  (g_bReceiveDdcciCmdNotFinish = _TRUE)
#define CLR_RECEIVE_DDCCI_CMD_NOT_FINISH()  (g_bReceiveDdcciCmdNotFinish = _FALSE)
#endif
...
//****************************************************************************
//--------------------------------------------------
// Enumerations of DDCCI Auto Switch DDC Channel
//--------------------------------------------------
typedef enum
{
    _DDCCI_ADC_DDC = 0x00,
    ...
    _DDCCI_DDC4,
    _DDCCI_DDC5,
    _DDCCI_ADC_DDC2 = 0x08,
} EnumDdcciAutoSwitchDdcChannel;
...
extern bit g_bSrcReadDdcciAlready;
#if(_DDCCI_AUTO_SWITCH_SUPPORT == _ON)
extern bit g_bReceiveDdcciCmdNotFinish;
#endif
...
#if(_SW_IIC_SUPPORT == _ON)
extern bit ScalerMcuIICRead(BYTE ucSlaveAddr, BYTE ucSubAddrLength, DWORD ulSubAddr, WORD usLength, BYTE *pucReadArray);
extern bit ScalerMcuIICWrite(BYTE ucSlaveAddr, BYTE ucSubAddrLength, DWORD ulSubAddr, WORD usLength, BYTE *pucWriteArray);
#endif
...
extern BYTE mt321x_soft_reset(void);
extern void mt321x_device_set_default(void);
extern BYTE mt321x_detect(void);
extern void mt321x_set_rgb_flicker_sample_time(DWORD sample_time_us);
extern void mt321x_set_rgb_integration_time_us(DWORD rgb_time_us,DWORD sample_time_us);
extern BYTE ScalerMcuMt3212CtInit(void);
extern void ScalerMcuGetMt3212CtData(void);
#endif

#if _LS_PS_SUPPORT
#define PS_MAX_DIS                          100
#define PS_CEN_DIS                          50
#define PS_MIN_DIS                          30
#define ALS_MAX_BRI                         100
#define ALS_CEN_BRI                         80
#define ALS_MIN_BRI                         20

extern void ScalerMcuLSPsReset(void);
extern void ScalerMcuLSPsInit(void);
extern BYTE ScalerMcuGetPSData(void);
extern BYTE ScalerMcuALSDataHanlder(void);
#endif
