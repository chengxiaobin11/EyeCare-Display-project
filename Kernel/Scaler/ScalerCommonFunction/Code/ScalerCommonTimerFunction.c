...
#define _TIMER_COUNT_TEMP_IDLE                  ((_SYS_PS_TIMER_PRECISION_SUPPPORT == _ON) ? ((WORD)(((DWORD)_EXT_XTAL + (_TIMER2_COUNT_IN_TEMP / 2)) / _TIMER2_COUNT_IN_TEMP)) : ((WORD)(((DWORD)_INTERNAL_OSC_XTAL + (_TIMER2_COUNT_PS_TEMP / 2)) / _TIMER2_COUNT_PS_TEMP)))
...
// Active Mode //
/////////////////
#define _TIMER1_UART_COUNT_TEMP                 ((DWORD)4 * _UART_SMOD0_NORMAL * _TIMER_COUNT_TEMP1 * _FLASH_CLK_DIV * _MCU_CLK_DIV * _UART_BAUD_RATE_POWER_NORMAL / 1000)
#if(_UART_LOW_BAUD_RATE_SUPPORT == _OFF)
#define _TIMER1_UART_COUNT_BYTE                 (0x100 - ((BYTE)(((DWORD)_TIMER_COUNT_TEMP2 + (_TIMER1_UART_COUNT_TEMP / 2)) / _TIMER1_UART_COUNT_TEMP)))
#else
#define _TIMER1_UART_COUNT_WORD                 (0xFFFF - ((WORD)(((DWORD)_TIMER_COUNT_TEMP2 + (_TIMER1_UART_COUNT_TEMP / 2)) / _TIMER1_UART_COUNT_TEMP)))
#endif

////////////////////////////
// Power Saving/Down Mode //
////////////////////////////
#define _TIMER1_UART_COUNT_PS_TEMP              ((DWORD)4 * _UART_SMOD0_SAVING * _FLASH_CLK_PS_DIV * _MCU_CLK_PS_DIV * _UART_BAUD_RATE_POWER_SAVING / 1000)
#if(_UART_LOW_BAUD_RATE_SUPPORT == _OFF)
...
#else
#define _TIMER1_UART_COUNT_PS_WORD              (0xFFFF - ((WORD)(((DWORD)_INTERNAL_OSC_XTAL + (_TIMER1_UART_COUNT_PS_TEMP / 2)) / _TIMER1_UART_COUNT_PS_TEMP)))
#endif

//////////////////////////////////////////////////////
// Power Saving/Down Fast Mode for DP Aux Handshake //
//////////////////////////////////////////////////////
#define _TIMER1_UART_COUNT_PS_FAST_TEMP         ((DWORD)4 * _UART_SMOD0_SAVING * _FLASH_CLK_PS_FAST_DIV * _MCU_CLK_PS_DIV * _UART_BAUD_RATE_POWER_SAVING / 1000)
#if(_UART_LOW_BAUD_RATE_SUPPORT == _OFF)
...
#else
#define _TIMER1_UART_COUNT_PS_FAST_WORD         (0xFFFF - ((WORD)(((DWORD)_INTERNAL_OSC_XTAL + (_TIMER1_UART_COUNT_PS_FAST_TEMP / 2)) / _TIMER1_UART_COUNT_PS_FAST_TEMP)))
#endif

//////////////////
// Initial Mode //
//////////////////
#define _TIMER1_UART_COUNT_IN_TEMP              ((DWORD)4 * _UART_SMOD0_NORMAL * _FLASH_CLK_IN_DIV * _MCU_CLK_DIV * _UART_BAUD_RATE_POWER_NORMAL / 1000)
#if(_UART_LOW_BAUD_RATE_SUPPORT == _OFF)
#define _TIMER1_UART_COUNT_IN_BYTE              (0x100 - ((BYTE)(((DWORD)_EXT_XTAL + (_TIMER1_UART_COUNT_IN_TEMP / 2)) / _TIMER1_UART_COUNT_IN_TEMP)))
#else
#define _TIMER1_UART_COUNT_IN_WORD              (0xFFFF - ((WORD)(((DWORD)_EXT_XTAL + (_TIMER1_UART_COUNT_IN_TEMP / 2)) / _TIMER1_UART_COUNT_IN_TEMP)))
#endif
...
//////////////////
#if(_UART_LOW_BAUD_RATE_SUPPORT == _OFF)
#define _TIMER1_UART_COUNT_IDLE_BYTE            ((_SYS_PS_TIMER_PRECISION_SUPPPORT == _ON) ? (_TIMER1_UART_COUNT_IN_BYTE) : (_TIMER1_UART_COUNT_PS_BYTE))
#else
#define _TIMER1_UART_COUNT_IDLE_WORD            ((_SYS_PS_TIMER_PRECISION_SUPPPORT == _ON) ? (_TIMER1_UART_COUNT_IN_WORD) : (_TIMER1_UART_COUNT_PS_WORD))
#endif
...
////////////////////////////////////////////////////////////////////////////
#if(_FLASH_CLK_SPEED == _FLASH_LOW_SPEED)
#define _TIMER1_UART_COUNT_OSD_TEMP             ((DWORD)4 * _UART_SMOD0_NORMAL * _TIMER_COUNT_TEMP1 * _FLASH_CLK_FAST_DIV * _MCU_CLK_DIV * _UART_BAUD_RATE_POWER_NORMAL / 1000)
#if(_UART_LOW_BAUD_RATE_SUPPORT == _OFF)
...
#else
#define _TIMER1_UART_COUNT_OSD_WORD             (0xFFFF - ((WORD)((((DWORD)_TIMER_COUNT_TEMP2 + (_TIMER1_UART_COUNT_OSD_TEMP / 2)) / _TIMER1_UART_COUNT_OSD_TEMP))))
#endif
#endif
...
// Idle Mode //
///////////////
#define _IDLE_TIME_TEMP                         ((_SYS_PS_TIMER_PRECISION_SUPPPORT == _ON) ? ((DWORD)0x0000FFFF / (((DWORD)_EXT_XTAL + _TIMER2_COUNT_IN_TEMP) / _TIMER2_COUNT_IN_TEMP)) : ((DWORD)0x0000FFFF / (((DWORD)_INTERNAL_OSC_XTAL + _TIMER2_COUNT_PS_TEMP) / _TIMER2_COUNT_PS_TEMP)))

#define _IDLE_TIME                              ((_IDLE_TIME_TEMP < 100) ? _IDLE_TIME_TEMP : 100) // Avoid_TIMER2_COUNT_IDLE_NUM Overflow

#define _TIMER2_COUNT_IDLE_NUM                  ((_SYS_PS_TIMER_PRECISION_SUPPPORT == _ON) ? (0xFFFF - ((WORD)((((DWORD)_EXT_XTAL + (_TIMER2_COUNT_IN_TEMP / 2)) / _TIMER2_COUNT_IN_TEMP) * _IDLE_TIME))) : (0xFFFF - ((WORD)((((DWORD)_INTERNAL_OSC_XTAL + (_TIMER2_COUNT_PS_TEMP / 2)) / _TIMER2_COUNT_PS_TEMP) * _IDLE_TIME))))
...
BYTE g_ucTimerCountHByte1_Uart;
BYTE g_ucTimerCountLByte1_Uart;
#endif
#endif
//****************************************************************************
...
void ScalerTimerCancelTimerEvent_EXINT1(EnumScalerTimerEventID enumEventID);
#endif
...
void ScalerTimerWDEventProc_WDINT(void) using 3
{
    ...
    if(((MCU_FFEB_WDT_TEST & (_BIT7 | _BIT2)) == (_BIT7 | _BIT2)) || (GET_GLOBAL_XTAL_CLK_SWITCH() != _GLOBAL_XTAL_CLK_SEL_UNCHANGE))
    {
        ...
        ScalerDpRxDpcdPortAccessBackup_WDINT();
#endif
            ...
            if(GET_WD_EVENT_VALID(ucIndex) == _TRUE)
            {
                if(GET_WD_EVENT_TIME(ucIndex) <= usWDLatchedTime)
                {
                    switch(GET_WD_EVENT_ID(ucIndex))
                    {
                        ...
                        case _SCALER_WD_TIMER_EVENT_CC_RX0_DETECT_VBUS:
#if(_TYPE_C_PMIC_TYPE != _PMIC_NONE)
                        case _SCALER_WD_TIMER_EVENT_CC_RX0_CHECK_VBUS_0V:
#endif
#if((_TYPE_C_EMB_CTS_FLOW == _ON) && (_HW_TYPE_C_FUNCTION_GEN == _TYPE_C_FUNCTION_GEN_1))
                        case _SCALER_WD_TIMER_EVENT_CC_RX0_CHANGE_VBUS_OFF_THRESHOLD:
#endif
                            ScalerTypeCRx0CcWDTimerEventProc_WDINT(GET_WD_EVENT_ID(ucIndex), &ucActiveWDID, &ucActiveWDTime);

                            break;

                        case _SCALER_WD_TIMER_EVENT_PD_RX0_CBL_TIMEOUT:
                        case _SCALER_WD_TIMER_EVENT_PD_RX0_SEND_HARD_RST:
                        ...
                        case _SCALER_WD_TIMER_EVENT_PD_RX0_SNK_SWITCH_TO_SRC:
                        case _SCALER_WD_TIMER_EVENT_PD_RX0_SEND_EPR_ENTER_FAILED:
                        case _SCALER_WD_TIMER_EVENT_PD_RX0_SEND_VCONN_SWAP:
                        case _SCALER_WD_TIMER_EVENT_PD_RX0_CHUNK_SENDER_REQ_TIMEOUT:
                        case _SCALER_WD_TIMER_EVENT_PD_RX0_SEND_EPR_SRC_CAP:
                        case _SCALER_WD_TIMER_EVENT_PD_RX0_TX_AVALIABLE:
...
#if((_DP_HDCP_2_2_SUPPORT == _ON) && (_D0_DP_EXIST == _ON))
                        case _SCALER_WD_TIMER_EVENT_DP_RX0_HDCP2_AKE_INIT:

                            ScalerDpRx0Hdcp2AkeInitProc_WDINT();

                            break;
#endif
#if((_DP_HDCP_2_2_SUPPORT == _ON) && (_D1_DP_EXIST == _ON))
                        case _SCALER_WD_TIMER_EVENT_DP_RX1_HDCP2_AKE_INIT:

                            ScalerDpRx1Hdcp2AkeInitProc_WDINT();

                            break;
#endif

#if((_DP_HDCP_2_2_SUPPORT == _ON) && (_D0_DP_EXIST == _ON))
                        case _SCALER_WD_TIMER_EVENT_DP_RX0_HDCP2_SKE:

                            ScalerDpRx0Hdcp2SkeProc_WDINT();

                            break;
#endif
#if((_DP_HDCP_2_2_SUPPORT == _ON) && (_D1_DP_EXIST == _ON))
                        case _SCALER_WD_TIMER_EVENT_DP_RX1_HDCP2_SKE:

                            ScalerDpRx1Hdcp2SkeProc_WDINT();

                            break;
#endif

#if((_DP_HDCP_2_2_SUPPORT == _ON) && (_D0_DP_EXIST == _ON))
                        case _SCALER_WD_TIMER_EVENT_DP_RX0_HDCP2_H_PRIME:

                            ScalerDpRx0Hdcp2HPrimeProc_WDINT();

                            break;
#endif
#if((_DP_HDCP_2_2_SUPPORT == _ON) && (_D1_DP_EXIST == _ON))
                        case _SCALER_WD_TIMER_EVENT_DP_RX1_HDCP2_H_PRIME:

                            ScalerDpRx1Hdcp2HPrimeProc_WDINT();
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX1_HDCP2_RSA_CAL_START:

                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                if(ScalerGetBit_EXINT(P63_10_HDCP_RSA_CTRL0, _BIT7) == 0x00) // RSA = Idle
                                {
                                    ScalerTMDSRx1Hdcp2RxRsaCalculate_WDINT();

                                    // Active Timer Event to Check RSA Done
                                    ucActiveWDID = _SCALER_WD_TIMER_EVENT_TMDS_RX1_HDCP2_CHECK_RSA_CAL_DONE;
                                    ucActiveWDTime = 10;
                                }
                                else
                                {
                                    // Reactive WD Timer to Start RSA Cal
                                    ucActiveWDID = _SCALER_WD_TIMER_EVENT_TMDS_RX1_HDCP2_RSA_CAL_START;
                                    ucActiveWDTime = 10;
                                }
                            }
                            break;

                        case _SCALER_WD_TIMER_EVENT_TMDS_RX1_HDCP2_CHECK_RSA_CAL_DONE:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                if(ScalerGetBit_EXINT(P63_10_HDCP_RSA_CTRL0, _BIT2) == _BIT2) // RSA done
                                {
                                    ...
                                    if(ScalerHdcp2RxRsaOaepCalculate_WDINT(g_pucTmdsRx1Hdcp2Km) == _TRUE)
                                    {
                                        ScalerTMDSRx1Hdcp2HPrime_WDINT();
                                    }
                                }
                                else
                                {
                        ...
                        case _SCALER_WD_TIMER_EVENT_RX1_HDCP2_SET_REAUTH:

                            if(GET_TMDS_RX1_HDCP2_AUTHENTICATION_DONE() == _TRUE)
                            {
                                ScalerTMDSRx1Hdcp2SetReAuth_WDINT();
                            }
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX2_HDCP2_RSA_CAL_START:

                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                if(ScalerGetBit_EXINT(P63_10_HDCP_RSA_CTRL0, _BIT7) == 0x00) // RSA = Idle
                                {
                                    ScalerTMDSRx2Hdcp2RxRsaCalculate_WDINT();

                                    // Active Timer Event to Check RSA Done
                                    ucActiveWDID = _SCALER_WD_TIMER_EVENT_TMDS_RX2_HDCP2_CHECK_RSA_CAL_DONE;
                                    ucActiveWDTime = 10;
                                }
                                else
                                {
                                    // Reactive WD Timer to Start RSA Cal
                                    ucActiveWDID = _SCALER_WD_TIMER_EVENT_TMDS_RX2_HDCP2_RSA_CAL_START;
                                    ucActiveWDTime = 10;
                                }
                            }
                            break;

                        case _SCALER_WD_TIMER_EVENT_TMDS_RX2_HDCP2_CHECK_RSA_CAL_DONE:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                if(ScalerGetBit_EXINT(P63_10_HDCP_RSA_CTRL0, _BIT2) == _BIT2) // RSA done
                                {
                                    ...
                                    if(ScalerHdcp2RxRsaOaepCalculate_WDINT(g_pucTmdsRx2Hdcp2Km) == _TRUE)
                                    {
                                        ScalerTMDSRx2Hdcp2HPrime_WDINT();
                                    }
                                }
                                else
                                {
                        ...
                        case _SCALER_WD_TIMER_EVENT_RX2_HDCP2_SET_REAUTH:

                            if(GET_TMDS_RX2_HDCP2_AUTHENTICATION_DONE() == _TRUE)
                            {
                                ScalerTMDSRx2Hdcp2SetReAuth_WDINT();
                            }
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX3_HDCP2_RSA_CAL_START:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                if(ScalerGetBit_EXINT(P63_10_HDCP_RSA_CTRL0, _BIT7) == 0x00) // RSA = Idle
                                {
                                    ScalerTMDSRx3Hdcp2RxRsaCalculate_WDINT();

                                    // Active Timer Event to Check RSA Done
                                    ucActiveWDID = _SCALER_WD_TIMER_EVENT_TMDS_RX3_HDCP2_CHECK_RSA_CAL_DONE;
                                    ucActiveWDTime = 10;
                                }
                                else
                                {
                                    // Reactive WD Timer to Start RSA Cal
                                    ucActiveWDID = _SCALER_WD_TIMER_EVENT_TMDS_RX3_HDCP2_RSA_CAL_START;
                                    ucActiveWDTime = 10;
                                }
                            }
                            break;
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX3_HDCP2_CHECK_RSA_CAL_DONE:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                if(ScalerGetBit_EXINT(P63_10_HDCP_RSA_CTRL0, _BIT2) == _BIT2) // RSA done
                                {
                                    ...
                                    if(ScalerHdcp2RxRsaOaepCalculate_WDINT(g_pucTmdsRx3Hdcp2Km) == _TRUE)
                                    {
                                        ScalerTMDSRx3Hdcp2HPrime_WDINT();
                                    }
                                }
                                else
                                {
                        ...
                        case _SCALER_WD_TIMER_EVENT_RX3_HDCP2_SET_REAUTH:
                            ...
                            {
                                ScalerTMDSRx3Hdcp2SetReAuth_WDINT();
                            }
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX4_HDCP2_RSA_CAL_START:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                if(ScalerGetBit_EXINT(P63_10_HDCP_RSA_CTRL0, _BIT7) == 0x00) // RSA = Idle
                                {
                                    ScalerTMDSRx4Hdcp2RxRsaCalculate_WDINT();

                                    // Active Timer Event to Check RSA Done
                                    ucActiveWDID = _SCALER_WD_TIMER_EVENT_TMDS_RX4_HDCP2_CHECK_RSA_CAL_DONE;
                                    ucActiveWDTime = 10;
                                }
                                else
                                {
                                    // Reactive WD Timer to Start RSA Cal
                                    ucActiveWDID = _SCALER_WD_TIMER_EVENT_TMDS_RX4_HDCP2_RSA_CAL_START;
                                    ucActiveWDTime = 10;
                                }
                            }
                            break;
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX4_HDCP2_CHECK_RSA_CAL_DONE:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                if(ScalerGetBit_EXINT(P63_10_HDCP_RSA_CTRL0, _BIT2) == _BIT2) // RSA done
                                {
                                    ...
                                    if(ScalerHdcp2RxRsaOaepCalculate_WDINT(g_pucTmdsRx4Hdcp2Km) == _TRUE)
                                    {
                                        ScalerTMDSRx4Hdcp2HPrime_WDINT();
                                    }
                                }
                                else
                                {
                        ...
                        case _SCALER_WD_TIMER_EVENT_RX4_HDCP2_SET_REAUTH:
                            ...
                            {
                                ScalerTMDSRx4Hdcp2SetReAuth_WDINT();
                            }
                            break;
#endif

#if((_D5_INPUT_PORT_TYPE == _D5_HDMI_PORT) || (_D5_INPUT_PORT_TYPE == _D5_MHL_PORT))
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX5_HDCP2_RSA_CAL_START:

                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                if(ScalerGetBit_EXINT(P63_10_HDCP_RSA_CTRL0, _BIT7) == 0x00) // RSA = Idle
                                {
                                    ScalerTMDSRx5Hdcp2RxRsaCalculate_WDINT();

                                    // Active Timer Event to Check RSA Done
                                    ucActiveWDID = _SCALER_WD_TIMER_EVENT_TMDS_RX5_HDCP2_CHECK_RSA_CAL_DONE;
                                    ucActiveWDTime = 10;
                                }
                                else
                                {
                                    // Reactive WD Timer to Start RSA Cal
                                    ucActiveWDID = _SCALER_WD_TIMER_EVENT_TMDS_RX5_HDCP2_RSA_CAL_START;
                                    ucActiveWDTime = 10;
                                }
                            }
                            break;

                        case _SCALER_WD_TIMER_EVENT_TMDS_RX5_HDCP2_CHECK_RSA_CAL_DONE:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                if(ScalerGetBit_EXINT(P63_10_HDCP_RSA_CTRL0, _BIT2) == _BIT2) // RSA done
                                {
                                    ...
                                    if(ScalerHdcp2RxRsaOaepCalculate_WDINT(g_pucTmdsRx5Hdcp2Km) == _TRUE)
                                    {
                                        ScalerTMDSRx5Hdcp2HPrime_WDINT();
                                    }
                                }
                                else
                                {
                        ...
                        case _SCALER_WD_TIMER_EVENT_RX5_HDCP2_SET_REAUTH:

                            if(GET_TMDS_RX5_HDCP2_AUTHENTICATION_DONE() == _TRUE)
                            {
                                ScalerTMDSRx5Hdcp2SetReAuth_WDINT();
                            }
                            break;
#endif
        ...
        ScalerDpRxDpcdPortAccessBackupRestore_WDINT();
#endif
...
void ScalerTimerSetTimerCount(EnumScalerTimerOperationMode enumOperationMode)
{
    ...
    switch(enumOperationMode)
    {
...
#if((_INSTANT_TIMER_EVENT_0 == _ON) || (_INSTANT_TIMER_EVENT_1 == _ON))
            if(g_enumTimerMode != _TIMER_OPERATION_INITIAL_MODE)
            {
                g_enumTimerMode = _TIMER_OPERATION_INITIAL_MODE;

#if(_INSTANT_TIMER_EVENT_0 == _ON)
                if(bTR0Info == _ON)
                {
                    g_usTimerBackupCount0 = 0xFFFF - ((WORD)((_TIMER01_TEMP_COUNT_XTAL * g_usTimerPreviousCount0) / 1000));
                }
#endif
                ...
                if(bTR1Info == _ON)
                {
                    g_usTimerBackupCount1 = 0xFFFF - ((WORD)((_TIMER01_TEMP_COUNT_XTAL * g_usTimerPreviousCount1) / 1000));
                }
#endif
            }
#endif
...
#if(_UART_SUPPORT == _ON)
#if(_UART_LOW_BAUD_RATE_SUPPORT == _ON)
            g_ucTimerCountLByte1_Uart = LOBYTE(_TIMER1_UART_COUNT_IN_WORD);
            g_ucTimerCountHByte1_Uart = HIBYTE(_TIMER1_UART_COUNT_IN_WORD);
#else
...
#if(_UART_SUPPORT == _ON)
#if(_UART_LOW_BAUD_RATE_SUPPORT == _ON)
            g_ucTimerCountLByte1_Uart = LOBYTE(_TIMER1_UART_COUNT_WORD);
            g_ucTimerCountHByte1_Uart = HIBYTE(_TIMER1_UART_COUNT_WORD);
#else
...
#if(_UART_SUPPORT == _ON)
#if(_UART_LOW_BAUD_RATE_SUPPORT == _ON)
                g_ucTimerCountLByte1_Uart = LOBYTE(_TIMER1_UART_COUNT_PS_FAST_WORD);
                g_ucTimerCountHByte1_Uart = HIBYTE(_TIMER1_UART_COUNT_PS_FAST_WORD);
#else
...
#if(_UART_SUPPORT == _ON)
#if(_UART_LOW_BAUD_RATE_SUPPORT == _ON)
                g_ucTimerCountLByte1_Uart = LOBYTE(_TIMER1_UART_COUNT_PS_WORD);
                g_ucTimerCountHByte1_Uart = HIBYTE(_TIMER1_UART_COUNT_PS_WORD);
#else
        ...
        case _TIMER_OPERATION_POWER_IDLE_MODE:
...
#if(_SYS_PS_TIMER_PRECISION_SUPPPORT == _OFF)
            pucTimercounter[2] = _TIMER2_COUNT_PS_LBYTE;
            pucTimercounter[3] = _TIMER2_COUNT_PS_HBYTE;
#else
            pucTimercounter[2] = _TIMER2_COUNT_IN_LBYTE;
            ...
            {
#if(_UART_LOW_BAUD_RATE_SUPPORT == _ON)
                g_ucTimerCountLByte1_Uart = LOBYTE(_TIMER1_UART_COUNT_IDLE_WORD);
                g_ucTimerCountHByte1_Uart = HIBYTE(_TIMER1_UART_COUNT_IDLE_WORD);
#else
                pucTimercounter[4] = _TIMER1_UART_COUNT_IDLE_BYTE;
#endif
            }
#endif
            break;
...
#if(_UART_SUPPORT == _ON)
#if(_UART_LOW_BAUD_RATE_SUPPORT == _ON)
            g_ucTimerCountLByte1_Uart = LOBYTE(_TIMER1_UART_COUNT_OSD_WORD);
            g_ucTimerCountHByte1_Uart = HIBYTE(_TIMER1_UART_COUNT_OSD_WORD);
#else
...
#if(_INSTANT_TIMER_EVENT_0 == _ON)
    if((bTR0Info == _ON) && (enumOperationMode != _TIMER_OPERATION_POWER_IDLE_MODE))
    {
...
#if(_INSTANT_TIMER_EVENT_1 == _ON)
    if((bTR1Info == _ON) && (enumOperationMode != _TIMER_OPERATION_POWER_IDLE_MODE))
    {
        // Do not load Timer Counter if Calculated Timer Counter is the same as Previous Timer Counter
...
void ScalerTimerAddTimerCounter(void)
{
...
#endif
    {
        ...
        else
        {
            usOffset = (((WORD)(_TIMER2_COUNT_IDLE_HBYTE << 8) & 0xFF00) | (_TIMER2_COUNT_IDLE_LBYTE));
            usOffset = (((WORD)(TH2 << 8) & 0xFF00) | (TL2)) - usOffset;
            usOffset = usOffset / _TIMER_COUNT_TEMP_IDLE;
        }
    }
...
void ScalerTimerEventProc(EnumScalerTimerEventID enumEventID)
{
    switch(enumEventID)
    {
        ...
        case _SCALER_TIMER_EVENT_TMDS_Z0_POWER_SAVING_TOGGLE_LOW_DUTY:
            ...
            ScalerTMDSClkLaneZ0HighProc();
            break;

        case _SCALER_TIMER_EVENT_TMDS_Z0_POWER_SAVING_TOGGLE_HIGH_DUTY:

            ScalerTMDSClkLaneZ0LowProc();
            break;
#endif

#if(_HDMI_2_0_SUPPORT == _ON)
        case _SCALER_TIMER_EVENT_RX0_HDMI2_SCRAMBLE_DETECT_TIMEOUT:
...
#if(_D5_HDMI_2_0_SUPPORT == _ON)
        case _SCALER_TIMER_EVENT_RX5_HDMI2_SCRAMBLE_DETECT_TIMEOUT:
#endif
            ScalerTMDSHdmiScrambleDetectTimeoutTimerEvent(enumEventID);
            break;
#endif
...
#if(_D1_HDMI_2_0_SUPPORT == _ON)
        case _SCALER_TIMER_EVENT_D1_TMDS_HDMI_HPD_5VPIN_CHECK:
            ScalerTMDSHdmiHpd5vPinCheckProc(_D1_INPUT_PORT);
            break;
#endif

#if(_D2_HDMI_2_0_SUPPORT == _ON)
        case _SCALER_TIMER_EVENT_D2_TMDS_HDMI_HPD_5VPIN_CHECK:
            ScalerTMDSHdmiHpd5vPinCheckProc(_D2_INPUT_PORT);
            break;
#endif

#if(_D3_HDMI_2_0_SUPPORT == _ON)
        case _SCALER_TIMER_EVENT_D3_TMDS_HDMI_HPD_5VPIN_CHECK:
            ScalerTMDSHdmiHpd5vPinCheckProc(_D3_INPUT_PORT);
            break;
#endif

#if(_D4_HDMI_2_0_SUPPORT == _ON)
        case _SCALER_TIMER_EVENT_D4_TMDS_HDMI_HPD_5VPIN_CHECK:
            ScalerTMDSHdmiHpd5vPinCheckProc(_D4_INPUT_PORT);
            break;
#endif

#if(_D5_HDMI_2_0_SUPPORT == _ON)
        case _SCALER_TIMER_EVENT_D5_TMDS_HDMI_HPD_5VPIN_CHECK:
            ScalerTMDSHdmiHpd5vPinCheckProc(_D5_INPUT_PORT);
            break;
#endif
...
#endif
#if(_D1_HDMI_SUPPORT == _ON)
        case _SCALER_TIMER_EVENT_AUDIO_D1_FW_TRACKING_PREPARING:
#endif
#if(_D2_HDMI_SUPPORT == _ON)
        ...
        ScalerAudioFwTrackingEventSet(enumEventID);
        break;
...
#endif
#if(_D1_HDMI_SUPPORT == _ON)
        case _SCALER_TIMER_EVENT_AUDIO_D1_FW_TRACKING_TIMEOUT:
#endif
#if(_D2_HDMI_SUPPORT == _ON)
        ...
        ScalerAudioTimeoutEventSet(enumEventID);
        break;
#endif
        ...
        case _SCALER_TIMER_EVENT_DP_RX0_SOURCE_WRITE_POWER_UP_TIMEOUT:
            ...
            if(GET_DP_RX0_SOURCE_WRITE_POWER_UP() == _DP_SOURCE_WRITE_POWER_UP_TIMER_ACTIVE)
            {
        ...
        case _SCALER_TIMER_EVENT_DP_RX1_SOURCE_WRITE_POWER_UP_TIMEOUT:
            ...
            if(GET_DP_RX1_SOURCE_WRITE_POWER_UP() == _DP_SOURCE_WRITE_POWER_UP_TIMER_ACTIVE)
            {
        ...
        case _SCALER_TIMER_EVENT_PD_RX0_SNK_HARD_RST_TIMEOUT:
        ...
        case _SCALER_TIMER_EVENT_PD_RX0_SRC_EPR_KEEP_ALIVE_TIMEOUT:
        ...
        case _SCALER_TIMER_EVENT_PMIC_POLLING_OCP:
            ...
            ScalerTypeCPmicRx0TimerEventProc(enumEventID);
        ...
        case _SCALER_TIMER_EVENT_SMBUS_BLOCK_READ_WRITE:
...
#if(((_DDCCI_CODE_REDUCTION == _OFF) && (_DEBUG_MESSAGE_SUPPORT == _OFF) && (_DDCCI_AUTO_SWITCH_SUPPORT == _ON)) || (_SMBUS_BLOCK_READ_WRITE_COMMAND_SUPPORT == _ON))
//--------------------------------------------------
// Description  : Cancel a Timer Event in Int1
// Input Value  : enumEventID --> Event which we want to cancel
// Output Value : None
//--------------------------------------------------
void ScalerTimerCancelTimerEvent_EXINT1(EnumScalerTimerEventID enumEventID) using 2
{
    // Search for Existing Event with the same Event ID
    for(pData_EXINT[0] = 0; pData_EXINT[0] < _TIMER_EVENT_COUNT; pData_EXINT[0]++)
    {
