...
extern void ScalerTMDSRx1SwitchHdcpSlaveAddr(void);
extern void ScalerTMDSRx1BeforeHotPlugEventProc(bit bDisableZ0);
extern void ScalerTMDSRx1AfterHotPlugEventProc(bit bRestoreZ0);
