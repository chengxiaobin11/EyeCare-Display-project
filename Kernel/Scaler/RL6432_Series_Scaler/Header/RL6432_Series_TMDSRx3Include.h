...
#define GET_TMDS_RX3_AC_ON_HPD_TOGGLE_EVENT()           (g_stTMDSRx3CtrlInfo.b1HdmiAcOnHpdToggleEvent)
#define SET_TMDS_RX3_AC_ON_HPD_TOGGLE_EVENT()           (g_stTMDSRx3CtrlInfo.b1HdmiAcOnHpdToggleEvent = _TRUE)
#define CLR_TMDS_RX3_AC_ON_HPD_TOGGLE_EVENT()           (g_stTMDSRx3CtrlInfo.b1HdmiAcOnHpdToggleEvent = _FALSE)
#endif
...
extern void ScalerTMDSRx3SwitchHdcpSlaveAddr(void);
extern void ScalerTMDSRx3BeforeHotPlugEventProc(bit bDisableZ0);
extern void ScalerTMDSRx3AfterHotPlugEventProc(bit bRestoreZ0);
