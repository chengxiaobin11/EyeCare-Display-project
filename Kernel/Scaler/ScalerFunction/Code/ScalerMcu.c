...
BYTE ScalerMcuGetDdcChannelFromInputPort(BYTE ucInputPort);
#endif
...
void ScalerMcuPwmControl(EnumPowerStatus enumPowStatus)
{
    BYTE ucTempPwmOut = 0x00;
    BYTE ucTempPwmClock = 0x00;

    if(enumPowStatus == _POWER_STATUS_NORMAL)
    {
        // PWM output clock stop disable
        ucTempPwmClock = MCU_FFF2_PWM_I2C_CLOCK_STOP;
        ucTempPwmClock |= (_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0);
        ucTempPwmClock &= ~(((BYTE)_PWM5_EN << 5) | ((BYTE)_PWM4_EN << 4) | ((BYTE)_PWM3_EN << 3) | ((BYTE)_PWM2_EN << 2) | ((BYTE)_PWM1_EN << 1) | ((BYTE)_PWM0_EN));
        MCU_FFF2_PWM_I2C_CLOCK_STOP = ucTempPwmClock;

        // PWM Output Enable
        ucTempPwmOut = MCU_FF48_PWM_EN;
        ucTempPwmOut &= ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0);
        ucTempPwmOut |= (((BYTE)_PWM5_EN << 5) | ((BYTE)_PWM4_EN << 4) | ((BYTE)_PWM3_EN << 3) | ((BYTE)_PWM2_EN << 2) | ((BYTE)_PWM1_EN << 1) | ((BYTE)_PWM0_EN));
        MCU_FF48_PWM_EN = ucTempPwmOut;
    ...
    else if(enumPowStatus == _POWER_STATUS_SAVING)
    {
        ...
        ucTempPwmOut = MCU_FF48_PWM_EN;
        ucTempPwmOut &= ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0);
        ucTempPwmOut |= (((BYTE)_PWM5_PSAV_EN << 5) | ((BYTE)_PWM4_PSAV_EN << 4) | ((BYTE)_PWM3_PSAV_EN << 3) | ((BYTE)_PWM2_PSAV_EN << 2) | ((BYTE)_PWM1_PSAV_EN << 1) | ((BYTE)_PWM0_PSAV_EN));
        MCU_FF48_PWM_EN = ucTempPwmOut;

        // PWM output clock stop disable
        ucTempPwmClock = MCU_FFF2_PWM_I2C_CLOCK_STOP;
        ucTempPwmClock |= (_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0);
        ucTempPwmClock &= ~(((BYTE)_PWM5_PSAV_EN << 5) | ((BYTE)_PWM4_PSAV_EN << 4) | ((BYTE)_PWM3_PSAV_EN << 3) |
    ...
    else if(enumPowStatus == _POWER_STATUS_OFF)
    {
        ...
        ucTempPwmOut = MCU_FF48_PWM_EN;
        ucTempPwmOut &= ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0);
        ucTempPwmOut |= (((BYTE)_PWM5_PDOW_EN << 5) | ((BYTE)_PWM4_PDOW_EN << 4) | ((BYTE)_PWM3_PDOW_EN << 3) | ((BYTE)_PWM2_PDOW_EN << 2) | ((BYTE)_PWM1_PDOW_EN << 1) | ((BYTE)_PWM0_PDOW_EN));
        MCU_FF48_PWM_EN = ucTempPwmOut;

        // PWM Output Clock Stop Enable when Power Down(or enable by define)
        ucTempPwmClock = MCU_FFF2_PWM_I2C_CLOCK_STOP;
        ucTempPwmClock |= (_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0);
        ucTempPwmClock &= ~(((BYTE)_PWM5_PDOW_EN << 5) | ((BYTE)_PWM4_PDOW_EN << 4) | ((BYTE)_PWM3_PDOW_EN << 3) |
