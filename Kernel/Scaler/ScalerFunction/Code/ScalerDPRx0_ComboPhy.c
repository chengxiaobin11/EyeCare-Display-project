        ...
        else // Normal Cable Mode
        {
            switch(GET_DP_EMBEDDED_SWITCH_SELECT())
            {
                ...
                case _D2_INPUT_PORT:
                    ...
                    SET_DP_RX0_PCB_LANE0_MAPPING(_D2_DP_PCB_LANE0_MAPPING);
                    SET_DP_RX0_PCB_LANE1_MAPPING(_D2_DP_PCB_LANE1_MAPPING);
                    SET_DP_RX0_PCB_LANE2_MAPPING(_D2_DP_PCB_LANE2_MAPPING);
                    SET_DP_RX0_PCB_LANE3_MAPPING(_D2_DP_PCB_LANE3_MAPPING);
                    SET_DP_RX0_PCB_LANE0_PN_SWAP(_D2_DP_PCB_LANE0_PN_SWAP);
                    SET_DP_RX0_PCB_LANE1_PN_SWAP(_D2_DP_PCB_LANE1_PN_SWAP);
                    SET_DP_RX0_PCB_LANE2_PN_SWAP(_D2_DP_PCB_LANE2_PN_SWAP);
                    SET_DP_RX0_PCB_LANE3_PN_SWAP(_D2_DP_PCB_LANE3_PN_SWAP);
        ...
        else // Normal Cable Mode
        {
            switch(GET_DP_EMBEDDED_SWITCH_SELECT())
            {
                ...
                case _D2_INPUT_PORT:
                    ...
                    SET_DP_RX0_PCB_LANE0_MAPPING(_D2_DP_PCB_LANE3_MAPPING);
                    SET_DP_RX0_PCB_LANE1_MAPPING(_D2_DP_PCB_LANE2_MAPPING);
                    SET_DP_RX0_PCB_LANE2_MAPPING(_D2_DP_PCB_LANE1_MAPPING);
                    SET_DP_RX0_PCB_LANE3_MAPPING(_D2_DP_PCB_LANE0_MAPPING);
                    SET_DP_RX0_PCB_LANE0_PN_SWAP(_D2_DP_PCB_LANE0_PN_SWAP);
                    SET_DP_RX0_PCB_LANE1_PN_SWAP(_D2_DP_PCB_LANE1_PN_SWAP);
                    SET_DP_RX0_PCB_LANE2_PN_SWAP(_D2_DP_PCB_LANE2_PN_SWAP);
                    SET_DP_RX0_PCB_LANE3_PN_SWAP(_D2_DP_PCB_LANE3_PN_SWAP);
