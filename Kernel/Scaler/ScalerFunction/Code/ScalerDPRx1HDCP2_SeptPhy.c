...
void ScalerDpRx1Hdcp2HPrimeProc_WDINT(void);
...
void ScalerDpRx1Hdcp2SetDpcdReadValue_WDINT(BYTE ucRSAType, BYTE *pucReadArray, WORD usLength);
void ScalerDpRx1Hdcp2CpIRQ_WDINT(EnumDpRxBStatusType enumBStatusType);
void ScalerDpRx1Hdcp2HpdIrqAssert_WDINT(void);
#endif
...
void ScalerDpRx1Hdcp2Handler(void)
{
    ...
    if(GET_DP_RX1_HDCP2_AKE_INIT_RECEIVED() == _TRUE)
    {
        ...
        ScalerDpRx1Hdcp2ClearDpcdRepeaterInfo();
#endif
...
void ScalerDpRx1Hdcp2Handler_EXINT0(void) using 1
{
    ...
    if(ScalerGetBit_EXINT(PBA_DC_AUX_IRQ_STATUS, _BIT7) == _BIT7)
    {
        ...
        g_bDpRx1AutoInc = (ScalerGetBit_EXINT(PBA_C0_DPCD_CTRL, _BIT0) == _BIT0);
        ...
        if(ucMessageId == _HDCP_2_2_NONE)
        {
            ...
            ScalerSetBit_EXINT(PBA_C0_DPCD_CTRL, ~_BIT0, g_bDpRx1AutoInc);
        ...
        switch(ucMessageId)
        {
            case _HDCP_2_2_AKE_INIT:
                ...
                ScalerTimerWDCancelTimerEvent_EXINT0(_SCALER_WD_TIMER_EVENT_DP_RX1_HDCP2_H_PRIME);
            ...
            case _HDCP_2_2_AKE_STORED_KM:
                ...
                ScalerTimerWDActivateTimerEvent_EXINT0(4, _SCALER_WD_TIMER_EVENT_DP_RX1_HDCP2_H_PRIME);
...
void ScalerDpRx1Hdcp2ResetProc(void)
{
    ...
    ScalerDpRx1Hdcp2ClearDpcdReadValue(_HDCP_2_2_RX_V_PRIME, 190);
#endif
}
//--------------------------------------------------
...
void ScalerDpRx1Hdcp2ResetProc_EXINT0(void) using 1
{
    ...
    CLR_DP_RX1_HDCP2_SKE_SEND_EKS_RECEIVED();
    CLR_DP_RX1_HDCP2_AUTHENTICATION_ACTIVE();
    CLR_DP_RX1_HDCP2_CLEAR_DPCD_READ_VALUE_DONE();
...
// Output Value : None
//--------------------------------------------------
void ScalerDpRx1Hdcp2HPrimeProc_WDINT(void) using 3
{
    BYTE ucBackUp = ScalerGetByte_EXINT(PBA_D0_AUX_MODE_SET);

    SET_DP_RX1_AUX_MANUAL_MODE_EXINT();

    // Calculate H'
    if(ScalerHdcp2HPrimeCalculate_WDINT(g_pucDpRx1Hdcp2dKey0, g_pucDpRx1Hdcp2dKey1, g_pucDpRx1Hdcp2Rtx, g_pucDpRx1Hdcp2TxCaps, g_pucDPRx1Caps) == _TRUE)
    {
        for(pData_EXINT[0] = 0; pData_EXINT[0] < 32; pData_EXINT[0]++)
        {
            g_pucHdcp2Sha256[pData_EXINT[0]] = ScalerGetByte_EXINT(P63_35_HDCP_SHA_0 + pData_EXINT[0]);
        ...
        ScalerDpRx1Hdcp2SetDpcdReadValue_WDINT(_HDCP_2_2_RX_H_PRIME, g_pucHdcp2Sha256, 32);
    }

    ScalerDpRx1Hdcp2CpIRQ_WDINT(_DP_HDCP2_H_PRIME_AVAILABLE);
...
// Output Value : None
//--------------------------------------------------
void ScalerDpRx1Hdcp2SetDpcdReadValue_WDINT(BYTE ucRSAType, BYTE *pucReadArray, WORD usLength) using 3
{
    switch(ucRSAType)
    {
        case _HDCP_2_2_RRX:
    ...
    for(pData_EXINT[0] = 0; pData_EXINT[0] < usLength; pData_EXINT[0]++)
    {
        ScalerDpRx1SetDpcdValue_WDINT(pData_EXINT[1], pData_EXINT[2], pData_EXINT[3], pucReadArray[pData_EXINT[0]]);
        PDATA_WORD_EXINT(1) = PDATA_WORD_EXINT(1) + 1;
    }
}
...
// Output Value : None
//--------------------------------------------------
void ScalerDpRx1Hdcp2CpIRQ_WDINT(EnumDpRxBStatusType enumBStatusType) using 3
{
    BYTE ucBackUp = 0;
    ...
    switch(enumBStatusType)
    {
        ...
        case _DP_HDCP2_PARING_AVAILABLE:
            ...
            ScalerDpRx1SetDpcdValue_WDINT(0x06, 0x94, 0x93, (ScalerDpRx1GetDpcdInfo_WDINT(0x06, 0x94, 0x93) | (enumBStatusType >> 3)));
    ...
    pData_EXINT[0] = (ScalerDpRx1GetDpcdInfo_WDINT(0x00, 0x02, 0x01) | _BIT2);

    // SET AUX AUTO MODE
    SET_DP_RX1_AUX_AUTO_MODE_EXINT();

    ScalerDpRx1SetDpcdValue_WDINT(0x00, 0x02, 0x01, pData_EXINT[0]);
    ...
    ScalerDpRx1Hdcp2HpdIrqAssert_WDINT();
}
...
// Output Value : None
//--------------------------------------------------
void ScalerDpRx1Hdcp2HpdIrqAssert_WDINT(void) using 3
{
