...
bit g_bDpHdcpRx1HdcpCpirqFlag = _FALSE;
StructDpLanesMapping g_stDpRx1LanesMapping;

volatile BYTE g_ucDpAuxRx1DpcdAddress;
volatile BYTE g_ucDpAuxRx1DpcdLength;
...
BYTE g_ucDpRx1Tp1PermitSwingLevel0;
...
void ScalerDpRx1DisconnectReset(void);
...
void ScalerDpRx1ActiveLinkStatusIRQ(void);
...
void ScalerDpRx1DpcdGroupReset(BYTE ucDpcdAccessPortH, BYTE ucDpcdAccessPortM, BYTE ucDpcdAccessPortL, WORD usLen);
void ScalerDpRx1DpcdLinkConfigReset(void);
void ScalerDpRx1DpcdSourceOUIReset(void);
void ScalerDpRx1SetSinkDeviceSpecificField(EnumDpVersionType enumDpVersion);

void ScalerDpRx1SetBranchDeviceSpecificField(EnumDpVersionType enumDpVersion);
void ScalerDpRx1ClearBranchDeviceSpecificField(void);
...
#if(_DP_LINK_RATE_CHANGE_WO_LT_SUPPORT == _ON)
...
void ScalerDpRx1AdjustVsyncDelay(void)
{
    ...
    // Polling Vertical BS
    if(ScalerDpRx1PollingFlagLinkCheck(50, PB9_01_DP_VBID, _BIT0, _TRUE) == _FALSE)
    {
        return;
    }
...
void ScalerDpRx1ScrambleSetting(void)
{
    ...
    if((ScalerDpRx1GetDpcdBitInfo(0x00, 0x01, 0x01, _BIT7) == _BIT7) != (ScalerGetBit(PB0_01_PHY_DIG_RESET_CTRL, _BIT2) == _BIT2))
    {
    ...
    if((ScalerDpRx1GetDpcdBitInfo(0x00, 0x01, 0x02, _BIT5) == _BIT5) != (ScalerGetBit(PB0_07_SCRAMBLE_CTRL, _BIT5) == _BIT5))
    {
...
bit ScalerDpRx1LaneValidCheck(void)
{
    ...
    switch(ScalerDpRx1GetDpcdInfo(0x00, 0x01, 0x01) & 0x1F)
    {
        case _DP_ONE_LANE:
            ...
            if(((GET_DP_RX1_PCB_LANE0_MAPPING() == _DP_SCALER_LANE0) && (ScalerGetBit(PB0_00_HD_DP_SEL, _BIT7) == 0x00)) ||
               ((GET_DP_RX1_PCB_LANE0_MAPPING() == _DP_SCALER_LANE1) && (ScalerGetBit(PB0_00_HD_DP_SEL, _BIT6) == 0x00)) ||
               ((GET_DP_RX1_PCB_LANE0_MAPPING() == _DP_SCALER_LANE2) && (ScalerGetBit(PB0_00_HD_DP_SEL, _BIT5) == 0x00)) ||
               ((GET_DP_RX1_PCB_LANE0_MAPPING() == _DP_SCALER_LANE3) && (ScalerGetBit(PB0_00_HD_DP_SEL, _BIT4) == 0x00)))
            {
                return _FALSE;
            }
...
void ScalerDpRx1CrcCalculate(void)
{
    if(GET_DP_RX1_CRC_CALCULATE() == _TRUE)
    {
        ...
        {
            ScalerSetBit(PB8_70_DP_CRC_CTRL, ~_BIT4, _BIT4);
        }
        else
        {
            ScalerSetBit(PB8_70_DP_CRC_CTRL, ~_BIT4, 0x00);
        }

        // Start CRC Calculation
        ScalerSetBit(PB8_70_DP_CRC_CTRL, ~_BIT7, _BIT7);

        if((ScalerTimerPollingFlagProc(_DP_MEASURE_POLLING_TIMEOUT, PB8_70_DP_CRC_CTRL, _BIT6, _TRUE) && (ScalerDpRx1FifoCheck(_DP_FIFO_POLLING_CHECK))) == _TRUE)
        {
...
EnumDpHotPlugTime ScalerDpRx1BeforeHpdToggleProc(EnumDpHotPlugAssertType enumHpdType)
{
    ...
    if(enumHpdType == _DP_HPD_ASSERTED)
    {
        ...
        {
            if(ScalerSyncDpRxGetHotPlugPinDetect(_D1_INPUT_PORT) == _HIGH)
            {
                return _DP_HPD_TIME_NONE;
            }
        }
    ...
    ScalerTimerWDCancelTimerEvent(_SCALER_WD_TIMER_EVENT_DP_RX1_HDCP2_H_PRIME);
#endif
...
void ScalerDpRx1DisconnectReset(void)
{
    ...
    ScalerDpRx1DpcdGroupReset(0x00, 0x00, 0x30, 16);

    // Link Configuration Reset 100~106
    ScalerDpRx1DpcdLinkConfigReset();
    ...
    ScalerDpRx1SetDpcdValue(0x00, 0x01, 0x18, 0x00);

    // Hot Plug/Hot Unplug Event Notification Type Reset
    ScalerDpRx1SetDpcdValue(0x00, 0x01, 0xA1, 0x00);

    // Source OUI Reset
    ScalerDpRx1DpcdSourceOUIReset();
...
void ScalerDpRx1ActiveLinkStatusIRQ(void)
{
    ...
    if(GET_DP_RX1_HDCP_CPIRQ() == _TRUE)
    {
        CLR_DP_RX1_HDCP_CPIRQ();
...
void ScalerDpRx1AuxSet(void)
{
    if(GET_DP_AUX_DIFF_MODE() == _FALSE)
    {
        ...
        ScalerSetByte(PBA_61_AUX_1, ((_DP_RX_AUX_REPLY_SWING_LEVEL << 5) | _BIT4));
    ...
    else
    {
        ...
        ScalerSetBit(PBA_61_AUX_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), ((_DP_RX_AUX_REPLY_SWING_LEVEL << 5) | _BIT4));
...
void ScalerDpRx1ErrorCounterUpdate_EXINT0(void) using 1
{
    ...
    switch(g_ucDpRx1LaneCount)
    {
        case _DP_ONE_LANE:
            ...
            usErrorTemp = (((WORD)ScalerGetByte_EXINT(PB0_0B_BIST_PATTERN3) << 8) | (ScalerGetByte_EXINT(PB0_0C_BIST_PATTERN4)));
...
{
    BYTE ucAutoIncBackUp = ScalerGetByte_EXINT(PBA_C0_DPCD_CTRL);
...
void ScalerDpRx1DpcdGroupReset(BYTE ucDpcdAccessPortH, BYTE ucDpcdAccessPortM, BYTE ucDpcdAccessPortL, WORD usLen)
{
    BYTE ucAuxModeBackUp = 0;
    BYTE ucAutoIncBackUp = 0;

    // Release Aux
    ScalerSetBit(PBA_C0_DPCD_CTRL, ~_BIT7, 0x00);

    ucAuxModeBackUp = ScalerGetByte(PBA_D0_AUX_MODE_SET);
    ucAutoIncBackUp = ScalerGetByte(PBA_C0_DPCD_CTRL);

    if((ucAuxModeBackUp & _BIT1) == _BIT1)
    {
        SET_DP_RX1_AUX_MANUAL_MODE();
    }
    ...
    {
        // Enable Dpcd Auto Inc
        ScalerSetBit(PBA_C0_DPCD_CTRL, ~_BIT0, _BIT0);
    }

    while(usLen > 0)
    {
        // Reset Dpcd
        ScalerSetByte(PBA_C4_DPCD_DATA_PORT, 0x00);
    ...
    {
        // Disable Dpcd Auto Inc
        ScalerSetBit(PBA_C0_DPCD_CTRL, ~_BIT0, 0x00);
    }
...
{
    // Link Configuration Reset 100~106
    ScalerDpRx1DpcdGroupReset(0x00, 0x01, 0x00, 7);

    // Link Quality Reset 10B~10E
    ScalerDpRx1DpcdGroupReset(0x00, 0x01, 0x0B, 4);
}
...
{
    // Source OUI Reset
    ScalerDpRx1DpcdGroupReset(0x00, 0x03, 0x00, 12);
}
...
void ScalerDpRx1SetBranchDeviceSpecificField(EnumDpVersionType enumDpVersion)
{
    if(enumDpVersion >= _DP_VERSION_1_4)
    {
        ...
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x00, _DP_1_4_BRANCH_RTK_IEEE_OUI_L);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x01, _DP_1_4_BRANCH_RTK_IEEE_OUI_M);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x02, _DP_1_4_BRANCH_RTK_IEEE_OUI_H);

        // Branch IEEE OUI LSB For DP1.4
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x03, _DP_1_4_BRANCH_RTK_ID_STRING_0);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x04, _DP_1_4_BRANCH_RTK_ID_STRING_1);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x05, _DP_1_4_BRANCH_RTK_ID_STRING_2);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x06, _DP_1_4_BRANCH_RTK_ID_STRING_3);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x07, _DP_1_4_BRANCH_RTK_ID_STRING_4);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x08, _DP_1_4_BRANCH_RTK_ID_STRING_5);

        // Branch HW/FW Version For DP1.4
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x09, _DP_1_4_BRANCH_RTK_HW_VERSION);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x0A, _DP_1_4_BRANCH_RTK_FW_VERSION_H);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x0B, _DP_1_4_BRANCH_RTK_FW_VERSION_L);
    }
    else if(enumDpVersion >= _DP_VERSION_1_2)
    {
        // Branch IEEE OUI For DP1.2
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x00, _DP_1_2_BRANCH_RTK_IEEE_OUI_L);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x01, _DP_1_2_BRANCH_RTK_IEEE_OUI_M);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x02, _DP_1_2_BRANCH_RTK_IEEE_OUI_H);

        // Branch IEEE OUI LSB For DP1.2
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x03, _DP_1_2_BRANCH_RTK_ID_STRING_0);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x04, _DP_1_2_BRANCH_RTK_ID_STRING_1);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x05, _DP_1_2_BRANCH_RTK_ID_STRING_2);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x06, _DP_1_2_BRANCH_RTK_ID_STRING_3);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x07, _DP_1_2_BRANCH_RTK_ID_STRING_4);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x08, _DP_1_2_BRANCH_RTK_ID_STRING_5);

        // Branch HW/FW Version For DP1.2
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x09, _DP_1_2_BRANCH_RTK_HW_VERSION);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x0A, _DP_1_2_BRANCH_RTK_FW_VERSION_H);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x0B, _DP_1_2_BRANCH_RTK_FW_VERSION_L);
    }
    else
    {
#if(_DP_SINK_VER11_OUI_SUPPORT == _ON)
        // Branch IEEE OUI For DP1.1
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x00, _DP_1_1_BRANCH_RTK_IEEE_OUI_L);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x01, _DP_1_1_BRANCH_RTK_IEEE_OUI_M);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x02, _DP_1_1_BRANCH_RTK_IEEE_OUI_H);
#else
        ...
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x03, _DP_1_1_BRANCH_RTK_ID_STRING_0);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x04, _DP_1_1_BRANCH_RTK_ID_STRING_1);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x05, _DP_1_1_BRANCH_RTK_ID_STRING_2);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x06, _DP_1_1_BRANCH_RTK_ID_STRING_3);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x07, _DP_1_1_BRANCH_RTK_ID_STRING_4);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x08, _DP_1_1_BRANCH_RTK_ID_STRING_5);

        // Branch HW/FW Version For DP1.1
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x09, _DP_1_1_BRANCH_RTK_HW_VERSION);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x0A, _DP_1_1_BRANCH_RTK_FW_VERSION_H);
        ScalerDpRx1SetDpcdValue(0x00, 0x05, 0x0B, _DP_1_1_BRANCH_RTK_FW_VERSION_L);
    }
}
...
void ScalerDpRx1ChangeHdcpDpcdCapability(bit bEn)
{
    if(bEn == _ENABLE)
    {
        ...
        ScalerDpRx1SetDpcdBitValue(0x06, 0x80, 0x28, ~(_BIT1 | _BIT0), (((BYTE)GET_DP_RX1_HDCP14_REPEATER_SUPPORT() << 1) | _BIT0));
#else
...
WORD ScalerDpRx1SetFREESYNCMsaForLut(WORD usDpHtotal)
{
    ...
    WORD usTempMsaHtotal = ((((WORD)ScalerGetByte(PB9_08_MSA_HTT_0)) << 8) | ((WORD)ScalerGetByte(PB9_09_MSA_HTT_1)));
...
WORD ScalerDpRx1FreesyncHPorchEnlarge(WORD usDpHtotal)
{
    ...
    WORD usFifoOffset = 0;
    WORD usTempHWidth = ((((WORD)ScalerGetByte(PB9_0C_MSA_HWD_0)) << 8) | ((WORD)ScalerGetByte(PB9_0D_MSA_HWD_1)));
    ...
    switch(enumDpMstBackup)
    {
        case _DP_MST_BACKUP_INFO:
               ...
               (GET_DP_RX1_LINK_TRAINING_STATUS() == _DP_FAKE_LINK_TRAINING_PASS))
            {
                ...
                memcpy(g_pucDpRx1MstTimeSlotBackup, (volatile BYTE xdata *)PB8_03_STHD_CTRL_2, sizeof(g_pucDpRx1MstTimeSlotBackup));

                for(enumSourceNum = _DP_ST_SOURCE1; enumSourceNum <= _DP_ST_SOURCE5; enumSourceNum++)
                {
                    g_pucDpMacRx1MstStMuxBackup[enumSourceNum] = GET_DP_RX_MST_ST_SOURCE_BACKUP(enumSourceNum);
                }
            }
        ...
        case _DP_MST_BACKUP_INFO_RESTORE:
            ...
            if(((ScalerDpRx1GetDpcdInfo(0x00, 0x00, 0x21) & _BIT0) == _BIT0) && (g_stDpRx1MiscInfo.b1DpMstEnableBackup == _TRUE))
            {
                ...
                memcpy((volatile BYTE xdata *)PB8_03_STHD_CTRL_2, g_pucDpRx1MstTimeSlotBackup, sizeof(g_pucDpRx1MstTimeSlotBackup));

                for(enumSourceNum = _DP_ST_SOURCE1; enumSourceNum <= _DP_ST_SOURCE5; enumSourceNum++)
                {
                    ScalerDpRxMstSetSourceMuxBackup(enumSourceNum, g_pucDpMacRx1MstStMuxBackup[enumSourceNum]);
                }
            }
...
bit ScalerDpRx1DeOnlyTimngCheck(DWORD ulVBs2BsCount)
{
    ...
    // Get Vactive
    ScalerRead(PB9_16_MSA_VHT_0, 2, &pData[2], _AUTOINC);
...
bit ScalerDpRx1DisplayFormatSetting(void)
{
    ...
    if(GET_FREESYNC_ENABLED() == _TRUE)
    {
        ...
        usDpHtotal = GET_DWORD_MUL_DIV(usHBs2BsCount, ulStreamClkValue, 1000000) / (ScalerDpRx1GetDpcdInfo(0x00, 0x01, 0x00) * 27 / 2);
...
#endif
    {
        ...
        {
            usDpHtotal = ((((WORD)ScalerGetByte(PB9_08_MSA_HTT_0)) << 8) | ((WORD)ScalerGetByte(PB9_09_MSA_HTT_1)));
            ...
            // Set Vtotal
            ScalerSetByte(PB8_49_MN_DPF_VTT_M, HIBYTE(usDpVtotal));
            ScalerSetByte(PB8_4A_MN_DPF_VTT_L, LOBYTE(usDpVtotal));
            ...
            DebugMessageRx1("DE_Only Mode Enabled!!", ScalerGetByte(PB8_30_DPF_CTRL_0));
        }
        else
        {
...
#endif
            {
                ...
                if((bit)ucOddFlg == _TRUE)
                {
                    ...
                    SET_DP_RX1_INTERLACE_VTOTAL_NUMBER(_ODD);
                }
                else
                {
                    SET_DP_RX1_INTERLACE_VTOTAL_NUMBER(_EVEN);
                }
            ...
            DebugMessageRx1("Full Last Line Mode Enable!!", ScalerGetByte(PB8_30_DPF_CTRL_0));
        }
    }
...
bit ScalerDpRx1HdcpMeasureCheck(void)
{
    ...
    // Get Vtotal
    ScalerRead(PB9_10_MSA_VTTE_0, 2, pData, _AUTOINC);
...
void ScalerDpRx1LinkRateChangeRebuildPhy(void)
{
    ...
    if((GET_DP_RX1_LINK_TRAINING_STATUS() == _DP_NORMAL_LINK_TRAINING_PASS) && (ScalerDpRx1LinkRateChange() == _TRUE))
    {
        ...
        case _DP_LINK_STATUS_FAIL:
            ...
            else
            {
                ...
                if((GET_DP_RX1_LINK_TRAINING_STATUS() == _DP_NORMAL_LINK_TRAINING_PASS) || (GET_DP_RX1_LINK_TRAINING_STATUS() == _DP_LINK_STATUS_FAIL))
                {
                    ...
                    ScalerDpRx1ActiveLinkStatusIRQ();
                }
...
bit ScalerDpRx1MstToSstDisplayFormatSetting(void)
{
...
#endif
    {
        if(bDeOnlyModeJudge == _TRUE)
        {
            WORD usDpHtotal = ((((WORD)ScalerGetByte(PA_10_MSA_HTT_0)) << 8) | ((WORD)ScalerGetByte(PA_11_MSA_HTT_1)));
