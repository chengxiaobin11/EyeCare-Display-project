...
#if(_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON)
#if(_PANEL_PIXEL_CLOCK_MAX_KHZ > 440000)
//#warning "_PANEL_PIXEL_CLOCK_MAX_KHZ > 440M (1 PATH)"
#endif
...
#if(_PANEL_PIXEL_CLOCK_MAX_KHZ > 300000)
#warning "_PANEL_PIXEL_CLOCK_MAX_KHZ > 300M"
#endif
#endif
...
#warning "_PANEL_PIXEL_CLOCK_MAX_KHZ > 720M (2 PATH)"
#endif
...
#if(_PANEL_DPTX_LANE_NUMBER == _PANEL_DPTX_LANE_NUMBER_8)
#if((_PANEL_DH_TOTAL_MIN - _PANEL_DH_WIDTH) < 80)
#warning "_PANEL_DH_TOTAL_MIN - _PANEL_DH_WIDTH should be at least 80"
#endif
#elif(_PANEL_DPTX_LANE_NUMBER == _PANEL_DPTX_LANE_NUMBER_4)
#if((_PANEL_DH_TOTAL_MIN - _PANEL_DH_WIDTH) < 40)
#warning "_PANEL_DH_TOTAL_MIN - _PANEL_DH_WIDTH should be at least 40"
#endif
#elif(_PANEL_DPTX_LANE_NUMBER == _PANEL_DPTX_LANE_NUMBER_2)
#if((_PANEL_DH_TOTAL_MIN - _PANEL_DH_WIDTH) < 32)
#warning "_PANEL_DH_TOTAL_MIN - _PANEL_DH_WIDTH should be at least 32"
#endif
#elif(_PANEL_DPTX_LANE_NUMBER == _PANEL_DPTX_LANE_NUMBER_1)
#if((_PANEL_DH_TOTAL_MIN - _PANEL_DH_WIDTH) < 28)
#warning "_PANEL_DH_TOTAL_MIN - _PANEL_DH_WIDTH should be at least 28"
#endif
#endif
