...
#ifdef _76PIN_PIN_21
#if((_MEMORY_SIZE_CONFIG != _EMBEDDED_MEMORY_SIZE_NONE) && (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON))
//#warning "RL6463 76PIN _IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT Only Support No Memory!!!"
#endif
#endif
#endif
...
#if((_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON) && (_DP_MST_MAC_BW_LIMITED_BY_PROJECT_TIMING_SUPPORT == _OFF))
#warning "_DP_MST_MAC_BW_LIMITED_BY_PROJECT_TIMING_SUPPORT Should Be _ON when _IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON !!!"
#endif
...
#if((_TYPE_C_POWER_SOURCE == _TYPE_C_VBUS_POWER_ONLY) && (_TYPE_C_EMB_PORT_ROLE != _TYPE_C_PORT_SNK_ONLY))
#warning "If _TYPE_C_POWER_SOURCE is _TYPE_C_VBUS_POWER_ONLY, _TYPE_C_EMB_PORT_ROLE should be _TYPE_C_PORT_SNK_ONLY!!!"
#endif

#if((_TYPE_C_POWER_SOURCE == _TYPE_C_VBUS_POWER_ONLY) && (_STARTUP_SPEED_UP_SUPPORT == _OFF))
#warning "'_STARTUP_SPEED_UP_SUPPORT' Should be '_ON' if '_TYPE_C_POWER_SOURCE' = '_TYPE_C_VBUS_POWER_ONLY'"
#endif
...
//--------------------------------------------------
#if(_SCALER_TYPE == _RL6492_SERIES)
#if((_PANEL_STYLE == _PANEL_LVDS) && (_MEMORY_TYPE_CONFIG == _MEMORY_SDRAM))
#if(_LVDS_ULTRA_HIGH_SPEED_SUPPORT == _ON)
#if(_PANEL_EXIST_MULTIPANEL == _ON)
#if(_MULTIPANEL_ULTRA_HIGH_SPEED_PIXEL_CLOCK_MAX == _MULTIPANEL_CLOCK_MAX_NONE)
#warning "_MULTIPANEL_ULTRA_HIGH_SPEED_PIXEL_CLOCK_MAX Should Not be _MULTIPANEL_CLOCK_MAX_NONE When _LVDS_ULTRA_HIGH_SPEED_SUPPORT and _PANEL_EXIST_MULTIPANEL is _ON!!!"
#endif
#endif
#endif
#endif
...
#if(_INPUTCLOCK_RANG_HDMI > 4450)
//#warning "_INPUTCLOCK_RANG_HDMI Should <= 445M !!!"
#endif

#if((_INPUTCLOCK_RANG_DP > 4300) || (_INPUTCLOCK_RANG_USBC > 4300))
//#warning "_INPUTCLOCK_RANG_DP and _INPUTCLOCK_RANG_USBC Should <= 430M !!!"
#endif
...
#if(_INPUTCLOCK_RANG_DP > 3000)
#warning "INPUTCLOCK_RANGE_DP Should <= 300M!!!"
#endif
...
#if(_PANEL_EXIST_MULTIPANEL == _ON)
#if(_MULTIPANEL_ULTRA_HIGH_SPEED_PIXEL_CLOCK_MAX == _MULTIPANEL_CLOCK_MAX_NONE)
#warning "_MULTIPANEL_ULTRA_HIGH_SPEED_PIXEL_CLOCK_MAX Should Not be _MULTIPANEL_CLOCK_MAX_NONE When _IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT is _ON!!!"
#endif
#endif
...
#ifdef _76PIN_PIN_21
#if(_INPUTCLOCK_RANG_DP <= 2250)
#warning "INPUTCLOCK_RANGE_DP Should > 225M when _IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT is _ON!!!"
#endif
...
#if(_INPUTCLOCK_RANG_HDMI > 2250)
//#warning "_INPUTCLOCK_RANG_HDMI Should <= 225M!!!"
#endif
#else
#if((_INPUTCLOCK_RANG_DP <= 2250) && (_INPUTCLOCK_RANG_HDMI <= 2250))
#warning "INPUTCLOCK_RANGE_DP or _INPUTCLOCK_RANG_HDMI Should > 225M when _IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT is _ON!!!"
