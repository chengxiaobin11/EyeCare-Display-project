...
#include "RL6851_Series_MCU_Reg_Mapping.h"
...
#define _INPUT_PORT_VALID                           ((_A0_INPUT_PORT_TYPE != _A0_NO_PORT) +\
                                                     ...
                                                     (_D12_INPUT_PORT_TYPE != _D12_NO_PORT))

//--------------------------------------------------
// Dp Valid Port Option
//--------------------------------------------------
#define _DP_PORT_VALID                              ((_D0_INPUT_PORT_TYPE == _D0_DP_PORT) +\
...
//--------------------------------------------------
// DP RL6463 Lane Swap Constraint
//--------------------------------------------------
#if(_SCALER_TYPE == _RL6463_SERIES)
#if(((_D0_INPUT_PORT_TYPE == _D0_DP_PORT) && (_D0_DP_PCB_LANE3_MAPPING != _DP_SCALER_LANE3)) ||\
    ((_D1_INPUT_PORT_TYPE == _D1_DP_PORT) && (_D1_DP_PCB_LANE3_MAPPING != _DP_SCALER_LANE3)) ||\
    (_HDMI_PORT_EXIST == _FALSE) || (_DP_PORT_EXIST == _FALSE))
#define _DP_RX_ACTIVE_REDUCE_LANE_COUNT_SUPPORT     _OFF
#else
#define _DP_RX_ACTIVE_REDUCE_LANE_COUNT_SUPPORT     _ON
#endif
...
//--------------------------------------------------
#define _DP_HDCP_ARBITER_SUPPORT                    ((_HW_DIGITAL_PORT_COMBO_PHY_TYPE == _DIGITAL_PORT_COMBO_PHY_D1_D2) &&\
...
//--------------------------------------------------
// Type-C Rts/User Port Controller Lane Swap By Scaler Support Definition
//--------------------------------------------------
#define _EXT_PORT_CTRL_LANE_SWAP_BY_SCALER_SUPPORT  ((_D0_DP_TYPE_C_EXT_PORT_CTRL_LANE_SWAP == _SWAP_BY_SCALER) ||\
                                                     (_D1_DP_TYPE_C_EXT_PORT_CTRL_LANE_SWAP == _SWAP_BY_SCALER) ||\
                                                     (_D6_DP_TYPE_C_EXT_PORT_CTRL_LANE_SWAP == _SWAP_BY_SCALER))
...
//--------------------------------------------------
// Type C Unattach HW Force Vbus Off Support Definition
//--------------------------------------------------
#define _TYPE_C_EMB_UNATTACH_HW_FORCE_VBUS_OFF      _OFF
...
#define _BILLBOARD_HUB_SUPPORT                      (((_D0_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_EMBEDDED) && (_D0_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_HUB)) ||\
                                                     ((_D1_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_EMBEDDED) && (_D1_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_HUB)) ||\
                                                     ((_D6_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_EMBEDDED) && (_D6_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_HUB)))

#define _BILLBOARD_PORT_CTRL_SUPPORT                ((_D0_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_PORT_CTRL) ||\
                                                     (_D1_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_PORT_CTRL) ||\
                                                     (_D6_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_PORT_CTRL))

#define _D0_BILLBOARD_SUPPORT                       ((_D0_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_SCALER) || ((_D0_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_EMBEDDED) && (_D0_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_HUB)) || (_D0_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_PORT_CTRL))
#define _D1_BILLBOARD_SUPPORT                       ((_D1_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_SCALER) || ((_D1_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_EMBEDDED) && (_D1_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_HUB)) || (_D1_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_PORT_CTRL))
#define _D6_BILLBOARD_SUPPORT                       ((_D6_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_SCALER) || ((_D6_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTROLLER_EMBEDDED) && (_D6_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_HUB)) || (_D6_DP_TYPE_C_BILLBOARD_TYPE == _BILLBOARD_PORT_CTRL))
...
#include "RL6851_Series_Pin_Mapping.h"
#endif
...
typedef enum
{
    ...
    _CONFIG_PIN_69,
    _CONFIG_PIN_70,
    _CONFIG_PIN_150_OFF_REGION,
    _CONFIG_PIN_151_OFF_REGION,
    _CONFIG_PIN_152_OFF_REGION,
...
//--------------------------------------------------
// Definition of DP AUX Count
//--------------------------------------------------
#if(_HW_DIGITAL_PORT_COMBO_PHY_TYPE == _DIGITAL_PORT_COMBO_PHY_ALL)
#define _DP_AUX_VALID_COUNT                         (_DP_SUPPORT == _ON)

#elif(_HW_DIGITAL_PORT_COMBO_PHY_TYPE == _DIGITAL_PORT_COMBO_PHY_D1_D2)
#define _DP_AUX_VALID_COUNT                         ((_D0_INPUT_PORT_TYPE == _D0_DP_PORT) +\
                                                     ((_D1_INPUT_PORT_TYPE == _D1_DP_PORT) || (_D2_INPUT_PORT_TYPE == _D2_DP_PORT)))
