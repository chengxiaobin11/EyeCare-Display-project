...
//--------------------------------------------------
// Structure of Type-C Embedded Related Structs
//--------------------------------------------------
typedef struct
{
    BYTE b5State : 5;
...
#define _M2PLL_FREQ_216M                        2
#define _M2PLL_FREQ_220M                        3
#define _M2PLL_FREQ_243M                        4
#define _M2PLL_FREQ_351M                        5
#define _M2PLL_FREQ_372M                        6
...
#define CHECK_PIN_CONDITION(condition)          {\
                                                    BYTE pucTCheckCondition[(condition) ? 1 : 1] = {0};\
...
typedef enum
{
    _5400_NOTIFY_EN_B0_NONE = 0x00,
    _5400_NOTIFY_EN_B0_RSV_BIT0 = _BIT0,
    _5400_NOTIFY_EN_B0_EXTAL_SUPPLY_CHG = _BIT1,
    _5400_NOTIFY_EN_B0_PWR_OP_MODE_CHG = _BIT2,
    _5400_NOTIFY_EN_B0_RSV_BIT3 = _BIT3,
    _5400_NOTIFY_EN_B0_RSV_BIT4 = _BIT4,
    _5400_NOTIFY_EN_B0_PROVIDER_CAP_CHG = _BIT5,
    _5400_NOTIFY_EN_B0_NEGOTIATE_PWR_LV_CHG = _BIT6,
    _5400_NOTIFY_EN_B0_PD_RST_COMPLETE = _BIT7,
    _5400_NOTIFY_EN_B0_ALL = 0xFF,
}Enum5400NotifyEnByte0;
...
typedef enum
{
    _5400_NOTIFY_EN_B1_NONE = 0x00,
    _5400_NOTIFY_EN_B1_SUPPORT_CAM_CHG = _BIT0,
    _5400_NOTIFY_EN_B1_BAT_CHARGE_STATUS_CHG = _BIT1,
    _5400_NOTIFY_EN_B1_RSV_BIT10 = _BIT2,
    _5400_NOTIFY_EN_B1_PORT_PARTNER_CHG = _BIT3,
    _5400_NOTIFY_EN_B1_PWR_DIRECTION_CHG = _BIT4,
    _5400_NOTIFY_EN_B1_RSV_BIT13 = _BIT5,
    _5400_NOTIFY_EN_B1_CONNECT_CHG = _BIT6,
    _5400_NOTIFY_EN_B1_RSV_BIT15 = _BIT7,
    _5400_NOTIFY_EN_B1_ALL = 0xFF,
}Enum5400NotifyEnByte1;
...
typedef enum
{
    _5400_NOTIFY_EN_B2_NONE = 0x00,
    _5400_NOTIFY_EN_B2_RSV_BIT16 = _BIT0,
    _5400_NOTIFY_EN_B2_RSV_BIT17 = _BIT1,
    _5400_NOTIFY_EN_B2_RSV_BIT18 = _BIT2,
    _5400_NOTIFY_EN_B2_RSV_BIT19 = _BIT3,
    _5400_NOTIFY_EN_B2_ALT_FLOW_CHG = _BIT4,
    _5400_NOTIFY_EN_B2_DP_STATUS_CHG = _BIT5,
    _5400_NOTIFY_EN_B2_DFP_OCP_STATUS = _BIT6,
    _5400_NOTIFY_EN_B2_PORT_OP_MODE_CHG = _BIT7,
    _5400_NOTIFY_EN_B2_ALL = 0xFF,
}Enum5400NotifyEnByte2;
...
typedef enum
{
    _5400_NOTIFY_EN_B3_NONE = 0x00,
    _5400_NOTIFY_EN_B3_PWR_CTRL_REQ = _BIT0,
    _5400_NOTIFY_EN_B3_VDM_RECEIVED = _BIT1,
    _5400_NOTIFY_EN_B3_PDFW_START = _BIT2,
    _5400_NOTIFY_EN_B3_DATA_MSG_RECEIVED = _BIT3,
    _5400_NOTIFY_EN_B3_RSV_BIT28 = _BIT4,
    _5400_NOTIFY_EN_B3_RSV_BIT29 = _BIT5,
    _5400_NOTIFY_EN_B3_RSV_BIT30 = _BIT6,
    _5400_NOTIFY_EN_B3_PD_AMS_CHG = _BIT7,
    _5400_NOTIFY_EN_B3_ALL = 0xFF,
}Enum5400NotifyEnByte3;
...
typedef struct
{
    Enum5400NotifyEnByte0 enumNotifyEnByte0;
    Enum5400NotifyEnByte1 enumNotifyEnByte1;
    Enum5400NotifyEnByte2 enumNotifyEnByte2;
    Enum5400NotifyEnByte3 enumNotifyEnByte3;
}Struct5400NotifyEn;
...
//--------------------------------------------------
// Enumerations of DP Tx Source by User
//--------------------------------------------------
typedef enum
{
...
#define _HDR10_AMOUNT  _HDR10_MODE_AUTO
//--------------------------------------------------
