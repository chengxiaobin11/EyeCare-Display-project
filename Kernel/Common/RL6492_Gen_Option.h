...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6492_Gen_Option.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_SCALER_TYPE == _RL6492_SERIES)

#ifndef __RL6492_GEN_OPTION__
#define __RL6492_GEN_OPTION__
...
#define _HW_D1_INPUT_CLOCK_MAX                                  ((_D1_INPUT_PORT_TYPE == _D1_DP_PORT) ? 360000000 : 340000000) // Unit: Hz , DP1.1 , HDMI2.0(3.4G)
#define _HW_D2_INPUT_CLOCK_MAX                                  ((_D2_INPUT_PORT_TYPE == _D2_DP_PORT) ? 360000000 : 340000000) // Unit: Hz , DP1.1 , HDMI2.0(3.4G)
...
#define _XRAM_ADDR_END                                          (0xFCFF)

//--------------------------------------------------
// Definitions of Combo Phy Support
//--------------------------------------------------
#define _HW_DIGITAL_PORT_COMBO_PHY_TYPE                         _DIGITAL_PORT_COMBO_PHY_D1_D2
...
//-------------------------------------------------
#define _HW_PLL_AUTO_EDGE_SELECT_SUPPORT                        _ON
...
// IDither Gen
//-------------------------------------------------
#define _IDITHER_TYPE                                           _IDITHER_GEN_3_4_SEQ_TRUNCATE_6_4_2_BIT
...
//-------------------------------------------------
#define _HW_AUX_TALK_MODE_LDO_VOL_TYPE                          _AUX_TALK_MODE_GEN_2_ADJR_1_LDO_4BIT
...
// DDither Gen
//-------------------------------------------------
#define _DDITHER_TYPE                                           _DDITHER_GEN_4_6BIT_DITHERTBL_6BIT_PANEL_S2
...
#define _TMDS_HDCP_2_2_RX1_ONLINE_AES_PAGE                      _PAGEB
#define _TMDS_HDCP_2_2_RX2_ONLINE_AES_PAGE                      _PAGEB
...
// HW HDMI 2.0 Support
//--------------------------------------------------
#define _HW_HDMI_2_0_SUPPORT_PORT                               _HDMI_2_0_D1_D2
...
#define _HW_DP_INFOFRAME_RSV1_MEMORY_START_ADDR                 0x41
#define _HW_DP_INFOFRAME_RSV2_MEMORY_START_ADDR                 0x61
...
//--------------------------------------------------
#define _HW_USB3_RETIMER_SUPPORT                                _ON

//--------------------------------------------------
// _TYPE_C_SUPPORT_VERSION SELECT
//--------------------------------------------------
#define _HW_TYPE_C_SUPPORT_VERSION                              _TYPE_C_VERSION_1_2
...
//--------------------------------------------------
#define _HW_TYPE_C_FUNCTION_GEN                                 _TYPE_C_FUNCTION_GEN_1

//--------------------------------------------------
// _HW_USB_SUPPORT_ROLE SELSCT
//--------------------------------------------------
#define _HW_USB_SUPPORT_ROLE                                    _TYPE_C_USB_DEVICE_ONLY

//--------------------------------------------------
// _HW_USB_SUPPORT_ROLE SELSCT
//--------------------------------------------------
#define _HW_USB_MAX_LINK_RATE_SUPPORT                           _USB_SPEED_5G
...
//--------------------------------------------------
#define _HW_DP_RX_HDCP2_ONLINE_AES_COUNT                        _DP_RX_HDCP2_ONLINE_AES_1SET
...
// HW DP MAC Arbiter
//--------------------------------------------------
#define _HW_DP_MAC_ARBITER_SUPPORT                              _ON
...
//-------------------------------------------------
#define _RLXXXX_PROJECT_DEFAULT                                 "RL6492_Project_Default.h"

//-------------------------------------------------
// FW Pcb Default Include
//-------------------------------------------------
#define _RLXXXX_PCB_DEFAULT                                     "RL6492_Pcb_Default.h"
...
//-------------------------------------------------
#define _VSD_ULTRAVIVID_DT_COMPENSATION_SUPPORT                 _OFF
...
#include "RL6492_OSD_Gen_Option.h"

#endif // End of #ifndef __RL6492_GEN_OPTION__
#endif // End of #if(_SCALER_TYPE == _RL6492_SERIES)
