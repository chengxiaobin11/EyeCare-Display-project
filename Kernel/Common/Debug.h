...
// DDC Channel Select
//--------------------------------------------------
#define _DEBUG_DDC_CHANNEL_SEL                      _PCB_DEBUG_DDC    //EyeProtection for _DDC2
...
#define _DEBUG_MESSAGE_OSD                          _OFF// liuxh _DEBUG_MESSAGE_OSD
...
#define DebugMessageCEC(x, y)                       ScalerDebugMessage((x), (y))
#else
...
#define DebugMessageCheckMDomain(x, y)              ScalerDebugMessage((x), (y))
#else
#define DebugMessageCheckMDomain(x, y)              ;
#endif

#if(_DEBUG_MESSAGE_DUALBANK == _ON)
#define DebugMessageDualBank(x, y)                  ScalerDebugMessage((x), (y))
#else
