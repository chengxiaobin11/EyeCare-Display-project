...
#define _HW_D0_INPUT_CLOCK_MAX                                  ((_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON) ? (725000000) : (600000000)) // Unit: Hz , DP 1.2
#define _HW_D1_INPUT_CLOCK_MAX                                  ((_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON) ? (725000000) : (600000000)) // Unit: Hz , DP 1.2
#define _HW_D2_INPUT_CLOCK_MAX                                  600000000 // Unit: Hz , HDMI2.0 , MHL3.2
#define _HW_D3_INPUT_CLOCK_MAX                                  600000000 // Unit: Hz , HDMI2.0 , MHL3.2
...
//--------------------------------------------------
#define _HW_TMDS_YUV420_DUPLICATE_MODE_SUPPORT                  ((_LOCAL_DIMMING_SUPPORT == _ON) ||\
                                                                 (_TMDS_YUV420_DUPLICATE_MODE_SUPPORT == _ON))
