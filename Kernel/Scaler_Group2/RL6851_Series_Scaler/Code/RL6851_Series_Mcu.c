...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Series_Mcu.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6851_SERIES_MCU__
...
#define _EMBEDDED_DDCRAM_DDC1_ADDRESS                                   0xE200
...
//--------------------------------------------------
// EMCU ISP_DDC (Page FD)
//--------------------------------------------------
volatile BYTE xdata MCU_FD30_ISP_DDC_SEGMENT_ADDRESS                                                                    _at_ 0xFD30;
volatile BYTE xdata MCU_FD31_ISP_DDC_SEGMENT_DATA                                                                       _at_ 0xFD31;
volatile BYTE xdata MCU_FD32_ISP_DDC_DDC_ENABLE                                                                         _at_ 0xFD32;
volatile BYTE xdata MCU_FD33_ISP_DDC_DDC_CONTROL_1                                                                      _at_ 0xFD33;
volatile BYTE xdata MCU_FD34_ISP_DDC_DDC_CONTROL_2                                                                      _at_ 0xFD34;
volatile BYTE xdata MCU_FD37_ISP_DDC_EDID_IRQ                                                                           _at_ 0xFD37;
volatile BYTE xdata MCU_FD38_ISP_DDC_RESERVED                                                                           _at_ 0xFD38;
...
volatile BYTE xdata MCU_FE61_PORT_READ_CONTROL_02                                                                       _at_ 0xFE61;
volatile BYTE xdata MCU_FE62_DUMMY_4                                                                                    _at_ 0xFE62;
...
volatile BYTE xdata MCU_FEB4_EMCU_SRAM_MARGIN_CTRL                                                                      _at_ 0xFEB4;


//--------------------------------------------------
// EMCU DDCRAM Settings (Page FE)
//--------------------------------------------------
volatile BYTE xdata MCU_FEB9_DDC_DID_CTRL                                                                               _at_ 0xFEB9;
volatile BYTE xdata MCU_FEBA_DDC0_DDCRAM_SEL                                                                            _at_ 0xFEBA;
volatile BYTE xdata MCU_FEBB_DDC0_DXINFO_B0_DID                                                                         _at_ 0xFEBB;
volatile BYTE xdata MCU_FEBC_DDC0_DXINFO_B1_DID                                                                         _at_ 0xFEBC;
volatile BYTE xdata MCU_FEBD_DDC0_DXINFO_OFFSL_DID                                                                      _at_ 0xFEBD;
volatile BYTE xdata MCU_FEBE_DDC0_DXINFO_B0_EDID                                                                        _at_ 0xFEBE;
volatile BYTE xdata MCU_FEBF_DDC0_DXINFO_B1_EDID                                                                        _at_ 0xFEBF;
volatile BYTE xdata MCU_FEC0_DDC0_DXINFO_OFFSL_EDID                                                                     _at_ 0xFEC0;
volatile BYTE xdata MCU_FEC1_DDC0_CHECKSUM_DID                                                                          _at_ 0xFEC1;
volatile BYTE xdata MCU_FEC2_DDC0_CHECKSUM_OFFSL_DID                                                                    _at_ 0xFEC2;
volatile BYTE xdata MCU_FEC3_DDC0_CHECKSUM_EDID                                                                         _at_ 0xFEC3;
volatile BYTE xdata MCU_FEC4_DDC0_CHECKSUM_OFFS_EDID                                                                    _at_ 0xFEC4;
volatile BYTE xdata MCU_FEC5_DDC1_DDCRAM_SEL                                                                            _at_ 0xFEC5;
volatile BYTE xdata MCU_FEC6_DDC1_DXINFO_B0_DID                                                                         _at_ 0xFEC6;
volatile BYTE xdata MCU_FEC7_DDC1_DXINFO_B1_DID                                                                         _at_ 0xFEC7;
volatile BYTE xdata MCU_FEC8_DDC1_DXINFO_OFFSL_DID                                                                      _at_ 0xFEC8;
volatile BYTE xdata MCU_FEC9_DDC1_DXINFO_B0_EDID                                                                        _at_ 0xFEC9;
volatile BYTE xdata MCU_FECA_DDC1_DXINFO_B1_EDID                                                                        _at_ 0xFECA;
volatile BYTE xdata MCU_FECB_DDC1_DXINFO_OFFSL_EDID                                                                     _at_ 0xFECB;
volatile BYTE xdata MCU_FECC_DDC1_CHECKSUM_DID                                                                          _at_ 0xFECC;
volatile BYTE xdata MCU_FECD_DDC1_CHECKSUM_OFFSL_DID                                                                    _at_ 0xFECD;
volatile BYTE xdata MCU_FECE_DDC1_CHECKSUM_EDID                                                                         _at_ 0xFECE;
volatile BYTE xdata MCU_FECF_DDC1_CHECKSUM_OFFS_EDID                                                                    _at_ 0xFECF;
...
// EMCU LSADC (Page FF)
//--------------------------------------------------
volatile BYTE xdata MCU_FF02_ADC_ANALOG_CONFIG                                                                          _at_ 0xFF02;
...
volatile BYTE xdata MCU_FFD7_I2CM_STR4                                                                                  _at_ 0xFFD7;
volatile BYTE xdata MCU_FFD8_I2CM_STR5                                                                                  _at_ 0xFFD8;
...
//--------------------------------------------------
volatile BYTE xdata MCU_FF7D_DDC_DID_IRQ_0                                                                              _at_ 0xFF7D;
...
void ScalerMcuDdcciEnable(bit bEn, BYTE ucInputPort);
#endif
void ScalerMcuDdcRamEnable(void);
void ScalerMcuDdcramConfig(void);
BYTE ScalerMcuDdcramBlockSel(WORD usDdcramStartAddr);
...
void ScalerMcuDdcDebounceSel(EnumClkSel enumClock)
{
    ...
    {
        // VGA_DDC De-bounce Reference Clock(14.318M) div by 2, latch 3 stages
        MCU_FF1C_ADC_DDC_CONTROL_1 &= ~_BIT7;
        MCU_FF1C_ADC_DDC_CONTROL_1 |= (_BIT6 | _BIT5 | _BIT4);

        // ISP DDC De-bounce Reference Clock(14.318M) div by 2, latch 3 stages
        MCU_FD33_ISP_DDC_DDC_CONTROL_1 &= ~_BIT7;
        MCU_FD33_ISP_DDC_DDC_CONTROL_1 |= (_BIT6 | _BIT5 | _BIT4);

#if(((_D0_INPUT_PORT_TYPE == _D0_DP_PORT) && (_D0_DDC_CHANNEL_SEL == _DDC0)) ||\
        ((_D1_INPUT_PORT_TYPE == _D1_DP_PORT) && (_D1_DDC_CHANNEL_SEL == _DDC0)))
        // DDC0 De-bounce Reference Clock(14.318M) div by 1, latch 1 stages
        MCU_FF1F_DDC0_DDC_CONTROL_1 &= ~(_BIT7 | _BIT6 | _BIT5);
        ...
        // DDC0 De-bounce Reference Clock(14.318M) div by 2, latch 3 stages
        ...
        // DDC1 De-bounce Reference Clock(IOSC = 28M) div by 1, latch 1 stages
        MCU_FF2D_DDC1_DDC_CONTROL_1 &= ~(_BIT7 | _BIT6 | _BIT5);
        ...
        // DDC1 De-bounce Reference Clock(IOSC = 28M) div by 2, latch 3 stages
    ...
    {
        // VGA_DDC De-bounce Reference Clock(28M) div by 4, latch 3 stages
        MCU_FF1C_ADC_DDC_CONTROL_1 |= (_BIT7 | _BIT6 | _BIT5 | _BIT4);

        // ISP DDC De-bounce Reference Clock(28M) div by 4, latch 3 stages
        MCU_FD33_ISP_DDC_DDC_CONTROL_1 |= (_BIT7 | _BIT6 | _BIT5 | _BIT4);

#if(((_D0_INPUT_PORT_TYPE == _D0_DP_PORT) && (_D0_DDC_CHANNEL_SEL == _DDC0)) ||\
        ((_D1_INPUT_PORT_TYPE == _D1_DP_PORT) && (_D1_DDC_CHANNEL_SEL == _DDC0)))
        // DDC0 De-bounce Reference Clock(IOSC = 28M) div by 2, latch 1 stages
        MCU_FF1F_DDC0_DDC_CONTROL_1 &= ~(_BIT7 | _BIT6 | _BIT5);
        MCU_FF1F_DDC0_DDC_CONTROL_1 |= (_BIT6 | _BIT4);
#elif(((_D0_TMDS_SUPPORT == _ON) && (_D0_DDC_CHANNEL_SEL == _DDC0)) ||\
          ((_D1_TMDS_SUPPORT == _ON) && (_D1_DDC_CHANNEL_SEL == _DDC0)))
        // DDC0 De-bounce Reference Clock(IOSC = 28M) div by 4, latch 3 stages
        MCU_FF1F_DDC0_DDC_CONTROL_1 |= (_BIT7 | _BIT6 | _BIT5 | _BIT4);
#endif

#if(((_D0_INPUT_PORT_TYPE == _D0_DP_PORT) && (_D0_DDC_CHANNEL_SEL == _DDC1)) ||\
        ((_D1_INPUT_PORT_TYPE == _D1_DP_PORT) && (_D1_DDC_CHANNEL_SEL == _DDC1)))
        // DDC1 De-bounce Reference Clock(IOSC = 28M) div by 2, latch 1 stages
        MCU_FF2D_DDC1_DDC_CONTROL_1 &= ~(_BIT7 | _BIT6 | _BIT5);
        MCU_FF2D_DDC1_DDC_CONTROL_1 |= (_BIT6 | _BIT4);
#elif(((_D0_TMDS_SUPPORT == _ON) && (_D0_DDC_CHANNEL_SEL == _DDC1)) ||\
          ((_D1_TMDS_SUPPORT == _ON) && (_D1_DDC_CHANNEL_SEL == _DDC1)))
        // DDC1 De-bounce Reference Clock(IOSC = 28M) div by 4, latch 3 stages
...
void ScalerMcuDdcciSwitchPort(EnumDDCCIDebugMode enumMode, BYTE ucInputPort)
{
    ...
    else
    {
        ...
        MCU_FF22_IIC_CH_SEL &= ~(_BIT3 | _BIT2 | _BIT1 | _BIT0);
#elif(_DEBUG_DDC_CHANNEL_SEL == _ISP_DDC)
        // DDC from ISP_DDC channel
        MCU_FF22_IIC_CH_SEL &= ~(_BIT3 | _BIT2 | _BIT1 | _BIT0);
    ...
    if(bEnable == _ENABLE)
    {
        switch(MCU_FF22_IIC_CH_SEL)
        {
            case _DDCCI_ADC_DDC:
                ...
                MCU_FD34_ISP_DDC_DDC_CONTROL_2 |= _BIT4;
...
void ScalerMcuDdcInitial(void)
{
    ...
    // Disable DDC Segment for ISP_DDC
    MCU_FD34_ISP_DDC_DDC_CONTROL_2 &= ~_BIT2;

    // Slave address 0xA0 for ISP_DDC
    MCU_FD32_ISP_DDC_DDC_ENABLE &= ~(_BIT7 | _BIT6 | _BIT5);

    // Force DDC to DDC2 Mode
    MCU_FD33_ISP_DDC_DDC_CONTROL_1 |= _BIT2;
    ...
    // ISP_DDC Force Nack
    MCU_FD37_ISP_DDC_EDID_IRQ |= _BIT5;
...
/////////////////////////////////////////
    ...
    // ISP_DDC
    MCU_FD34_ISP_DDC_DDC_CONTROL_2 &= ~_BIT0;
}
...
void ScalerMcuDdcciEnable(bit bEn, BYTE ucInputPort)
{
    BYTE ucDdcChannel = ScalerMcuGetDdcChannelFromInputPort(ucInputPort);
...
void ScalerMcuDdcRamEnable(void)
{
    // ISP_DDC Debounce Enable, ADC DDC channel enable
    MCU_FD32_ISP_DDC_DDC_ENABLE |= (_BIT1 | _BIT0);
...
void ScalerMcuDdcramConfig(void)
{
    ...
    // DDC0 DDCRAM Select
    MCU_FEBA_DDC0_DDCRAM_SEL &= ~(_BIT4 | _BIT3 | _BIT2);
    MCU_FEBA_DDC0_DDCRAM_SEL |= (ScalerMcuDdcramBlockSel(_EMBEDDED_DDCRAM_DDC0_ADDRESS) << 2);

    // DDC1 DDCRAM Select
    MCU_FEC5_DDC1_DDCRAM_SEL &= ~(_BIT4 | _BIT3 | _BIT2);
    MCU_FEC5_DDC1_DDCRAM_SEL |= (ScalerMcuDdcramBlockSel(_EMBEDDED_DDCRAM_DDC1_ADDRESS) << 2);
}
...
//                _NO_DDC: _BIT7; VGA_DDC2: _BIT8;_ISP_DDC:_BIT9
// Output Value : NONE
//--------------------------------------------------
void ScalerMcuSetISPChannel(WORD usISPChannel)
{
    ...
    // ISP_DDC
    ScalerMcuDdcISPChannelCtrl(_ISP_DDC, (bit)(usISPChannel & _BIT9));
}

//--------------------------------------------------
// Description  : ISP Channel Setting
// Input Value  : ucDdcChannel --> VGA_DDC...ISP_DDC
...
void ScalerMcuDdcISPChannelCtrl(BYTE ucDdcChannel, bit bEnable)
{
    switch(ucDdcChannel)
    {
        ...
        case _ISP_DDC:
            // ISP_DDC
            MCU_FD34_ISP_DDC_DDC_CONTROL_2 = (bEnable) ? (MCU_FD34_ISP_DDC_DDC_CONTROL_2 | _BIT3) : (MCU_FD34_ISP_DDC_DDC_CONTROL_2 & (~_BIT3));
            break;
