...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Series_ScalerCommonTimerFunction.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
                    ...
                    switch(GET_WD_EVENT_ID(ucIndex))
                    {
...
#if(_D0_DP_EXIST == _ON)
#if(_DP_WD_REBUILD_PHY_4PART_FOR_UCD400 == _ON)
                        case _SCALER_WD_TIMER_EVENT_RX0_DP_LINK_TRAINING_REBUILD_PHY_PART1:
                        case _SCALER_WD_TIMER_EVENT_RX0_DP_LINK_TRAINING_REBUILD_PHY_PART2:
                        case _SCALER_WD_TIMER_EVENT_RX0_DP_LINK_TRAINING_REBUILD_PHY_PART3:
                        case _SCALER_WD_TIMER_EVENT_RX0_DP_LINK_TRAINING_REBUILD_PHY_PART4:
#else
...
#if(_D1_DP_EXIST == _ON)
#if(_DP_WD_REBUILD_PHY_4PART_FOR_UCD400 == _ON)
                        case _SCALER_WD_TIMER_EVENT_RX1_DP_LINK_TRAINING_REBUILD_PHY_PART1:
                        case _SCALER_WD_TIMER_EVENT_RX1_DP_LINK_TRAINING_REBUILD_PHY_PART2:
                        case _SCALER_WD_TIMER_EVENT_RX1_DP_LINK_TRAINING_REBUILD_PHY_PART3:
                        case _SCALER_WD_TIMER_EVENT_RX1_DP_LINK_TRAINING_REBUILD_PHY_PART4:
#else
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX1_HDCP2_RSA_CAL_START:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                ...
                                {
                                    ScalerTimerWDActivateTimerEvent_WDINT(10, _SCALER_WD_TIMER_EVENT_TMDS_RX1_HDCP2_RSA_CAL_START);
                                }
                            }
                            break;
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX1_HDCP2_CHECK_RSA_CAL_DONE:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                ...
                                {
                                    ScalerTimerWDActivateTimerEvent_WDINT(10, _SCALER_WD_TIMER_EVENT_TMDS_RX1_HDCP2_CHECK_RSA_CAL_DONE);
                                }
                            }
                            else
                            {
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX2_HDCP2_RSA_CAL_START:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                ...
                                {
                                    ScalerTimerWDActivateTimerEvent_WDINT(10, _SCALER_WD_TIMER_EVENT_TMDS_RX2_HDCP2_RSA_CAL_START);
                                }
                            }
                            break;
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX2_HDCP2_CHECK_RSA_CAL_DONE:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                ...
                                {
                                    ScalerTimerWDActivateTimerEvent_WDINT(10, _SCALER_WD_TIMER_EVENT_TMDS_RX2_HDCP2_CHECK_RSA_CAL_DONE);
                                }
                            }
                            else
                            {
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX3_HDCP2_RSA_CAL_START:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                ...
                                {
                                    ScalerTimerWDActivateTimerEvent_WDINT(10, _SCALER_WD_TIMER_EVENT_TMDS_RX3_HDCP2_RSA_CAL_START);
                                }
                            }
                            break;
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX3_HDCP2_CHECK_RSA_CAL_DONE:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                ...
                                {
                                    ScalerTimerWDActivateTimerEvent_WDINT(10, _SCALER_WD_TIMER_EVENT_TMDS_RX3_HDCP2_CHECK_RSA_CAL_DONE);
                                }
                            }
                            else
                            {
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX4_HDCP2_RSA_CAL_START:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                ...
                                {
                                    ScalerTimerWDActivateTimerEvent_WDINT(10, _SCALER_WD_TIMER_EVENT_TMDS_RX4_HDCP2_RSA_CAL_START);
                                }
                            }
                            break;
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX4_HDCP2_CHECK_RSA_CAL_DONE:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                ...
                                {
                                    ScalerTimerWDActivateTimerEvent_WDINT(10, _SCALER_WD_TIMER_EVENT_TMDS_RX4_HDCP2_CHECK_RSA_CAL_DONE);
                                }
                            }
                            else
                            {
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX5_HDCP2_RSA_CAL_START:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                ...
                                {
                                    ScalerTimerWDActivateTimerEvent_WDINT(10, _SCALER_WD_TIMER_EVENT_TMDS_RX5_HDCP2_RSA_CAL_START);
                                }
                            }
                            break;
                        ...
                        case _SCALER_WD_TIMER_EVENT_TMDS_RX5_HDCP2_CHECK_RSA_CAL_DONE:
                            ...
                            if(ScalerHdcp2RsaAvailable_WDINT() == _TRUE)
                            {
                                ...
                                {
                                    ScalerTimerWDActivateTimerEvent_WDINT(10, _SCALER_WD_TIMER_EVENT_TMDS_RX5_HDCP2_CHECK_RSA_CAL_DONE);
                                }
                            }
                            else
                            {
...
// Output Value : None
//--------------------------------------------------
void ScalerTimerWDActivateTimerEvent(WORD usTime, EnumScalerWDTimerEventID enumEventID)
{
    BYTE ucIndex = 0;
    BYTE ucEventIndex = 0;
    BYTE ucWDTimeMSB = 0;
...
#if(_DP_WD_REBUILD_PHY_4PART_FOR_UCD400 == _ON)
//--------------------------------------------------
// Description  : Cancel WD Timer Event (Only for WDINT)
// Input Value  : ucEventID => Event ID
// Output Value : None
//--------------------------------------------------
void ScalerTimerWDCancelTimerEvent_WDINT(EnumScalerWDTimerEventID enumEventID) using 3
{
    BYTE ucIndex = 0;
...
void ScalerTimerEventProc(EnumScalerTimerEventID enumEventID)
{
    switch(enumEventID)
    {
        ...
        case _SCALER_TIMER_EVENT_TMDS_EMP_DETECT:
            ScalerTMDSMacEmpDetectEvent();
            break;
#endif
...
#if((_DP_SUPPORT == _ON) || ((_TMDS_HDCP_2_2_SUPPORT == _ON) && (_HDMI_PORT_EXIST == _ON)))
//--------------------------------------------------
// Description  : Cancel an event
// Input Value  : Event     --> Event which we want to cancel
// Output Value : None
