...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Series_ScalerCommonSyncInterface.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
// Macro of DP Input Pixel Clk (Unit in 0.1MHz)
//--------------------------------------------------
#if(_DP_SUPPORT == _ON)
...
extern void ScalerSyncSetAmdVsdbVer(BYTE ucInputPort, EnumAmdVsdbVer enumAmdVer);
...
extern void ScalerSyncDpSetCableStatus(EnumSourceSearchPort enumInputPort, bit bStatus);
extern bit ScalerSyncDpGetLinkTrainingPass(EnumSourceSearchPort enumInputPort);

#if(_DP_IRQ_HPD_MODE == _DP_IRQ_HPD_T2_MODE)
extern void ScalerSyncDpHpdIrqAssertTimer2EventProc_EXINT(void);
#endif

#if(_TWO_CHIP_DATA_EXCHANGE_MODE != _DATA_EXCHANGE_MODE_NONE)
extern void ScalerSyncDpRepeaterPowerOffReset(void);
#endif

#if(_DP_TX_SUPPORT == _ON)
extern void ScalerSyncDpRxSinkCountUpdateProc(EnumSourceSearchPort enumInputPort);
#endif

#if(_DP_LONG_HPD_ALLOWED_BY_USER_SUPPORT == _ON)
extern void ScalerSyncDpLongHpdSetAllowed(EnumSourceSearchPort enumInputPort, bit bAllowed);
#endif

#if((_PORT_CONTROLLER_RTS5400_SERIES_SUPPORT == _ON) || (_PORT_CONTROLLER_USERDECITION_SUPPORT == _ON))
extern void ScalerSyncDpRxSetLaneMapping(EnumSourceSearchPort enumInputPort, EnumTypeCPinCfgType enumPinAssignment, EnumTypeCOrientation enumOrientation);
#endif
...
extern void ScalerSyncDpHdcpRepeaterCapableProc(void);
...
extern void ScalerSyncDpSourceWritePowerUpProc(void);
#endif
...
extern void ScalerSyncTMDSSetHdmiZ0HpdType(EnumHdmiZ0HpdType enumHdmiZ0HpdType, WORD usZ0LowPeriod, WORD usZ0HpdInterval);

#if((_HDMI_MULTI_EDID_SUPPORT == _ON) && (_TMDS_FS_ON_ONLY_TARGETPORT_HPD_SUPPORT == _ON) && (_HDMI_FREESYNC_SUPPORT == _ON))
extern void ScalerSyncTMDSClrHPDTriggerEvent(EnumSourceSearchPort enumInputPort);
#endif
#endif
...
#if(_DVI_SUPPORT == _ON)
extern bit ScalerSyncTmdsGetDigitalPort(BYTE ucInputPort);
#endif
