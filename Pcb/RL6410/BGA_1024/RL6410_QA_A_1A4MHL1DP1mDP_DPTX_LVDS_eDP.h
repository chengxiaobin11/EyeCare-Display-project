...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_QA_A_1A4MHL1DP1mDP_DPTX_LVDS_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6410_QA_A_1A4MHL1DP1mDP_DPTX_LVDS_eDP)
...
// Series Pin Share //
//////////////////////
#include "RL6410_QA_A_1A4MHL1DP1mDP_DPTX_LVDS_eDP_PINSHARE.h"
...
#endif // End of #if(_PCB_TYPE == _RL6410_QA_A_1A4MHL1DP1mDP_DPTX_LVDS_eDP)
