...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_DEMO_A_1A4MHL2DP_DPTX_LVDS_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6410_DEMO_A_1A4MHL2DP_DPTX_LVDS_eDP)
...
// Series Pin Share //
//////////////////////
#include "RL6410_DEMO_A_1A4MHL2DP_DPTX_LVDS_eDP_PINSHARE.h"
...
// #define bD0_TYPE_C_CABLE_CONNECT                (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // For Repeater Cable Detect Case
// #define bD0_CONNECT                             (bD0_TYPE_C_CABLE_CONNECT)
...
#endif // End of #if(_PCB_TYPE == _RL6410_DEMO_A_1A4MHL2DP_DPTX_LVDS_eDP)
