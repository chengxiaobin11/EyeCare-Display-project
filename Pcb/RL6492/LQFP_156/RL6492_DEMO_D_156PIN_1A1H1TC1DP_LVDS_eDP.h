...
#define _TYPE_C_PMIC_FW_OCP_PROTECT_METHOD      _TYPE_C_PMIC_FW_OCP_BY_SCALER_SARADC
#define _TYPE_C_PMIC_FW_OCP_CURRENT_VALUE       125  // unit: %, should multiply with PMIC setting current to get the real OCP value
