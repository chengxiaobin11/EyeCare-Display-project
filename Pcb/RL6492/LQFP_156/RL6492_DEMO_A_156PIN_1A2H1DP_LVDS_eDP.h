...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6492_DEMO_A_156PIN_1A2H1DP_LVDS_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6492_DEMO_A_156PIN_1A2H1DP_LVDS_eDP)
...
// Series Pin Share //
//////////////////////
#include "RL6492_DEMO_A_156PIN_1A2H1DP_LVDS_eDP_PINSHARE.h"
...
//-----------------------------------------------
#define bREGULATOR_5V                           _PIN_23_MCU_REG

#define _REGULATOR_5V_ON                        1
#define _REGULATOR_5V_OFF                       0
...
//-----------------------------------------------
#define bD0_DP_PIN15_CONNECT                    _PIN_16_MCU_REG
#define bD0_DP_PIN16_CONNECT                    _PIN_21_MCU_REG
#define bD0_DP_PIN17_CONNECT                    _PIN_15_MCU_REG
...
//-----------------------------------------------
#define bD0_HPD                                 _PIN_14_MCU_REG
...
#endif // End of #if(_PCB_TYPE == _RL6492_DEMO_A_156PIN_1A2H1DP_LVDS_eDP)
