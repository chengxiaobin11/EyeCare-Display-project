...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6492_DEMO_B_156PIN_1A1H1TC1DP_LVDS_eDP_PN_SWAP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6492_DEMO_B_156PIN_1A1H1TC1DP_LVDS_eDP_PN_SWAP)
...
// Series Pin Share //
//////////////////////
#include "RL6492_DEMO_B_156PIN_1A1H1TC1DP_LVDS_eDP_PN_SWAP_PINSHARE.h"
...
#endif // End of #if(_PCB_TYPE == _RL6492_DEMO_B_156PIN_1A1H1TC1DP_LVDS_eDP_PN_SWAP)
