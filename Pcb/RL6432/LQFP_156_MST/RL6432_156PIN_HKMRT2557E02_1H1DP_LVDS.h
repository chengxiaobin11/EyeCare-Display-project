...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432__156PIN__HKMRT2556E02__1H1DP__LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432_156PIN_HKMRT2557E02_1H1DP_LVDS)
...
#define _D3_EMBEDDED_DDCRAM_MAX_SIZE           _EDID_SIZE_NONE// _EDID_SIZE_256
#define _D3_EMBEDDED_DDCRAM_LOCATION           _EDID_TABLE_LOCATION_USER// _EDID_TABLE_LOCATION_CODE

#else
#define _D1_INPUT_PORT_TYPE                     _D1_HDMI_PORT
#define _D1_DDC_CHANNEL_SEL                     _DDC1
#define _D1_EMBEDDED_DDCRAM_MAX_SIZE                _EDID_SIZE_256
#define _D1_EMBEDDED_DDCRAM_LOCATION            _EDID_TABLE_LOCATION_CODE//_EDID_TABLE_LOCATION_USER

#define _D3_INPUT_PORT_TYPE                     _D3_HDMI_PORT        // HDMI 1
#define _D3_DDC_CHANNEL_SEL                     _DDC3
...
//======Show input source definitions===============
//========================================
///////////////
#define _D1_TMDS_BR_SWAP                        _ON// HDMI
#define _D1_TMDS_PN_SWAP                        _ON// HDMI
...
#define _LVDS_PORT_SEL                        _LVDS_2_PORT_AB//  _LVDS_2_PORT_CD
...
#define _LVDS_VCM_CONTROL                       _LVDS_VCM_LOW
...
// LVDS SSC Config
//--------------------------------------------------
#if 0//_LVDS_SPREAD_RANGE
#define _LVDS_SPREAD_RANGE                      12
#else
...
//BY QS   TBD
//  ע���������PWM���� 5��ʱ��_AUDIO_VOLUMN_PWM ������Ϊ_NO_PWM, ����_AUDIO_VOLUMN_PWMҲ��ͬʱ���õ�����PWM 5
#define _BACKLIGHT_PWM                          _PWM5
#define _BACKLIGHT_PWM_INVERSE                  _OFF
...
// DDCSDA_VGA
#define _156PIN_PIN_132                         (0 & 0x0F) // Page 10-0x06[2:0]
// 0 ~ 8 (0: P1D6i<I>, 1: P1D6o<PP>, 2: P1D6o<OD>, 8: DDCSDAVGA)

// HP_DET
#define _156PIN_PIN_133                         (1 & 0x0F) // Page 10-0x07[2:0]
...
// DDCSCL1
#define _156PIN_PIN_137                         (8 & 0x0F) // Page 10-0x0A[2:0]
// 0 ~ 8 (0: P3D2i<I>, 1: Reserved, 2: P3D2o<OD>, 3: AUXp1, 8:DDCSCL1)

// DDSSDA1
#define _156PIN_PIN_138                         (8 & 0x0F) // Page 10-0x0B[2:0]
...
// (AUDIO_HOUTL)
#define _156PIN_PIN_147                         (3 & 0x0F) // Page 10-0x12[2:0]
// 0 ~ 5 (0: P4D2i<I>, 1: P4D2o<PP>, 2: P4D2o<OD>, 3: Audio_houtl, 4: sd2, 5: spdif2)

// (AUDIO_HOUTR)
#define _156PIN_PIN_148                         (3 & 0x0F) // Page 10-0x13[2:0]
// 0 ~ 5 (0: P4D3i<I>, 1: P4D3o<PP>, 2: P4D3o<OD>, 3: Audio_houtr, 4: sd3, 5: spdif3)

// HP_DET
#define _156PIN_PIN_151                         (0 & 0x0F) // Page 10-0x14[2:0]
...
// NC(AUDIO_REF)
#define _156PIN_PIN_153                         (3 & 0x0F) // Page 10-0x16[2:0]
// 0 ~ 4 (0: P4D6i<I>, 1: P4D6o<PP>, 2: P4D6o<OD>, 3: Audio_ref, 4: mck)

// Audio_soutr
#define _156PIN_PIN_154                         (3 & 0x0F) // Page 10-0x17[2:0]
// 0 ~ 5 (0: P4D7i<I>, 1: P4D7o<PP>, 2: P4D7o<OD>, 3: Audio_soutl, 4: sd0,
//        5: spdif0)

// Audio_soutl
#define _156PIN_PIN_155                         (3 & 0x0F) // Page 10-0x18[2:0]
// 0 ~ 5 (0: P5D0i<I>, 1: P5D0o<PP>, 2: P5D0o<OD>, 3: Audio_soutr, 4: sd1,
//        5: spdif1)

// 
#define _156PIN_PIN_51_OFF_REGION                          (2 & 0x0F) // Page 10-0x19[2:0]
// 0 ~ 6 (0: P5D1i<I>, 1: P5D1o<PP>, 2: P5D1o<OD>, 3: PWM3<PP>, 4: PWM3<OD>,
//        5: tcon[6],  6: DPTX_aux_ch_p_1)

//DDR Power2.5V EN
#define _156PIN_PIN_52_OFF_REGION                          (2 & 0x0F) // Page 10-0x1A[2:0]
...
// 
#define _156PIN_PIN_47_OFF_REGION                          (0 & 0x0F) // Page 10-0x22[2:0]
...
// 
#define _156PIN_PIN_66                          (1 & 0x0F) // Page 10-0x2F[2:0]
...
// Mute
#define _156PIN_PIN_81                          (1 & 0x0F) // Page 10-0x40[2:0]
...
#define   OSD_LED_CONTRL(x)          (MCU_EMPTY_PIN_ASSIGN_ADDRESS = x)//_156PIN_PIN_66,   P7D7
#define   GET_LED_STATUS()          (MCU_EMPTY_PIN_ASSIGN_ADDRESS)
...
//-----------------------------------------------
#define bVCCKOFFPOWER                         (MCU_FE26_PORT86_PIN_REG) // (MCU_FE20_PORT80_PIN_REG) // 156PIN_PIN_67, P8.0
...
//-----------------------------------------------
#define bDDRPOWER                               (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // _156PIN_PIN_52, P5.2
...
//--------------------------------------------------
#define bPANELPOWER                             (MCU_FE1A_PORT72_PIN_REG) // _156PIN_PIN_63, P7D2
...
//--------------------------------------------------
//#define bBACKLIGHTPOWER                         (MCU_FE1C_PORT74_PIN_REG) // _156PIN_PIN_64, P7.4
sbit bBACKLIGHTPOWER = P1^7; //_156PIN_PIN_133
...
//-----------------------------------------------
#define bFLASH_WRITE_PROTECT                    (MCU_FE19_PORT71_PIN_REG) // _156PIN_PIN_61, P7.1
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_FE1F_PORT77_PIN_REG) // _156PIN_PIN_66
...
sbit bD0_DP_PIN16_CONNECT                       = P1 ^ 3; // _156PIN_PIN_118, P1.3
#define bD0_DP_PIN17_CONNECT                    (MCU_FE24_PORT84_PIN_REG) // _156PIN_PIN_71, P8.4
...
sbit bD1_CONNECT                             	= P1 ^ 4; // _156PIN_PIN_119,  P1D4
sbit bD3_CONNECT                             	= P1 ^ 0; // _156PIN_PIN_82, P1.0
...
//--------------------------------------------------
#define bLVDSDPTXSWICH                          (MCU_EMPTY_PIN_ASSIGN_ADDRESS) 
...
// Macro of LED On/Off
//--------------------------------------------------
#define bLED1                                   (MCU_FE2B_PORT93_PIN_REG) // _156PIN_PIN_74,P8D7
#define bLED2                                   (MCU_FE2A_PORT92_PIN_REG) // _156PIN_PIN_73, P8D6
...
//HDMI3
#define bDDC3IICSCL         				 	(MCU_FE2E_PORT96_PIN_REG) //_156PIN_PIN_79
#define bDDC3IICSDA          					(MCU_FE2F_PORT97_PIN_REG) //_156PIN_PIN_80

#define bSWIIC_ZCS_CT_SDA                       (MCU_FE09_PORT51_PIN_REG)
#define bSWIIC_ZCS_CT_SCL                       (MCU_FE0A_PORT52_PIN_REG)
#define bSWIIC_LS_PS_SDA                        (MCU_FE09_PORT51_PIN_REG)
#define bSWIIC_LS_PS_SCL                        (MCU_FE0A_PORT52_PIN_REG)
...
#define PCB_SW_IIC_SDA_SET()                    {\
                                                    ...
                                                    else if(GET_SW_IIC_STATUS() == _IIC_MT3212_CT)     \
                                                    {                                          		\
                                                        bSWIIC_ZCS_CT_SDA = _TRUE;         		    \
                                                    }                                          		\
                                                    else if(GET_SW_IIC_STATUS() == _IIC_LS_PS)     \
                                                    {                                          		\
                                                        bSWIIC_LS_PS_SDA = _TRUE;         		    \
                                                    }                                          		\
                                                }
#define PCB_SW_IIC_SDA_CLR()                    {\
                                                    ...
                                                    {                                          		\
                                                        bSWIIC_ZCS_CT_SDA = _FALSE;         		\
                                                    }                                          		\
                                                    else if(GET_SW_IIC_STATUS() == _IIC_LS_PS)      \
                                                    {                                          		\
                                                        bSWIIC_LS_PS_SDA = _FALSE;         		    \
                                                    }                                          		\
                                                }
...
#define PCB_SW_IIC_SCL_SET()                    {\
                                                    ...
                                                    {                                          		\
                                                        bSWIIC_ZCS_CT_SCL = _TRUE;         		    \
                                                    }                                          		\
                                                    else if(GET_SW_IIC_STATUS() == _IIC_LS_PS)      \
                                                    {                                          		\
                                                        bSWIIC_LS_PS_SCL = _TRUE;         		    \
                                                    }                                          		\
                                                }
#define PCB_SW_IIC_SCL_CLR()                    {\
                                                    ...
                                                    {                                          		\
                                                        bSWIIC_ZCS_CT_SCL = _FALSE;         		\
                                                    }                                          		\
                                                    else if(GET_SW_IIC_STATUS() == _IIC_LS_PS)      \
                                                    {                                          		\
                                                        bSWIIC_LS_PS_SCL = _FALSE;         		    \
                                                    }                                          		\
                                                }
...
//-----------------------------------------------
#define AD_KEY1                                 (MCU_FF09_ADC_A0_CONVERT_RESULT) // _156PIN_PIN_143,A-ADC0
#define AD_KEY2                                 (MCU_FF0A_ADC_A1_CONVERT_RESULT) // _156PIN_PIN_144,A-ADC1
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)	{\
																...
																else if((0x00 <= (ucV2)) && ((ucV2) < 0x10))\
																{\
																	(ucKeyState) |=_RIGHT_KEY_MASK;\
																}\
																else if(!bPower)\
																{\
																	(ucKeyState) |=_MIDDLE_KEY_MASK;\
																}\
																else if(!bUpp)\
																{\
...
//sbit bHeadphoneDetect                                    = P1 ^ 7;//_156PIN_PIN_133, P1D7

#define bHeadphoneDetect                      (MCU_FE04_PORT44_PIN_REG)//_156PIN_PIN_81,PAD0
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_FE30_PORTA0_PIN_REG)//_156PIN_PIN_81,PAD0
...
#define _BURNIN_STR_IC_NAME                	 _H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_5__,_5__,_7__,_E__,_0__,_2__
...
#define PCB_MPRT_TCON_PIN_SHARE_CONFIG(x)       {\
													if(x == _ON)\
													{\
														ScalerSetByte(0x102C, (BYTE)(3));\
													}\
													else\
													{\
														ScalerSetByte(0x102C, (BYTE)(1));\
													}\
												}
...
#define PCB_MPRT_TCON_ENABLE(x)                 {\
													if(x == _ON)\
													{\
														ScalerTcon5Enable(_ENABLE);\
													}\
													else\
													{\
														ScalerTcon5Enable(_DISABLE);\
													}\
												}

#define PCB_MPRT_TCON_INVERTED_OUTPUT()         {\
													ScalerSetDataPortBit(0x15A3,  0x68, ~(_BIT6), _BIT6  );\
												}


#define PCB_MPRT_TCON_PWM_ADJUST()              {\
                                                 	ScalerTcon5Adjust(0x00, 0x1FFF, ( g_MPRTValue), GET_MDOMAIN_OUTPUT_VTOTAL());\
												}

#endif


#endif // End of #if(_PCB_TYPE == _RL6432__156PIN__HKMRT2556E02__1H1DP__LVDS)
