...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432_QA_C_156PIN_1MHL2DP_DPTX_LVDS_eDP_PINSHARE.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
// DDR_PW_EN (Always Power Enable)
#define _156PIN_PIN_121                         (0 & 0x0F) // Page 10-0x07[2:0]
// 0 ~ 2 (0: P1D7i<I>, 1: P1D7o<PP>,   2: P1D7o<OD>, 3: pwm0 <PP>,  4: pwm0 <OD>,
//        5: tcon[4],  6: test4b_out2, 7: test4b_out3)

// AUX_CHP_0
#define _156PIN_PIN_123                         (3 & 0x0F) // Page 10-0x08[2:0]
// 0 ~ 3 (0: P3D0i<I>, 1: Reserved, 2: P3D0o<OD>, 3: AUXp0)

// AUX_CHN_0
#define _156PIN_PIN_124                         (3 & 0x0F) // Page 10-0x09[2:0]
// 0 ~ 3 (0: P3D1i<I>, 1: Reserved, 2: P3D1o<OD>, 3: AUXn0)

// AUX_CHP_1
#define _156PIN_PIN_125                         (3 & 0x0F) // Page 10-0x0A[2:0]
// 0 ~ 8 (0: P3D2i<I>, 1: Reserved, 2: P3D2o<OD>, 3: AUXp1, 8:DDCSCL1)

// AUX_CHN_1
#define _156PIN_PIN_126                         (3 & 0x0F) // Page 10-0x0B[2:0]
// 0 ~ 8 (0: P3D3i<I>, 1: Reserved, 2: P3D3o<OD>, 3: AUXn1, 8: DDSSDA1)

// DPTX_AUX_P
#define _156PIN_PIN_141                         (3 & 0x0F) // Page 10-0x10[2:0]
// 0 ~ 3 (0: P4D0i<I>, 1: P4D0o<PP>, 2: P4D0o<OD>, 3: DPTX_aux_ch_p)

// DPTX_AUX_N
#define _156PIN_PIN_142                         (3 & 0x0F) // Page 10-0x11[2:0]
...
// HDMI_CABLE_DETECT_3
#define _156PIN_PIN_64                          (0 & 0x0F) // Page 10-0x2C[2:0]
...
// DPTX_HPD
#define _156PIN_PIN_66                          (3 & 0x0F) // Page 10-0x2E[2:0]
...
// DDCSCL_2
#define _156PIN_PIN_79                          (8 & 0x0F) // Page 10-0x3C[2:0]
// 0 ~ 8 (0: P9D4i<I>, 1: Reserved, 2: P9D4o<OD>, 8: DDCSCL2)

// DDCSDA_2
#define _156PIN_PIN_80                          (8 & 0x0F) // Page 10-0x3D[2:0]
// 0 ~ 8 (0: P9D5i<I>, 1: Reserved, 2: P9D5o<OD>, 8: DDCSDA2)

// DDCSCL_3
#define _156PIN_PIN_81                          (8 & 0x0F) // Page 10-0x3E[2:0]
// 0 ~ 8 (0: P9D6i<I>, 1: Reserved, 2: P9D6o<OD>, 8: DDCSCL3)

// DDCSDA_3
#define _156PIN_PIN_82                          (8 & 0x0F) // Page 10-0x3F[2:0]
