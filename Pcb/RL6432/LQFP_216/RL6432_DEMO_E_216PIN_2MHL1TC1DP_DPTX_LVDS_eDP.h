...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432_DEMO_E_216PIN_2MHL1TC1DP_DPTX_LVDS_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432_DEMO_E_216PIN_2MHL1TC1DP_DPTX_LVDS_eDP)
...
// Series Pin Share //
//////////////////////
#include "RL6432_DEMO_E_216PIN_2MHL1TC1DP_DPTX_LVDS_eDP_PINSHARE.h"
...
//-----------------------------------------------
#define bD0_USB_TYPE_C_AUXP_CONNECT             (MCU_FE25_PORT85_PIN_REG) // Pin_203, P8.5
#define bD0_USB_TYPE_C_AUXN_CONNECT             (MCU_FE24_PORT84_PIN_REG) // Pin_202, P8.4
...
#define bD2_CONNECT                             (MCU_FE30_PORTA0_PIN_REG) // PIN_216, PA.0
...
//-----------------------------------------------
#define bD0_HPD                                 (MCU_FE22_PORT82_PIN_REG) // Pin_201, P8.2
#define bD1_HPD                                 (MCU_FE23_PORT83_PIN_REG) // Pin_200, P8.3
#define bD2_HPD                                 (P1_2) // Pin_15, P1.2
...
//--------------------------------------------------
#define bLVDSDPTXSWICH                          (MCU_FE0F_PORT57_PIN_REG) // Pin_167, P5.7
...
//--------------------------------------------------
#define bSWIIC_SYS_EEPROM_SCL                   (MCU_FE0D_PORT55_PIN_REG) // Pin_165
#define bSWIIC_SYS_EEPROM_SDA                   (MCU_FE0C_PORT54_PIN_REG) // Pin_164
...
#endif // End of #if(_PCB_TYPE == RL6432_DEMO_E_216PIN_2MHL1TC1DP_DPTX_LVDS_eDP)
