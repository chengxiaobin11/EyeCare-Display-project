...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6369_DEMO_76PIN_1A1DVI.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6369_DEMO_76PIN_1A1DVI)
...
// Series Pin Share //
//////////////////////
#include "RL6369_DEMO_76PIN_1A1DVI_PINSHARE.h"
...
#endif // End of #if(_PCB_TYPE == _RL6369_DEMO_76PIN_1A1DVI)
