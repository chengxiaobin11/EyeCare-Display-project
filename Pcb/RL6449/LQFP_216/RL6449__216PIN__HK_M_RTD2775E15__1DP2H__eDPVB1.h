...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : _RL6449__216PIN__HK_M_RTD2775E01__2DP2H__eDPVB1.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
//-----------------------------------------------
...
//#define _PORT_NAME_STR_A0						_STR_INDEX_NULL
...
#if(_LOCAL_DEVLOP)
#define _D1_EMBEDDED_DDCRAM_MAX_SIZE            _EDID_SIZE_384	
#else
...
#define _INPUT_PORT_SEARCH_PRI_1                _D3_INPUT_PORT//_D2_INPUT_PORT
#define _INPUT_PORT_SEARCH_PRI_2                _D2_INPUT_PORT//_D3_INPUT_PORT
...
//--------------------------------------------------
#define _PANEL_DPTX_1_2_SWING_LEVEL             _DP_SWING_1200_MV//_DP_SWING_800_MV
...
//--------------------------------------------------
#define _PANEL_DPTX_1_2_SPREAD_RANGE            10//12
...
#if 0//(Project_ID == ID_HK2795E01_BOE_MV270FHM_NF1_FHD280HZ_20231020)
...
// UH1 A0 - HDMI��24C02���л��ģ�Ĭ��Ҫ���ͣ�����,Ҫ��PBP,PIP��ʱ����ȥ����
...
#define  	_PWM_MPRT_ON        1
#define  	_PWM_MPRT_OFF       0
// ��MPRT��PWM���ų��Ͳ��б���
#define   PWM_MPRT_CONTRL(x)          (MCU_FE24_PORT84_PIN_REG = x)//_PIN_184,   
#define   GET_PWM_MPRT_STATUS()       (MCU_FE24_PORT84_PIN_REG)
...
//--------------------------------------------------
#define bBACKLIGHTPOWER                         (MCU_FE2B_PORT93_PIN_REG) // _PIN_197, 
...
#define bLED1                                   (MCU_FE25_PORT85_PIN_REG) // _PIN_185, P8D5
#define bLED2                                   (MCU_FE29_PORT91_PIN_REG) // _PIN_195, P9.1
/*
bLED1 - _0FF bLED2 - _ON  �ȵ�
bLED1 - _ON  bLED2 - _ON  �رյ�
bLED1 - _ON  bLED2 - _OFF ����
bLED1 - _OFF bLED2 - _OFF ��ɫ��
*/
...
#define bPOWER_KEY                              (KEY3_KEY)
#define bMENU_KEY   							(MCU_FE27_PORT87_PIN_REG) // Pin_193
#define bUP_KEY									(MCU_FE22_PORT82_PIN_REG) // Pin_180
...
||(_PROJECT_ID==_ID_ZQ_2775E15_BOE_DV245QHB_N20_8BIT_QHD180_ZQ25F180_20250110) \
    ...
    ||(_PROJECT_ID==_ID_JX_2557E02_MV238FHB_NF5_QHD144_EYEPROTECT_CLASSIC_R5KEY) \
)
...
#define PCB_MPRT_TCON_PIN_SHARE_CONFIG(x)       {\
													if(x == _ON)\
													{\
														ScalerSetByte(0x1034, (BYTE)(5));\
													}\
													else\
													{\
														ScalerSetByte(0x1034, (BYTE)(1));\
													}\
												}
...
#define PCB_MPRT_TCON_ENABLE(x)                 {\
													if(x == _ON)\
													{\
														ScalerTcon11Enable(_ENABLE);\
													}\
													else\
													{\
														ScalerTcon11Enable(_DISABLE);\
													}\
												}

#define PCB_MPRT_TCON_INVERTED_OUTPUT()         {\
													ScalerSetDataPortBit(0x15A3,     0xC8, ~(_BIT6), _BIT6  );\
												}


 //   ScalerSetDataPortBit(P15_A3_TCON_ADDR, _P15_A4_PT_C8_TC11_CTRL, ~(_BIT6), ((BYTE)bEnable << 6));

#define PCB_MPRT_TCON_PWM_ADJUST(vstart, vend)   {\
													 ScalerTcon11Adjust(0x00, 0x1FFF, (vstart), (vend));\
												 }

/*
#define PCB_MPRT_TCON_PWM_ADJUST()              {\
                                                 	ScalerTcon11Adjust(0x00, 0x1FFF, ( g_MPRTValue), GET_MDOMAIN_OUTPUT_VTOTAL());\
												}
*/
#endif

#endif // End of #if(_PCB_TYPE == _RL6449__216PIN__HK_M_RTD2775E01__2DP2H__eDPVB1)
///////////////////
