...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6449_QA_A_1A2MHL1DP1mDP_DPTX_eDP_PINSHARE.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
// DP5V_ON
#define _PIN_149_OFF_REGION                     (0 & 0x0F) // Page 10-0x20[2:0]
// 0 ~ 8 (0: P6D0i<I>, 1: P6D0o<PP>, 2: P6D0o<OD>, 3: tcon[2], 8: iicscl1

// ADJBACKLITE
#define _PIN_150_OFF_REGION                     (3 & 0x0F) // Page 10-0x21[2:0]
...
// CLK_2 (NC)
#define _PIN_153_OFF_REGION                     (1 & 0x0F) // Page 10-0x24[2:0]
