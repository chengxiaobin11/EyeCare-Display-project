...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6449_DEMO_F_1A2MHL1DP1mDP_DPTX_VB1.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6449_DEMO_F_1A2MHL1DP1mDP_DPTX_VB1)
...
// Series Pin Share //
//////////////////////
#include "RL6449_DEMO_F_1A2MHL1DP1mDP_DPTX_VB1_PINSHARE.h"
...
//--------------------------------------------------
#define bPANELPOWER                             (MCU_FE1D_PORT75_PIN_REG) // Pin_163, P7.5
...
#endif // End of #if(_PCB_TYPE == _RL6449_DEMO_F_1A2MHL1DP1mDP_DPTX_VB1)
