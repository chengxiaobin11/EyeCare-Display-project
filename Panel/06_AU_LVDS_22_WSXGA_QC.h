...
#if(_PANEL_TYPE == _AU_LVDS_22_WSXGA_QC)
//----------------------------------------------------------------------------------------------------
// ID Code      : _AU_LVDS_22_WSXGA_QC.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL                         2700
#define _PANEL_DH_TOTAL_MAX                     3024
...
#define _PANEL_PIXEL_CLOCK_MAX                  240
...
#endif // End of #if(_PANEL_TYPE == _AU_LVDS_22_WSXGA_QC)
