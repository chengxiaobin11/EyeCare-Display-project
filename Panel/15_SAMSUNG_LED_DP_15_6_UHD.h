...
#if(_PANEL_TYPE == _SAMSUNG_LED_DP_15_6_UHD)
//----------------------------------------------------------------------------------------------------
// ID Code      : _SAMSUNG_LED_DP_15_6_UHD.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL_MIN                     3940
...
#endif // End of #if(_PANEL_TYPE == _SAMSUNG_LED_DP_15_6_UHD)
