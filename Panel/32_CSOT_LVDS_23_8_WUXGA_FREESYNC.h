...
#if(_PANEL_TYPE == _CSOT_LVDS_23_8_WUXGA_FREESYNC)
//----------------------------------------------------------------------------------------------------
// ID Code      : _CSOT_LVDS_23_8_WUXGA_FREESYNC.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _PANEL_DH_START                         18
#define _PANEL_DH_WIDTH                         1920
#define _PANEL_DH_END                           1938

#define _PANEL_DH_TOTAL                         2000
#define _PANEL_DH_TOTAL_MAX                     2000
#define _PANEL_DH_TOTAL_MIN                     1988
...
#define _PANEL_DV_TOTAL_MAX                     2360
#define _PANEL_DV_TOTAL_MIN                     1098

#define _PANEL_DH_SYNC_WIDTH                    8
#define _PANEL_DV_SYNC_HEIGHT                   2

#define _PANEL_PIXEL_CLOCK                      220
#define _PANEL_PIXEL_CLOCK_MAX                  229
#define _PANEL_PIXEL_CLOCK_MIN                  52

#define _PANEL_POWER_ON_T1                      10
#define _PANEL_POWER_ON_T2                      60
#define _PANEL_POWER_ON_T3                      550

#define _PANEL_POWER_OFF_T4                     150
#define _PANEL_POWER_OFF_T5                     25
#define _PANEL_POWER_OFF_T6                     1450
...
#endif // End of #if(_PANEL_TYPE == _CSOT_LVDS_23_8_WUXGA_FREESYNC)
