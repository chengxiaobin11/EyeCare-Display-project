...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Project.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PROJECT == _RL6851_PROJECT)
...
// Pcb Option
//--------------------------------------------------
//#define _PCB_TYPE                                               _RL6851__76PIN__HKMRT2313BRE01__1A1H__LVDS//_RL6851_QA_A_128PIN_1A1H1DP_LVDS
...
// DDCCI Option
//-------------------------------------------------
#define _DDCCI_RXBUF_LENGTH                                     128//128
#define _DDCCI_TXBUF_LENGTH                                     41//42
#define _DDCCI_TIMEOUT_LIMIT                                    150//500 // 0~65535ms
...
#define _OVERSCAN_H_RATIO                                       10//30
#define _OVERSCAN_V_RATIO                                       10//30
...
#define _SYSTEM_EEPROM_EMULATION_FLASH_BANK                     8//11
...
//-------------------------------------------------
#define _HDCP_1_4_KEY_LOCATION                                  _TABLE_LOCATION_FLASH//_TABLE_LOCATION_CODE

//-------------------------------------------------
// For HDCP 1.4 Rx Key (FW Size : 325 Bytes ; Tool Size : 376 Bytes)
//-------------------------------------------------
#define _RX_HDCP_1_4_KEY_ADDRESS_EEPROM                         (_EEPROM_PAGE3_BANK1) //(_EEPROM_PAGE2_BANK1)
#define _RX_HDCP_1_4_KEY_ADDRESS_FLASH                          0x9000//0
#define _RX_HDCP_1_4_KEY_FLASH_BANK                            _SYSTEM_EEPROM_EMULATION_FLASH_BANK
...
//--------------------------------------------------
#define _OOR_H_FREQ_UPPER_BOUND                                 2000 // Unit in 0.1 kHZ
#define _OOR_H_FREQ_LOWER_BOUND                                 100  // Unit in 0.1 kHZ
#define _OOR_V_FREQ_UPPER_BOUND                                 1300  // Unit in 0.1 HZ
#define _OOR_V_FREQ_LOWER_BOUND                                 200  // Unit in 0.1 HZ
#define _OOR_H_WIDTH_UPPER_BOUND                                2048 // Unit in pixel
#define _OOR_V_HEIGHT_LOWER_BOUND                               240  // Unit in line

#define _FAIL_SAVE_H_FREQ_UPPER_BOUND                           2000 // Unit in 0.1 kHZ
#define _FAIL_SAVE_H_FREQ_LOWER_BOUND                           110  // Unit in 0.1 kHZ
#define _FAIL_SAVE_V_FREQ_UPPER_BOUND                           1300//845  // Unit in 0.1 HZ
#define _FAIL_SAVE_V_FREQ_LOWER_BOUND                           200  // Unit in 0.1 HZ

#define _INPUTCLOCK_RANG_VGA                                    2100 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_DVI                                    3000 // Unit in 0.1 MHz, Max 3000 (297MHz + 3MHz margin) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
#define _INPUTCLOCK_RANG_HDMI                                   3000//3400 //2250 // Unit in 0.1 MHz, Max 3000 (297MHz + 3MHz margin) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
#define _INPUTCLOCK_RANG_DP                                     3000//2250 // Unit in 0.1 MHz, Max 3000 (297MHz + 3MHz margin) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
...
// DVI & HDMI Option
//--------------------------------------------------
#define _DVI_DE_ONLY_SUPPORT                                    _OFF//_ON
#define _HDMI_FROM_DVI_CONNECT                                  _OFF//_ON
...
#define _LINE_IN_DAC_AOUT_GAIN_DB                               _AUDIO_DAC_OUTPUT_GAIN_0_DB // 0dB, 0.4dB for each step, Max Gain: 'b11(1.2dB)
#define _LINE_IN_DAC_HPOUT_GAIN_DB                              _AUDIO_DAC_OUTPUT_GAIN_0_DB // 0dB, 0.4dB for each step, Max Gain: 'b11(1.2dB)
...
//-------------------------------------------------
#define _DIGITAL_DAC_AOUT_GAIN_DB                               _AUDIO_DAC_OUTPUT_GAIN_0_DB // 0dB, 0.4dB for each step, Max Gain: 'b11(1.2dB)
#define _DIGITAL_DAC_HPOUT_GAIN_DB                              _AUDIO_DAC_OUTPUT_GAIN_0_DB // 0dB, 0.4dB for each step, Max Gain: 'b11(1.2dB)
...
#endif // End of #if(_PROJECT == _RL6851_PROJECT)
